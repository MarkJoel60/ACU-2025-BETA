...
// Type: PX.Objects.SO.SOSalesSubAccountMaskAttribute
...
public sealed class SOSalesSubAccountMaskAttribute : PXEntityAttribute
{
  ...
  {
    PXDimensionMaskAttribute dimensionMaskAttribute = new PXDimensionMaskAttribute("SUBACCOUNT", "ZZZZZZZZZA", "I", new SOSalesAcctSubDefault.SubListAttribute().AllowedValues, new SOSalesAcctSubDefault.SubListAttribute().AllowedLabels);
  ...
  public virtual void GetSubscriber<ISubscriber>(List<ISubscriber> subscribers) where ISubscriber : class
  {
    ...
    subscribers.Remove(((IEnumerable) ((PXAggregateAttribute) this)._Attributes).OfType<SOSalesAcctSubDefault.SubListAttribute>().FirstOrDefault<SOSalesAcctSubDefault.SubListAttribute>() as ISubscriber);
  }

  public virtual void CacheAttached(PXCache sender)
  {
    ((PXAggregateAttribute) this).CacheAttached(sender);
    SOSalesAcctSubDefault.SubListAttribute subListAttribute = (SOSalesAcctSubDefault.SubListAttribute) ((IEnumerable<PXEventSubscriberAttribute>) ((PXAggregateAttribute) this)._Attributes).First<PXEventSubscriberAttribute>((Func<PXEventSubscriberAttribute, bool>) (x => x.GetType() == typeof (SOSalesAcctSubDefault.SubListAttribute)));
  ...
  public static string MakeSub<Field>(PXGraph graph, string mask, object[] sources, Type[] fields) where Field : IBqlField
  {
    ...
    catch (PXMaskArgumentException ex)
    {
      ...
      {
        (object) new SOSalesAcctSubDefault.SubListAttribute().AllowedLabels[ex.SourceIdx],
