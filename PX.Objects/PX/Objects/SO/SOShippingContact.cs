...
// Type: PX.Objects.SO.SOShippingContact
...
[Serializable]
public class SOShippingContact : SOContact
{
  public new class PK : PrimaryKeyOf<
  #nullable disable
  SOShippingContact>.By<SOShippingContact.contactID>
  {
    public static SOShippingContact Find(PXGraph graph, int? contactID, PKFindOptions options = 0)
    {
      return (SOShippingContact) PrimaryKeyOf<SOShippingContact>.By<SOShippingContact.contactID>.FindBy(graph, (object) contactID, options);
    }
  }
  ...
  public new static class FK
  {
    public class Customer : 
      PrimaryKeyOf<PX.Objects.AR.Customer>.By<PX.Objects.AR.Customer.bAccountID>.ForeignKeyOf<SOShippingContact>.By<SOShippingContact.customerID>
    {
    }

    public class CustomerContact : 
      PrimaryKeyOf<ARContact>.By<ARContact.contactID>.ForeignKeyOf<SOShippingContact>.By<SOShippingContact.customerContactID>
    {
    }
  }
  ...
  public new abstract class customerContactID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    SOShippingContact.customerContactID>
  {
  }
  ...
  public new abstract class isDefaultContact : 
    ...
    IBqlBool, bool>.Field<
    #nullable disable
    SOShippingContact.isDefaultContact>
  {
  }
  ...
  public new abstract class overrideContact : 
    ...
    IBqlBool, bool>.Field<
    #nullable disable
    SOShippingContact.overrideContact>
  {
  }
