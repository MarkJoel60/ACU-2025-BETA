...
// Type: PX.Objects.SO.Unassigned.SOShipLineSplit
...
#nullable enable
namespace PX.Objects.SO.Unassigned;
  ...
  IItemPlanSource
{
  ...
  [PXDBInt(IsKey = true)]
  [PXDefault]
  [PXLineNbr(typeof (PX.Objects.SO.SOShipment.lineCntr), DecrementOnDelete = false)]
  ...
  [PXDefault(typeof (Selector<SOShipLineSplit.inventoryID, PX.Objects.IN.InventoryItem.baseUnit>))]
