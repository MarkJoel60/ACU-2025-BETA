...
// Type: PX.Objects.SO.SOUnbilledTax2Attribute
...
public class SOUnbilledTax2Attribute : SOUnbilledTaxAttribute
{
    ...
    : base(ParentType, TaxType, TaxSumType)
  {
    ...
    this._Attributes.Add((PXEventSubscriberAttribute) new PXUnboundFormulaAttribute(typeof (SOLine2.curyUnbilledAmt), typeof (SumCalc<SOOrder.curyUnbilledLineTotal>)));
    this._Attributes.Add((PXEventSubscriberAttribute) new PXUnboundFormulaAttribute(typeof (Mult<SOLine2.curyUnbilledAmt, Sub<decimal1, Mult<SOLine2.groupDiscountRate, SOLine2.documentDiscountRate>>>), typeof (SumCalc<SOOrder.curyUnbilledDiscTotal>)));
  }
