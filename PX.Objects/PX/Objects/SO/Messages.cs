...
public static class Messages
{
  ...
  public const string SOSetupCrossSellExcludedItemClasses = "SO Setup Cross Sell Excluded Item Classes";
  ...
  public const string OrchestrationPlanLine = "Orchestration Plan Line";
  public const string OrderOrchestrationSettings = "Order Orchestration Settings";
  public const string OrchestrationOrderLine = "Order Orchestration Line";
  public const string OrchestrationOrderSummaryLine = "Order Orchestration Summary Line";
  ...
  public const string CreditCardProcessingIsDisabled = "The operation cannot be performed because the financial period of the current date is either closed, inactive, or does not exist for the {0} company. To process the payment with a credit card, EFT, or POS terminal, create or reopen the financial period.";
  ...
  public const string InvoicedLineCannotBeDeleted = "The line cannot be deleted because it is linked to the {0} invoice.";
  ...
  public const string Availability_AllocatedInfo_Project = "Project/Total: On Hand {1}/{5} {0}, Available {2}/{6} {0}, Available for Shipping {3}/{7} {0}, Allocated {4} {0}";
  ...
  public const string ReceivedLineWarehouseUpdating = "The warehouse cannot be changed because the line is linked to the {0} purchase order.";
  ...
  public const string CompletedSOLineHasIncompleteSplit = "The shipment cannot be created because the {0} order has the completed line {1} with item {2} and incomplete splits in the Line Details dialog box. Change the order status to On Hold and clear the Completed check box in line {1}.";
  ...
  public const string TranWillBeReauthorizedWarning = "The selected transaction will be reauthorized automatically after voiding if Reauthorization Retry Delay (Hours) is set to 0 for the processing center on the Processing Centers tab of the Payment Methods (CA204000) form.";
  ...
  public const string ReturnReason = "Return";
  ...
  public const string CantCancelWhenCancelationAmountDiffers = "The {0} cancellation credit memo cannot be released because its balance differs from the balance of the {1} original invoice. The discrepancy may appear due to altered taxes, discounts, or freight recalculation. Delete the cancellation credit memo and create it again.";
  public const string CantCorrectWhenCancellationAmountDiffers = "The correction invoice cannot be released because the balance of the generated cancellation credit memo will differ from the balance of the {0} original invoice. Delete the correction invoice and try to cancel the original invoice instead.";
  public const string CantCancelWhenExternalTaxFlagDiffers = "The cancellation credit memo cannot be released because its balance differs from the balance of the {0} original invoice due to the calculation of external taxes. Make sure that the External Tax Provider check box on the Tax Zones (TX206000) form is in the same state as it was when the original invoice was created and try to cancel the original invoice again.";
  ...
  public const string OrderWithAppliedPaymentsCantBeDeleted = "Cannot delete the {0} sales order. There are one or more payments linked to this sales order. To delete the sales order, remove the payment application.";
  ...
  public const string PrepaymentZeroBecauseTotalIsNegative = "The amount is set to 0 because the Order Total is negative.";
  ...
  public const string CannotDeleteOrCancelChildAllocatedInBlanket = "The {0} child order cannot be deleted or canceled because the {1} item is allocated in the related {2} blanket sales order and the available quantity of the item is negative. To delete or cancel the child order, complete the related line with the item in the blanket sales order.";
  ...
  public const string IntercompanyShipmentAlreadyContainsOrderWithDifferentBranchID = "You cannot add the sales order to the shipment because the shipment already has a related sales order with a different branch ID.";
  ...
  public const string ShopForRatesDisabledDueToUnlimitedPackages = "The shipment was imported from an external system without validation of the number of packages against the license restriction. You cannot shop for rates.";
  public const string ShopForRatesButtonCaption = "Shop for Rates";
  public const string GetLabelsDisabledDueToUnlimitedPackages = "The shipment was imported from an external system without validation of the number of packages against the license restriction. You cannot get labels for this shipment in Acumatica ERP.";
  public const string ShipViaNotActive = "The Ship Via code is not active.";
  public const string BaseUnitQtyIsZeroBecauseOfLowPrecision = "Due to the insufficient decimal precision, the quantity in this line is calculated as 0 in the {0} UOM. To confirm the shipment, either change the UOM in line {1} of the related sales order, or change the decimal precision on the Companies (CS101500) form.";
  public const string PaymentHasAvailableBalance = "The {0} {1} has the available balance of {2} {3} that can be applied to the current {4} document with the {5} ref. number.";
  public const string AuthorizedAmountGreaterThanUnpaidBalance = "The unpaid balance for the current document is {0}. You cannot increase the authorized amount for an amount greater than the unpaid balance amount.";
  public const string IncreasedAmountMustBeGreaterThanCurrent = "The increased authorized amount must be greater than the current authorized amount.";
  public const string IncreasedAmountWithAvailableSOBalanceError = "The {0} document with the {1} ref. number has the balance of {2} {3} that is applied to the related {4} document with the {5} ref. number. You must transfer the application amount from the related sales order to the current {6} document with the {7} ref. number before increasing the authorized amount of the {8} document with the {9} ref. number.";
  public const string DefaultScaleNotFound = "The default scale is not found in the system.";
  public const string ScaleMissing = "The scale is not found in the system.";
  public const string ScaleDisconnected = "No information from the {0} scale. Check the connection of the scale.";
  public const string ScaleNoBox = "No information from the {0} scale. Make sure that the items are on the scale.";
  public const string OrderTypeCannotUse = "The selected order plan type cannot be used with the current state of the Require Stock Allocation check box. Select another order plan type.";
  ...
  public const string CannotCreatePOReceiptWhenPOIsNotOpen = "The purchase receipt cannot be created because the related {0} purchase order has the {1} status.";
  public const string CannotCreatePOReceiptWhenCustomerSOIsOnHold = "The purchase receipt cannot be created because the linked {0} sales order has the On Hold status.";
  public const string CannotCreateAPBillWhenPOReceiptUnderCorrection = "The AP bill cannot be created because {0} purchase receipt has the Under Correction status.";
  ...
  public const string InterCompanySOOrderOrderQtyValidation = "The quantity cannot be changed for a line of an intercompany sales order. Click Line Details on the table toolbar and correct the quantities in the line splits to have {0} in total.";
  public const string OrchestrateOrder = "Orchestrate Order";
  public const string SomeLinesOrchestratedWarning = "Some lines have already been orchestrated. Re-orchestration will be applied only to lines that are not marked as orchestrated.";
  public const string NoOrchestrationLinesFound = "No lines have been found for order orchestration. Check Trace for more details.";
  public const string UnableToOrchestrateOrderForOrderType = "Order orchestration is available only for order types with the SO or RMA automation behavior, the Process Shipments check box selected, and the active Issue operation on the Order Types (SO201000) form.";
  public const string NumberOfWarehousesCannotBeLessThan1 = "The number of fulfillment warehouses cannot be less than 1.";
  public const string OrderTotalMismatchCancelOrchestration = "The orchestration is canceled because the calculated order total differs from the order total before the orchestration. Possible reasons include rounding differences in line taxes or discounts, manually changed discounts or prices, or quantity tiers defined in the price lists for the items.";
  public const string PlanWithSourceWarehouseAlreadyExist = "The {0} source warehouse has already been specified in the {1} orchestration plan.";
  public const string PlanWithZoneAlreadyExist = "The {0} shipping zone has already been specified in the {1} orchestration plan.";
  public const string CannotDeleteOrchestrationPlan = "The orchestration plan cannot be deleted because at least one order orchestration has been performed for this plan.";
  public const string WarehouseAlreadyExist = "The warehouse has already been added to the plan.";
  public const string PriorityCannotBeDuplicated = "This priority already exists.";
  public const string OrderOrchestrationFailed = "The order cannot be orchestrated completely.";
  public const string OrderTypeConfigurationNotSupported = "The configuration does not support orchestration.";
  public const string MissingCountryState = "The order’s shipping zone or destination address is missing or incomplete.";
  public const string MissingShippingZoneForCountryState = "The shipping zone has not been found for the {0} country or {1} state.";
  public const string MissingShippingZoneForCountry = "The shipping zone has not been found for the {0} country.";
  public const string NoOrchestrationPlanFound = "No valid orchestration plan has been found for this order.";
  public const string NoOrderlinesFoundWithOpenUnallocatedQuantities = "No order lines with open unallocated quantities have been found for the orchestration.";
  public const string InventoryInsufficientInAlternateWarehouse = "The order cannot be orchestrated due to insufficient stock across all available warehouses.";
  public const string OrderTotalMismatch = "The order total after the {0} orchestration does not match the {1} order total before the orchestration.";
  public const string SkippedMarkedLines = "Lines marked for purchase, production, or linked to a blanket sales order were skipped from the orchestration.";
  public const string SkippedLinkedLines = "Lines linked to a shipment, purchase order, or another document were skipped from the orchestration.";
  public const string LimitOfWarehousesInAlgorithmExceeded = "The total number of warehouses used in the orchestration cannot exceed {0}. Review the selected orchestration plans and reduce this number.";
  public const string SelectedOrchestrationPlans = "The following orchestration plans were selected: {0}.";
  public const string CannotActivateOrchestrationPlan = "You cannot activate the orchestration plan because at least one warehouse in this plan is inactive.";
  public const string UsedInOrchestrationPlan = "You cannot deactivate the warehouse because it is included in at least one active orchestration plan.";
  public const string DoNotOrchestrate = "Do Not Orchestrate";
  public const string DestinationPriority = "Destination Priority";
  public const string WarehousePriority = "Warehouse Priority";
  public const string OrchestrationNone = "None";
  public const string OrchestrationNew = "New";
  public const string OrchestrationProcessed = "Processed";
  public const string OrchestrationUnsuccessful = "Unsuccessful";
  ...
  public const string FreightDesc = "Freight";
  ...
  public const string FreightCostNotUptoDate = "The freight cost is not up to date.";
  public const string RateAmountNotUptoDate = "The amount is not up to date.";
  public const string CaptureWeight = "Capture Weight";
  ...
  public const string IncreaseCCPayment = "Increase Authorized Amount";
  ...
  public const string SOLineMultipleLotSerNumbersError = "Multiple lot or serial numbers cannot be specified for a single line with the {0} item because the Specify Lot/Serial Price and Description check box is selected for the lot or serial class of this item on the Lot/Serial Classes (IN207000) form. Add a separate line for each lot or serial number.";
  public const string SOLineEmptyLotSerNumbersError = "The sales order cannot be saved because a lot or serial number is not specified for the {0} item. Specify the number, or clear the Specify Lot/Serial Price and Description check box for the lot or serial class of the item on the Lot/Serial Classes (IN207000) form.";
  public const string SOLineLotSerNumbersAutoCreateIssueError = "The order cannot be saved because entering a lot or serial number is required for a line with the {0} item. To save the order, clear the Auto Create Issue check box in the line.";
  public const string OriginalGroupDiscount = "Group discounts from the related sales order";
  public const string OriginalDocumentDiscount = "Document discounts from the related sales order";
