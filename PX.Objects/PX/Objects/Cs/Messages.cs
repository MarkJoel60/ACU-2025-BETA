...
public static class Messages
{
  ...
  public const string SegmentHasChildren = "The {0} segment cannot be deleted as it is overridden in at least one segmented key. To be able to delete the segment, you need to first delete the segments that have the Override check box selected in the following segmented keys: {1}.";
  ...
  public const string StartNumMustBeGreaterEndNum = "The start number must be less than the end number.";
  ...
  public const string DayToDayFrom = "Day To must be later than or the same as Day From.";
  ...
  public const string CountryAndStateCannotBeDuplicated = "The selected combination of the country and state is already assigned to the {0} shipping zone.";
  public const string AlreadyCountryAddedWithState = "A line with the same country and a specific state has already been added to the {0} shipping zone. When adding another line for this country, you need to specify a different state.";
  public const string AlreadyCountryConfiguredWithoutState = "Another line with the same country and no specific state has already been added to the {0} shipping zone. As a result, all states within that country are automatically included in the shipping zone.";
  public const string ShippingZoneInOrchestrationPlan = "The {0} shipping zone cannot be deleted because it is specified in the following orchestration plans: {1}. Deactivate the orchestration plans first.";
  [Obsolete]
  ...
  public const string CarrierNotActive = "The carrier is not active.";
  public const string DayToLessThan31 = "The Day To value must be less than 31.";
  ...
  public const string ShippingZoneLine = "Shipping Zone Line";
  ...
  public const string AddCountryState = "Add Country/State";
  ...
  public const string NADeliveryType = "N/A";
  public const string ParcelDeliveryType = "Parcel";
  public const string LTLFTLDeliveryType = "LTL/FTL";
  ...
  public const string AccountClass = "Account Class";
  public const string AccountShort = "Acc.";
  public const string SubShort = "Sub.";
  public const string PeriodShort = "Period";
  public const string OffsetYears = "Offset (Year)";
  public const string OffsetPeriod = "Offset (Period)";
