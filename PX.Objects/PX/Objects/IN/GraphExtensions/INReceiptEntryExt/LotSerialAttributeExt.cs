...
// Type: PX.Objects.IN.GraphExtensions.INReceiptEntryExt.LotSerialAttributeExt
...
public class LotSerialAttributeExt : 
  ...
  #nullable disable
  INReceiptEntry, PX.Objects.IN.INRegister, INTran, INTranSplit, INRegisterItemLotSerialAttributesHeader>,
  ICopyLotSerialAttributesExt<INRegisterItemLotSerialAttributesHeader>
{
  ...
  protected override INRegisterItemLotSerialAttributesHeader GetAttributesHeader(
    ...
    bool insert = false)
  {
    PX.Objects.IN.INRegister current = ((PXSelectBase<PX.Objects.IN.INRegister>) this.Base.CurrentDocument).Current;
