...
public static class Messages
{
  ...
  public const string StatusCheck_QtyNegative = "The available quantity of the {0} {1} item is not sufficient in the {2} warehouse.";
  ...
  public const string StatusCheck_StandardCostExceedsBaseCurrencyPrecision = "The total cost of the {0} item in the {1} warehouse differs from the quantity on hand multiplied by standard cost. Recalculate the item costs at the warehouse on the Update Standard Costs (IN502000) form by selecting the Revalue Inventory check box and processing the item.";
  public const string StandardCostExceedsBaseCurrencyPrecision = "The decimal precision of the cost of the {0} item with the Standard valuation method exceeds the currency precision. Consider decreasing the Price/Cost Decimal Places on the Companies (CS101500) form.";
  ...
  public const string Availability_Info_Project = "Project/Total: On Hand {1}/{4} {0}, Available {2}/{5} {0}, Available for Shipping {3}/{6} {0}";
  public const string Availability_ActualInfo = "On Hand {1} {0}, Available {2} {0}, Available for Shipping {3} {0}, Available for Issue {4} {0}";
  public const string Availability_ActualInfo_Project = "Project/Total: On Hand {1}/{5} {0}, Available {2}/{6} {0}, Available for Shipping {3}/{7} {0}, Available for Issue {4}/{8} {0}";
  ...
  public const string MissingGlobalUnitConversion = "No rule for converting the {0} unit of measure to the {1} unit of measure has been set up on the Units of Measure (CS203500) form.";
  ...
  public const string NonStockKitClearingRequireShippingError = "The check box cannot be cleared because the item is a kit and it contains at least one component that requires shipping.";
  public const string NonStockKitAddingItemError = "The item cannot be added to the kit specification because it can contain only non-stock items that do not require shipping.";
  public const string NonstockKitIsInUse = "The specification cannot be edited or deleted because the {0} non-stock kit is used in the following document: {1} {2}. To correct the specification, process the document to completion or delete it.";
  ...
  public const string UseDefaultReasonCodeinTransfersSetTrueButDefaultTransferReasonCodeNotSet = "The Use Default Reason Code in Transfers check box is selected on the Warehouse Management tab. Select the default reason code or clear the check box.";
  ...
  public const string CannotManuallySelectReceiptTransactionType = "The Receipt transaction type is used only in issues that are generated automatically for purchase receipt correction.";
  public const string CannotManuallySelectAdjTransactionType = "The Adjustment transaction type is used only in issues that are generated automatically for purchase receipt correction.";
  public const string NegativeAvgCostByNegativeQtyInWarehouse = "Negative average cost is caused by a negative quantity of the item in one of its warehouses.";
  public const string LotSerialAttributesPriceExist = "The check box cannot be selected because prices are specified on the Sales Prices (AR202000) form for the following items of the class: {0}.";
  public const string LotSerialAttributesPriceWorksheetExist = "The check box cannot be selected because there is at least one unreleased worksheet on the Sales Price Worksheets (AR202010) form for the following items of the class: {0}.";
  public const string LotSerialAttributesAreRequiredForReceipt = "At least one required attribute has not been specified for the {0} lot or serial number of the {1} item in the Line Details dialog box. Specify all required attributes to save the document.";
  public const string ClassLotSerialAttributeValuesExist = "The attribute cannot be deleted because at least one of its values is assigned to an item that has already been received.";
  public const string ItemLotSerialAttributeValuesExist = "The attribute cannot be deleted because at least one of its values is assigned to an item that has already been received.";
  public const string LotSerialAttributeDeleteWarning = "The attribute will be deleted from the settings of the item. Do you want to proceed?";
  ...
  public const string LotSerClassSpecifyPriceChangeErrorDetails = "The state of the Specify Lot/Serial Price and Description check box cannot be changed because items with this lot or serial class exist in the following open sales orders: {0}.";
  public const string InventorySearchWarnNoFts = "The search by a phrase or a list of keywords might not work because the Full-Text Search feature is not enabled. Contact an administrative user to enable the feature.";
  public const string FullTextSearchIndexShouldBeRebuilt = "Rebuild the search index for the InventoryItem entity on the Rebuild Full-Text Entity Index (SM209500) form.";
  public const string FullTextSearchIndexShouldBeRebuiltToUseFeature = "To use this feature, rebuild the search index for the InventoryItem entity on the Rebuild Full-Text Entity Index (SM209500) form.";
  public const string FullTextSearchIsDisabled = "This feature is available only if full-text search is enabled for the MS SQL database.";
  public const string FullTextSearchIsUsedByOtherTenants = "This feature is already enabled in the following tenants: {0}. For optimal results, you need to increase the maximum number of results in the web.config file. Alternatively, you can disable this feature in other tenants and clear their search indexes on the Rebuild Full-Text Entity Index (SM209500) form. Do you want to enable this feature?";
  ...
  public const string LotSerialAttributeValue = "Value";
  ...
  public const string INItemSiteHistByLatestSDate = "IN Item Site History by Latest SDate";
  ...
  public const string LotSerClassAttribute = "Lot/Serial Class Attribute";
  public const string ItemLotSerialAttribute = "Inventory Item Lot/Serial Attribute";
  public const string INRegisterItemLotSerialAttributesHeader = "IN Document Item Lot/Serial Attributes Header";
  public const string AddLotSerialHeader = "Add Lot/Serial Header";
  public const string INItemLotSerialAttributesHeader = "Inventory Item Lot/Serial Attributes Header";
  public const string INItemLotSerialAttributesHeaderSelected = "Inventory Item Lot/Serial Attributes Header Selected";
  ...
  public const string CalculateMC = "Calculate Movement Class";
  public const string CalculateAndUpdateMC = "Calculate and Update Movement Class";
  public const string UseAttributesFromFirstLine = "Use Attributes from First Line";
  ...
  public const string RandomlySelectedItems = "Random Items";
  ...
  public const string AllClasses = "All Classes";
  public const string SameClass = "Same Class";
  public const string OtherClasses = "Other Classes";
  public const string AnyPrice = "Any Price";
  public const string LowerPrice = "Lower Price";
  ...
  public const string CantActivateVariantAttributeForMatrixWithItems = "The {0} attribute cannot be activated because it is a variant attribute, and at least one matrix item exists for the template item. Remove the matrix items of the template item first.";
  public const string CantDeactivateVariantAttributeForMatrixWithItems = "The {0} attribute cannot be deactivated because it is a variant attribute, and at least two matrix items exist with different values. Remove the matrix items of the template item first.";
  public const string VariantAttributeDeactivationWarningForMatrixWithItems = "This action will deactivate the attribute for the template item and its related matrix items. Do you want to continue?";
  public const string CantDeactivateTheLastVariantAttribute = "The {0} attribute cannot be deactivated because it is a variant attribute, and at least one matrix item exists for the template item. Remove the matrix items of the template item first.";
