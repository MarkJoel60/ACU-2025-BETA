...
// Type: PX.Objects.IN.AffectedAvailability.AdjTranBySiteLotSerial
...
/// <exclude />
[PXHidden]
[PXProjection(typeof (Select5<INTran, InnerJoin<InventoryItem, On<INTran.FK.InventoryItem>, InnerJoin<INItemClass, On<InventoryItem.FK.ItemClass>, InnerJoin<INLotSerClass, On<InventoryItem.FK.LotSerialClass>, LeftJoin<INSiteLotSerial, On<INSiteLotSerial.inventoryID, Equal<INTran.inventoryID>, And<INSiteLotSerial.siteID, Equal<INTran.siteID>, And<INSiteLotSerial.lotSerialNbr, Equal<INTran.lotSerialNbr>>>>>>>>, Where<INTran.docType, Equal<INDocType.adjustment>, And<Where<INItemClass.negQty, Equal<False>, Or<Where<INLotSerClass.lotSerTrack, In3<INLotSerTrack.serialNumbered, INLotSerTrack.lotNumbered>, And<INLotSerClass.lotSerAssign, Equal<INLotSerAssign.whenReceived>>>>>>>, Aggregate<GroupBy<INTran.docType, GroupBy<INTran.refNbr, GroupBy<INTran.inventoryID, GroupBy<INTran.siteID, GroupBy<INTran.lotSerialNbr, Max<INSiteLotSerial.qtyHardAvail, Sum<INTran.baseQty>>>>>>>>>))]
public class AdjTranBySiteLotSerial : PXBqlTable, IBqlTable, IBqlTableSystemDataStorage
{
  ...
  [PXDBString(100, BqlField = typeof (INTran.lotSerialNbr), IsKey = true, IsUnicode = true, InputMask = "")]
  ...
  #nullable disable
  AdjTranBySiteLotSerial.docType>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  AdjTranBySiteLotSerial.inventoryID>
  {
  }
  ...
  public abstract class lotSerialNbr : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    AdjTranBySiteLotSerial.lotSerialNbr>
  {
  }
  ...
  IBqlString, string>.Field<
  #nullable disable
  AdjTranBySiteLotSerial.baseUnit>
  {
  }
  ...
  public abstract class qtyHardAvail : 
    ...
    #nullable disable
    AdjTranBySiteLotSerial.qtyHardAvail>
  {
  }
  ...
  public abstract class qtyAdjusted : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    AdjTranBySiteLotSerial.qtyAdjusted>
  {
  }
}
