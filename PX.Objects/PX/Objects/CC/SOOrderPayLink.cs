...
// Type: PX.Objects.CC.SOOrderPayLink
...
/// </summary>
public sealed class SOOrderPayLink : PXCacheExtension<
#nullable disable
PX.Objects.SO.SOOrder>
{
  ...
  [PXSelector(typeof (Search2<CCProcessingCenter.processingCenterID, InnerJoin<PX.Objects.CA.CashAccount, On<CCProcessingCenter.cashAccountID, Equal<PX.Objects.CA.CashAccount.cashAccountID>>, InnerJoin<CCProcessingCenterBranch, On<CCProcessingCenterBranch.processingCenterID, Equal<CCProcessingCenter.processingCenterID>>>>, Where<PX.Objects.CA.CashAccount.curyID, Equal<Current<PX.Objects.SO.SOOrder.curyID>>, And<CCProcessingCenter.allowPayLink, Equal<True>, And<CCProcessingCenter.isActive, Equal<True>, And<CCProcessingCenterBranch.branchID, Equal<Current<PX.Objects.SO.SOOrder.branchID>>>>>>>), DescriptionField = typeof (CCProcessingCenter.name))]
  ...
  public abstract class processingCenterID : 
    ...
    #nullable disable
    SOOrderPayLink.processingCenterID>
  {
  }
