...
public static class Messages
{
  ...
  public const string ContactNotFoundOrInactive = "The {0} contact does not exist or is inactive in the {1} processing center.";
  ...
  public const string ErrorOccurredWhileUpdatingTerminal = "An error occurred while updating terminal {0}: {1}";
  public const string ErrorOccurredWhileCreatingTerminal = "An error occurred while creating terminal {0}: {1}";
  public const string OneOrMoreErrorOccurred = "One or more errors occurred. See Trace log for details.";
}
