...
// Type: PX.Objects.AR.SubAccountMaskAttribute
...
public sealed class SubAccountMaskAttribute : PXEntityAttribute
{
  ...
  {
    PXDimensionMaskAttribute dimensionMaskAttribute = new PXDimensionMaskAttribute(this._DimensionName, this._MaskName, "L", new ARAcctSubDefault.ClassListAttribute().AllowedValues, new ARAcctSubDefault.ClassListAttribute().AllowedLabels);
  ...
  public virtual void GetSubscriber<ISubscriber>(List<ISubscriber> subscribers) where ISubscriber : class
  {
    ...
    subscribers.Remove(((IEnumerable) ((PXAggregateAttribute) this)._Attributes).OfType<ARAcctSubDefault.ClassListAttribute>().FirstOrDefault<ARAcctSubDefault.ClassListAttribute>() as ISubscriber);
  }

  public virtual void CacheAttached(PXCache sender)
  {
    ((PXAggregateAttribute) this).CacheAttached(sender);
    ARAcctSubDefault.ClassListAttribute classListAttribute = (ARAcctSubDefault.ClassListAttribute) ((IEnumerable<PXEventSubscriberAttribute>) ((PXAggregateAttribute) this)._Attributes).First<PXEventSubscriberAttribute>((Func<PXEventSubscriberAttribute, bool>) (x => x.GetType() == typeof (ARAcctSubDefault.ClassListAttribute)));
  ...
  public static string MakeSub<Field>(PXGraph graph, string mask, object[] sources, Type[] fields) where Field : IBqlField
  {
    ...
    catch (PXMaskArgumentException ex)
    {
      ...
      {
        (object) new ARAcctSubDefault.ClassListAttribute().AllowedLabels[ex.SourceIdx],
