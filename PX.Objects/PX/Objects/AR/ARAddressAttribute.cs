...
// Type: PX.Objects.AR.ARAddressAttribute
...
/// <summary>Internaly, it expects ARAddress as a IAddress type.</summary>
...
/// </param>
public class ARAddressAttribute(Type SelectType) : AddressAttribute(typeof (ARAddress.addressID), typeof (ARAddress.isDefaultBillAddress), SelectType)
{
  public override void CacheAttached(PXCache sender)
  {
    base.CacheAttached(sender);
    PXGraph.FieldVerifyingEvents fieldVerifying = sender.Graph.FieldVerifying;
    ARAddressAttribute addressAttribute = this;
    ...
    fieldVerifying.AddHandler<ARAddress.overrideAddress>(pxFieldVerifying);
  }

  public override void DefaultRecord(PXCache sender, object DocumentRow, object Row)
  {
    this.DefaultAddress<ARAddress, ARAddress.addressID>(sender, DocumentRow, Row);
  }
  ...
  public override void CopyRecord(
    ...
    bool clone)
  {
    this.CopyAddress<ARAddress, ARAddress.addressID>(sender, DocumentRow, SourceRow, clone);
  }
  ...
  public virtual void Record_Override_FieldVerifying(PXCache sender, PXFieldVerifyingEventArgs e)
  {
    ...
    try
    {
      this.Address_IsDefaultAddress_FieldVerifying<ARAddress>(sender, e);
    }
    finally
    {
