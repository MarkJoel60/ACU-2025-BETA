...
/// such as <see cref="P:PX.Objects.AR.ARInvoice.BillContactID">an invoice's billing contact</see>.
/// An <see cref="T:PX.Objects.AR.ARContact" /> record is a copy of customer location's
  ...
  IEmailMessageTarget
{
  ...
  /// <summary>
  /// An alias for <see cref="P:PX.Objects.AR.ARContact.CustomerID" />, which exists
  ...
  /// <summary>
  /// An alias for <see cref="P:PX.Objects.AR.ARContact.CustomerContactID" />,
  ...
  /// referenced by the <see cref="P:PX.Objects.AR.ARContact.CustomerContactID" /> field.
  /// </summary>
  [PXDBBool]
  [PXUIField]
  [PXDefault(true)]
  ...
  /// </summary>
  /// <value>
  /// This field is the inverse of <see cref="P:PX.Objects.AR.ARContact.IsDefaultContact" />.
  /// </value>
  [PXBool]
  [PXUIField]
  public virtual bool? OverrideContact
  {
    [PXDependsOnFields(new System.Type[] {typeof (ARContact.isDefaultContact)})] get
    {
  ...
  public class PK : PrimaryKeyOf<ARContact>.By<ARContact.contactID>
  {
    public static ARContact Find(PXGraph graph, int? contactID, PKFindOptions options = 0)
    {
      return (ARContact) PrimaryKeyOf<ARContact>.By<ARContact.contactID>.FindBy(graph, (object) contactID, options);
    }
  }
  ...
  public static class FK
  {
    public class Customer : 
      PrimaryKeyOf<PX.Objects.AP.Vendor>.By<PX.Objects.AP.Vendor.bAccountID>.ForeignKeyOf<ARContact>.By<ARContact.customerID>
    {
    }

    public class CustomerContact : 
      PrimaryKeyOf<PX.Objects.CR.Contact>.By<PX.Objects.CR.Contact.contactID>.ForeignKeyOf<ARContact>.By<ARContact.customerContactID>
    {
    }
  }
  ...
  public abstract class lastModifiedByScreenID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    ARContact.lastModifiedByScreenID>
  {
  }
  ...
  public abstract class lastModifiedDateTime : 
    ...
    IBqlDateTime, DateTime>.Field<
    #nullable disable
    ARContact.lastModifiedDateTime>
  {
  }
