...
// Type: PX.Objects.AR.ARSalesPriceMaintVisibilityRestriction
...
public class ARSalesPriceMaintVisibilityRestriction : PXGraphExtension<ARSalesPriceMaint>
{
  ...
  public virtual void Initialize()
  {
    ...
    ((PXSelectBase<ARSalesPrice>) this.Base.Records).WhereAnd<Where<PX.Objects.CR.BAccount.cOrgBAccountID, RestrictByUserBranches<Current<AccessInfo.userName>>, Or<ARSalesPrice.customerID, IsNull>>>();
  }
}
