...
public static class Messages
{
  ...
  public const string Entry_LE = "The amount must be less than or equal to {0}.";
  public const string Entry_GE = "The amount must be greater than or equal to {0}.";
  ...
  public const string CashSaleOutOfBalance = "The payment amount should be less than or equal to the invoice amount.";
  ...
  public const string RefundProhibitedBecauseOfUnreleasedApplications = "The {0} cannot be refunded because it has an unreleased application to the following document: {1} {2}.";
  ...
  public const string WRN_ProcessStatementDetectsUnappliedPayments = "At least one customer with unapplied payment documents has been found. Before preparing the statement, apply all payments. You can run the auto-application process on the Auto-Apply Payments (AR506000) form.";
  ...
  public const string WRN_ProcessStatementDetectsOverdueInvoicesAndUnappliedPayments = "At least one customer with unapplied payments or overdue charges has been found. Before preparing the statement, apply payments and calculate any overdue charges. You can run the auto-application process on the Auto-Apply Payments (AR506000) form.";
  ...
  public const string ERR_IncorrectRejectTranType = "The {0} transaction is rejected.";
  ...
  public const string ERR_IncorrectExpiredPaymentTranStatus = "Authorization for card transaction in the {0} document with the {1} ref. number is expired. Void the authorization and re-authorize the card payment.";
  ...
  public const string ERR_CanImportVoidingTransactionOnlyWithUnknownType = "The {0} transaction has not been imported. Set the Tran. Type parameter of the API call to UKN and re-import the transaction.";
  ...
  public const string ERR_FieldsAreEmptySimultaneously = "Both '{0}' and '{1}' cannot be empty at the same time.";
  ...
  public const string Application_Amount_Cannot_Exceed_Document_Amount = "The total application amount must not exceed the document amount.";
  ...
  public const string ERR_CCProcessingDoesNotSupportIncreaseAuthorizedAction = "The {0} processing center does not support the Increase Authorized Amount action.";
  ...
  public const string ARPaymentIsIncludedIntoCADepositAndCannotBeVoided = "This payment is included in the {0} bank deposit. It cannot be voided until the deposit is released or the payment is excluded from it.";
  public const string ARPaymentIsIncludedIntoCADepositAndRejectionCannotBeRecorded = "This payment is included in the {0} bank deposit. Rejection cannot be recorded until the deposit is released or the payment is excluded from it.";
  public const string ARRefundIsIncludedIntoCADepositAndCannotBeVoided = "This refund is included in the {0} bank deposit. It cannot be voided until the deposit is released or the refund is excluded from it.";
  ...
  public const string InactiveCreditCardMayNotBeProcessed = "The {0} card/account number is inactive on the Customer Payment Methods (AR303010) form and cannot be processed.";
  ...
  public const string PaidPPDReverse = "This document has been paid in full. To close the document, apply the cash discount by generating a credit memo on the Generate AR Tax Adjustments (AR504500) form. To reverse the document, click Reverse on the More menu.";
  ...
  public const string ReverseRetainage = "The Reverse command cannot be used for invoices with retainage and for retainage documents. To reverse this document, click Reverse and Apply to Memo on the More menu.";
  public const string ReversePaymentsByLines = "The Reverse and Apply to Memo command cannot be used if the Pay by Line check box is selected for a document. To reverse this document, click Reverse on the More menu.";
  ...
  public const string ReverseRetainageWithNonReversedDocuments = "The {0} document with the {1} ref. number cannot be reversed because it has been fully or partially settled.";
  ...
  public const string DuplicateARDocumentMessage = "A document of the {0} type with the {1} reference number already exists in the system. To proceed, enter another reference number for the reversing document.";
  ...
  public const string DocumentNotApproved = "The document cannot be created on this form because an approval map is active on the Accounts Receivable Preferences (AR101000) form.";
  ...
  public const string TaxesAreNotSupportedInPrepaymentInvoices = "{0} taxes are not supported for prepayment invoices.";
  ...
  public const string ExternalTaxZoneProhibited = "Tax zones with the External Tax Provider check box selected are not supported for prepayment invoices.";
  ...
  public const string UnableToApplyDelta = "The {4} {0} amount cannot be applied to the {2} {1} document whose unpaid balance is {5} {3}.";
  public const string UnableToCreateCPM = "The customer payment method was not created for this credit card transaction. Processing Center response: {0}";
  public const string SalesPriceCanntoBeSavedForLotSerialNumberedItem = "The sales price cannot be saved because the Specify Lot/Serial Price and Description check box is selected for the lot or serial class of the {0} item on the Lot/Serial Classes (IN207000) form. Clear the check box, or specify the price for the lot or serial numbers of the item on the Lot/Serial Details form.";
  ...
  public const string BalanceSummary = "Balance by Documents";
  public const string CustomerBalance = "Current Balance";
  public const string CustomerRetainedBalance = "Retained Balance";
  public const string CustomerDepositsBalance = "Prepayment Balance";
  public const string Difference = "Balance Discrepancy";
  public const string FormatStringOnePlaceholder = "{0}";
  public const string LabelBalance = "Balance";
  public const string LabelUnpaidBalance = "Unpaid Balance";
  ...
  public const string IncludeNonOverdue = "Add Coming-Due Documents";
  ...
  [Obsolete("This field has been deprecated and will be removed in Acumatica ERP 2020R2.")]
  ...
  public const string TotalBalance = "Total Balance";
  public const string TotalPrepayments = "Total Prepayments";
  public const string TotalRetainedBalance = "Total Retained Balance";
  public const string CurrencySuffix = " (Currency)";
  public const string CuryTotalBalance = "Total Balance (Currency)";
  public const string CuryTotalPrepayments = "Total Prepayments (Currency)";
  public const string CuryTotalRetainedBalance = "Total Retained Balance (Currency)";
  ...
  public const string PrintVoidRefund = "Voided Refund";
  public const string PrintVoidPayment = "Voided Payment";
  public const string PrintFinCharge = "Overdue Charge";
  ...
  public const string PrintCashReturn = "Cash Return";
  public const string PrintPrepaymentInvoice = "Prepmt. Invoice";
  ...
  public const string CCPreAuthorizationIncreaseFailed = "Pre-Authorization Increase Failed";
  ...
  public const string CCRejected = "Rejected";
  ...
  public const string ProcessPrintInvoices = "Print Invoices";
  public const string ProcessEmailInvoices = "Email Invoices";
  public const string ProcessEmailPaymentReceipts = "Email Payment Receipts";
  ...
  public const string RecordEftRejection = "Record EFT Rejection";
  ...
  public const string DiscountTotalDescription = "Discount Total Adjustment";
