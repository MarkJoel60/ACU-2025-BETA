...
// Type: PX.Objects.AR.CCPaymentProcessing.Repositories.PaymentMethodDataReader
...
public class PaymentMethodDataReader : IPaymentMethodDataReader
{
  ...
  public PX.Objects.CA.PaymentMethod GetPaymentMethod()
  {
    return PX.Objects.CA.PaymentMethod.PK.Find(this.graph, this.paymentMethodID);
  }
}
