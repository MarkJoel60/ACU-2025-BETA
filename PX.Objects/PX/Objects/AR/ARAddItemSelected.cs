...
// Type: PX.Objects.AR.ARAddItemSelected
...
[PXProjection(typeof (Select2<PX.Objects.IN.InventoryItem, LeftJoin<INItemClass, On<INItemClass.itemClassID, Equal<PX.Objects.IN.InventoryItem.itemClassID>>, LeftJoin<INPriceClass, On<INPriceClass.priceClassID, Equal<PX.Objects.IN.InventoryItem.priceClassID>>, LeftJoin<INUnit, On<INUnit.inventoryID, Equal<PX.Objects.IN.InventoryItem.inventoryID>, And<INUnit.fromUnit, Equal<PX.Objects.IN.InventoryItem.salesUnit>, And<INUnit.toUnit, Equal<PX.Objects.IN.InventoryItem.baseUnit>>>>>>>, Where<PX.Objects.IN.InventoryItem.itemStatus, NotEqual<InventoryItemStatus.inactive>, And<PX.Objects.IN.InventoryItem.itemStatus, NotEqual<InventoryItemStatus.markedForDeletion>, And<PX.Objects.IN.InventoryItem.itemStatus, NotEqual<InventoryItemStatus.unknown>, And<CurrentMatch<PX.Objects.IN.InventoryItem, AccessInfo.userName>>>>>>), Persistent = false)]
[Serializable]
public class ARAddItemSelected : PXBqlTable, IPXSelectable, IBqlTable, IBqlTableSystemDataStorage
{
  ...
  [Owner(typeof (PX.Objects.IN.InventoryItem.priceWorkgroupID), BqlField = typeof (PX.Objects.IN.InventoryItem.priceManagerID), DisplayName = "Price Manager")]
  ...
  public abstract class itemClassDescription : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    ARAddItemSelected.itemClassDescription>
  {
  }
  ...
  public abstract class priceClassID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    ARAddItemSelected.priceClassID>
  {
  }
  ...
  public abstract class priceClassDescription : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    ARAddItemSelected.priceClassDescription>
  {
  }
  ...
  public abstract class curyUnitPrice : 
    ...
    #nullable disable
    ARAddItemSelected.curyUnitPrice>
  {
  }
  ...
  public abstract class priceWorkgroupID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    ARAddItemSelected.priceWorkgroupID>
  {
  }

  public abstract class priceManagerID : 
    BqlType<
    #nullable enable
    IBqlInt, int>.Field<
    #nullable disable
    ARAddItemSelected.priceManagerID>
  {
  }
