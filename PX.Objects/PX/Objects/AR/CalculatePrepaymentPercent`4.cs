...
// Type: PX.Objects.AR.CalculatePrepaymentPercent`4
  ...
  where CuryDiscAmt : IBqlOperand
{
  public virtual object Evaluate(PXCache cache, object item, Dictionary<Type, object> pars)
  {
    ...
    Decimal? par3 = (Decimal?) pars[typeof (CuryExtPrice)];
    ...
    if (par2.HasValue && par3.HasValue && par4.HasValue)
    {
      ...
      {
        object valuePending = cache.GetValuePending<ARTranVATRecognitionOnPrepayments.curyPrepaymentAmt>(cache.Current);
