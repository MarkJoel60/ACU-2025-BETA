...
// Type: PX.Objects.AR.ARShippingContactAttribute
...
public class ARShippingContactAttribute(Type SelectType) : ContactAttribute(typeof (ARShippingContact.contactID), typeof (ARShippingContact.isDefaultContact), SelectType)
{
  public override void CacheAttached(PXCache sender)
  {
    base.CacheAttached(sender);
    PXGraph.FieldVerifyingEvents fieldVerifying = sender.Graph.FieldVerifying;
    ARShippingContactAttribute contactAttribute = this;
    ...
    fieldVerifying.AddHandler<ARShippingContact.overrideContact>(pxFieldVerifying);
  }

  public override void DefaultRecord(PXCache sender, object DocumentRow, object Row)
  {
    this.DefaultContact<ARShippingContact, ARShippingContact.contactID>(sender, DocumentRow, Row);
  }
  ...
  public override void CopyRecord(
    ...
    bool clone)
  {
    this.CopyContact<ARShippingContact, ARShippingContact.contactID>(sender, DocumentRow, SourceRow, clone);
  }
  ...
  public virtual void Record_Override_FieldVerifying(PXCache sender, PXFieldVerifyingEventArgs e)
  {
    ...
    try
    {
      this.Contact_IsDefaultContact_FieldVerifying<ARShippingContact>(sender, e);
    }
    finally
    {
