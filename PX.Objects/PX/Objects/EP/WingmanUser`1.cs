...
// Type: PX.Objects.EP.WingmanUser`1
...
[Obsolete("This attribute is deprecated, use WingmanUser<UserID, DelegationOf> instead")]
public class WingmanUser<UserID> : IBqlComparison, IBqlCreator, IBqlVerifier where UserID : IBqlOperand, new()
{
