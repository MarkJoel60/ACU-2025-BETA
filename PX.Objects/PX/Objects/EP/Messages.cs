...
public static class Messages
{
  ...
  public const string BAccountExists = "The {0} identifier is already used for the following records: {1}.";
  ...
  public const string CannotDeleteEquipmentRecord = "The {0} equipment cannot be deleted because it has been used in at least one equipment time card: {1}";
  ...
  public const string FinPeriodForDateNotFound = "The financial period that corresponds to the {0} date does not exist in the master financial calendar.";
  ...
  public const string CustomWeeksLimitReached = "The changes cannot be saved because the limit of weeks per year ({0}) has been exceeded for at least one year. Correct the number of weeks in the following years: {1}.";
  ...
  public const string TimeCardCannotFindLabor = "The time card cannot be submitted. Specify a labor item either in the time card lines or on the Employees (EP203000) form.";
  ...
  public const string WorkgroupIsInUseInWeeklyTimeEntry = "The {0} workgroup cannot be deleted because it has been used in at least one weekly crew time entry: {1}";
  ...
  public const string SummarySyncFailed = "Activity cannot be synced with the Summary records.{0}";
  ...
  public const string TimeCardWeekValidation = "A time card for the {0} employee and {1} week already exists.";
  public const string EquipmentTimeCardWeekValidation = "An equipment time card for the {0} equipment and {1} week already exists.";
  ...
  public const string DelegationOfExpenses = "Expense Receipts and Claims";
  public const string DelegationOfTimeEntries = "Time Activities and Employee Time Cards";
  ...
  public const string QuickView = "Quick View";
  [Obsolete]
  ...
  public const string TimeCard = "Employee Time Card";
  ...
  public const string ReportsTo = "Reports To (ID)";
  public const string ReportsToName = "Reports To (Name)";
