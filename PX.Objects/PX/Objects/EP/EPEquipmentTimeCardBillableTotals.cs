...
// Type: PX.Objects.EP.EPEquipmentTimeCardBillableTotals
...
[PXProjection(typeof (Select4<EPEquipmentDetail, Where<EPEquipmentDetail.isBillable, Equal<True>>, Aggregate<GroupBy<EPEquipmentDetail.timeCardCD, Sum<EPEquipmentDetail.setupTime, Sum<EPEquipmentDetail.runTime, Sum<EPEquipmentDetail.suspendTime>>>>>>))]
[PXHidden]
[Serializable]
public class EPEquipmentTimeCardBillableTotals : PXBqlTable, IBqlTable, IBqlTableSystemDataStorage
{
  ...
  public abstract class timeCardCD : 
    ...
    #nullable disable
    EPEquipmentTimeCardBillableTotals.timeCardCD>
  {
  }
  ...
  public abstract class runTime : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    EPEquipmentTimeCardBillableTotals.runTime>
  {
  }
  ...
  public abstract class setupTime : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    EPEquipmentTimeCardBillableTotals.setupTime>
  {
  }
  ...
  public abstract class suspendTime : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    EPEquipmentTimeCardBillableTotals.suspendTime>
  {
  }
  ...
  public abstract class timeTotalCalc : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    EPEquipmentTimeCardBillableTotals.timeTotalCalc>
  {
  }
}
