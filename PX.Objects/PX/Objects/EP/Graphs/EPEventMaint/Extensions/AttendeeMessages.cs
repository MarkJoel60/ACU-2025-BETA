...
// Type: PX.Objects.EP.Graphs.EPEventMaint.Extensions.AttendeeMessages
...
public static class AttendeeMessages
{
  ...
  public static class Ask
  {
    ...
    public static class Body
    {
      ...
      public const string ConfirmCancelAttendeeInvitations = "The invitations that have already been sent will be canceled. The cancellation emails will be sent to all potential attendees.";
      ...
      public const string ConfirmRescheduleNotification = "The invited potential attendees will be notified about the new time of the event.";
    }
  }
