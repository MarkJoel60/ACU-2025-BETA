...
// Type: PX.Objects.EP.PXConfigureSubordinateAndWingmenSelectorAttribute
...
public class PXConfigureSubordinateAndWingmenSelectorAttribute : PXSubordinateSelectorAttribute
{
  ...
  public PXConfigureSubordinateAndWingmenSelectorAttribute()
    : base(new PXDimensionAttribute("BIZACCT")
    {
      ValidComboRequired = true
    }, (PXSelectorAttribute) new PXCustomSubordinateAndWingmenSelectorAttribute(), true)
  {
  }
}
