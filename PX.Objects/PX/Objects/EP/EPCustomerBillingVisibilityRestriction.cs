...
// Type: PX.Objects.EP.EPCustomerBillingVisibilityRestriction
...
public class EPCustomerBillingVisibilityRestriction : PXGraphExtension<EPCustomerBilling>
{
  ...
  {
    base.Initialize();
    this.Base.CustomersView.WhereAnd<Where<PX.Objects.AR.Customer.cOrgBAccountID, RestrictByUserBranches<Current<AccessInfo.userName>>>>();
  }
}
