...
// Type: PX.Objects.Extensions.SalesTax.TaxTotal
...
public class TaxTotal : PXMappedCacheExtension
{
  ...
  /// <summary>Converts TaxTotal to <see cref="T:PX.Objects.Extensions.SalesTax.TaxItem" />.</summary>
  ...
  /// <summary>Falg to indicate tax is inclusive or not.</summary>
