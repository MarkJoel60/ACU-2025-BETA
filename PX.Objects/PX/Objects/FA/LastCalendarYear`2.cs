...
// Type: PX.Objects.FA.LastCalendarYear`2
...
public class LastCalendarYear<BookIDValue, OrganizationIDValue> : 
  ...
  where OrganizationIDValue : IBqlOperand
{
  public virtual object Evaluate(PXCache cache, object item, Dictionary<Type, object> parameters)
  {
    ...
    FABookYear faBookYear = GraphHelper.RowCast<FABookYear>((IEnumerable) PXSelectBase<FABookYear, PXSelect<FABookYear, Where<FABookYear.bookID, Equal<Required<FABook.bookID>>, And<FABookYear.organizationID, Equal<Required<FABookYear.organizationID>>>>, OrderBy<Desc<FABookYear.year>>>.Config>.SelectSingleBound(cache.Graph, new object[0], new object[2]
    {
      (object) parameter1,
      (object) parameter2
