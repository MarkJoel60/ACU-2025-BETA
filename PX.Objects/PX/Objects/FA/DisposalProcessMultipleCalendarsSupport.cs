...
// Type: PX.Objects.FA.DisposalProcessMultipleCalendarsSupport
...
public class DisposalProcessMultipleCalendarsSupport : PXGraphExtension<DisposalProcess>
{
  ...
  public virtual BqlCommand GetSelectCommand(
    DisposalProcess.DisposalFilter filter,
    DisposalProcessMultipleCalendarsSupport.GetSelectCommandDelegate baseDelegate)
  {
