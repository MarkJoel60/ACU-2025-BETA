...
public static class Messages
{
  ...
  public const string UpdateGLBookHasFACalendar = "The Posting Book check box cannot be selected for the {0} book because a calendar has been configured for the book on the Book Calendars (FA206000) form.";
  ...
  public const string CannotInsertFAOrganizationYearForBook = "The year {0} in the {1} book cannot be created for the {2} company because the financial year's configuration has been changed.";
  public const string CannotInsertFAMasterCalendar = "The year {0} in the {1} book cannot be created for the master calendar because the financial year's configuration has been changed.";
  public const string CannotInsertFACalendarSeeTrace = "One or more FA calendars could not be synchronized with the GL. See the trace for details.";
  public const string CannotSynchronizeOrganizationFACalendarWithGL = "The FA calendar for the {0} book of the {1} company cannot be synchronized with the GL because the financial year's configuration has changed. Please contact your Acumatica support provider.";
  public const string CannotSynchronizeMasterFACalendarWithGL = "The FA calendar cannot be synchronized with the GL because the financial year's configuration has changed. Please contact your Acumatica support provider.";
  ...
  public const string DepreciateFromDatePeriodCannotBeEarlierThanLatestTransactionPeriod = "The period of the placed-in service date ({0}) cannot be earlier than the period of the latest transaction ({1}).";
  public const string FixedAssetNotDepreciatedUntilSplitDate = "The fixed asset has not been depreciated from {0} for the {1} book. The depreciation will be suspended from {0} to {2} for the {1} book.";
  public const string NonDepreciableCannotHaveAccumulatedDeprOrLastDeprPeriod = "The asset is non-depreciable and cannot have Last Depr. Period and a non-zero Accum. Depr. specified for each book on the Balance tab. Correct these settings and try again.";
  public const string AssetHasNoPPlusTransaction = "The {0} fixed asset does not have a released purchasing transaction. To continue processing, make sure that the purchasing transaction exists and is released.";
  ...
  [Obsolete("This message has been deprecated and will be removed in Acumatica ERP 2018R2.")]
