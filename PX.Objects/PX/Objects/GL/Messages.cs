...
[PXLocalizable("GL Error")]
public static class Messages
{
  public const string Prefix = "GL Error";
  public const string ReverseBatchConfirmationMessage = "The reversal of a batch that originated in the {0} module can lead to inconsistency between data in the modules. Are you sure you want to reverse the batch that originated in the {0} module?";
  ...
  public const string DifferentBranches = "The {0} cash account is related to the {1} branch and the document is related to the {2} branch, but the Inter-Branch Transactions feature is disabled. Select another cash account or change the document branch to {1}.";
  ...
  public const string BatchOutOfBalance = "The batch is not balanced. Review the debit and credit amounts.";
  ...
  public const string FiscalPeriodMessageComposition = "{0}\n\r{1}, {2}.";
  public const string FiscalPeriodMethodDescriptionSeparator = "; ";
  public const string FiscalPeriodEndDateNotEqualFinYearEndDate = "The end date of the last financial period ({0}) is not the same as the end date of the financial year ({1}). To proceed, you need to modify the financial year configuration.";
  ...
  public const string FiscalPeriodMethodModifyNextYear = "the start date of the next financial year will be moved to {0}";
  public const string FiscalPeriodMethodModifyNextYearSetupBack = "the start date of the next financial year will be moved {0} day(s) back";
  public const string FiscalPeriodMethodModifyNextYearSetupForward = "the start date of the next financial year will be moved {0} day(s) forward";
  public const string FiscalPeriodMethodModifyNextYearSetupDate = "the next financial year will start on {0}";
  public const string FiscalPeriodMethodModifyNextYearNoChange = "the financial year settings will not be modified";
  public const string FiscalPeriodMethodExtendLastPeriod = "the end date of the last financial period will be moved to {0}";
  public const string FiscalPeriodMethodWeekStartWarning = "the start day of financial periods will be moved from {0} to {1}";
  public const string FiscalPeriodMethodEndDateMoveWarning = "the end date of the last financial period will be moved to {0} to preserve the start day of financial periods ({1})";
  public const string FiscalPeriodMethodDescriptionPrefix = "With the selected method";
  ...
  public const string DocumentARPendingApproval = "The document cannot be created on this form because an approval map is active on the Accounts Receivable Preferences (AR101000) form.";
  public const string DocumentAPPendingApproval = "The document cannot be created on this form because an approval map is active on the Accounts Payable Preferences (AP101000) form.";
  public const string DocumentCAPendingApproval = "The document cannot be created on this form because an approval map is active on the Cash Management Preferences (CA101000) form.";
  ...
  public const string GLPostingRunning = "GL batch posting is in progress. Please wait until the process is completed.";
  ...
  public const string BranchCannotDeletedBecauseOfAssociationWithPreferences = "The branch cannot be deleted because it has been specified as an in-transit branch. To delete the branch, on the Inventory Preferences (IN101000) form, specify another branch in the In-Transit Branch box.";
  ...
  public const string UpdateLastRefNbrWarning = "The system will update the AP Last Reference Number column on the Cash Accounts (CA202000) form with the following Ext. Ref. Number value: {0}.";
  ...
  public const string WrongCurrencyInfo = "Line #{0} has an unexpected CurrencyInfoID or the wrong CuryID of the linked CurrencyInfo entry and cannot be saved. Please report this situation to your Acumatica support provider.";
  public const string OffsetAccountInactive = "Inter-branch balancing entries cannot be created because the {0} account is inactive.";
  public const string AccountUsedCannotbeDeactivated = "The {0} account cannot be deactivated because it is used on the Inter-Branch Account Mapping (GL101010) form for the following branches: {1}.";
  ...
  public const string FixedDayOfWeek = "Fixed Day of Week";
  ...
  public const string PeriodStartDate = "Start Day of Period";
  public const string PeriodEndDate = "End Day of Period";
  public const string PeriodFixedDate = "Fixed Day of Period";
  ...
  public const string FinPeriodUpdateNextYearStart = "Modify Start Date of Next Year";
