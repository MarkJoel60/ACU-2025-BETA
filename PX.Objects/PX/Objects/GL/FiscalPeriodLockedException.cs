...
// Type: PX.Objects.GL.FiscalPeriodLockedException
...
{
  public FiscalPeriodLockedException(string message, PXErrorLevel errorLevel = 4)
  ...
  public FiscalPeriodLockedException(
    string finPeriodID,
    string organizationCD,
    PXErrorLevel errorLevel)
    : base("The {0} financial period is locked in the {1} company.", errorLevel, new object[2]
    {
  ...
  public FiscalPeriodLockedException(SerializationInfo info, StreamingContext context)
    : base(info, context)
  {
    ReflectionSerializer.RestoreObjectProps<FiscalPeriodLockedException>(this, info);
  }

  public virtual void GetObjectData(SerializationInfo info, StreamingContext context)
  {
    ReflectionSerializer.GetObjectData<FiscalPeriodLockedException>(this, info);
