...
// Type: PX.Objects.GL.FinPeriods.MasterFinPeriod
...
[PXProjection(typeof (Select<FinPeriod, Where<FinPeriod.organizationID, Equal<FinPeriod.organizationID.masterValue>>>), Persistent = true)]
[DebuggerDisplay("{GetType()}: FinPeriodID = {FinPeriodID}, tstamp = {PX.Data.PXDBTimestampAttribute.ToString(tstamp)}")]
[Serializable]
public class MasterFinPeriod : 
  PXBqlTable,
  IBqlTable,
  ...
  IPeriodSetup
{
  ...
  [PXParent(typeof (Select<MasterFinYear, Where<MasterFinYear.year, Equal<Current<MasterFinPeriod.finYear>>>>))]
  ...
  /// <summary>
  /// The number of the period in the <see cref="P:PX.Objects.GL.FinPeriods.MasterFinPeriod.FinYear">financial year</see>.
  /// </summary>
  ...
  /// <summary>Indicates whether the period is active.</summary>
  /// <value>
  ...
  /// <summary>
  /// The field used to display and edit the <see cref="P:PX.Objects.GL.FinPeriods.MasterFinPeriod.StartDate" /> of the period (inclusive) in the UI.
  /// </summary>
  /// <value>
  /// Depends on and changes the value of the <see cref="P:PX.Objects.GL.FinPeriods.MasterFinPeriod.StartDate" /> field, performing additional transformations.
  /// </value>
  [PXDate]
  [PXUIField]
  public virtual DateTime? StartDateUI
  {
    [PXDependsOnFields(new Type[] {typeof (MasterFinPeriod.startDate), typeof (MasterFinPeriod.endDate)})] get
    {
...
label_4:
  ...
  /// <summary>
  /// The field used to display and edit the <see cref="P:PX.Objects.GL.FinPeriods.MasterFinPeriod.EndDate" /> of the period (inclusive) in the UI.
  /// </summary>
  /// <value>
  /// Depends on and changes the value of the <see cref="P:PX.Objects.GL.FinPeriods.MasterFinPeriod.EndDate" /> field, performing additional transformations.
  /// </value>
  [PXDate]
  [PXUIField]
  public virtual DateTime? EndDateUI
  {
    [PXDependsOnFields(new Type[] {typeof (MasterFinPeriod.endDate)})] get
    {
  ...
  /// <summary>
  /// When <c>true</c>, indicates that the <see cref="P:PX.Objects.GL.FinPeriods.MasterFinPeriod.EndDate" /> of the period is locked and can not be edited.
  /// </summary>
  /// <value>
  ...
  /// </summary>
  /// <value>
  /// The value of this field is calculated from the <see cref="P:PX.Objects.GL.FinPeriods.MasterFinPeriod.EndDate" /> field.
  /// </value>
  [PXDate]
  [PXUIField]
  ...
  public class PK : PrimaryKeyOf<MasterFinPeriod>.By<MasterFinPeriod.finPeriodID>
  {
    public static MasterFinPeriod Find(PXGraph graph, string finPeriodID, PKFindOptions options = 0)
    {
      return (MasterFinPeriod) PrimaryKeyOf<MasterFinPeriod>.By<MasterFinPeriod.finPeriodID>.FindBy(graph, (object) finPeriodID, options);
    }
  }
  ...
  public static class FK
  {
    public class FinYear : 
      PrimaryKeyOf<MasterFinYear>.By<MasterFinYear.year>.ForeignKeyOf<MasterFinPeriod>.By<MasterFinPeriod.finYear>
    {
    }
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  MasterFinPeriod.organizationID>
  {
  }
  ...
  public abstract class createdByScreenID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    MasterFinPeriod.createdByScreenID>
  {
  }
  ...
  public abstract class createdDateTime : 
    ...
    IBqlDateTime, DateTime>.Field<
    #nullable disable
    MasterFinPeriod.createdDateTime>
  {
  }
  ...
  public abstract class lastModifiedByID : 
    ...
    IBqlGuid, Guid>.Field<
    #nullable disable
    MasterFinPeriod.lastModifiedByID>
  {
  }
  ...
  public abstract class lastModifiedByScreenID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    MasterFinPeriod.lastModifiedByScreenID>
  {
  }
  ...
  public abstract class lastModifiedDateTime : 
    ...
    IBqlDateTime, DateTime>.Field<
    #nullable disable
    MasterFinPeriod.lastModifiedDateTime>
  {
  }
}
