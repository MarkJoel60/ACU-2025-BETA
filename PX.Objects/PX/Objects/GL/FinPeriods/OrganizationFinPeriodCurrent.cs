...
// Type: PX.Objects.GL.FinPeriods.OrganizationFinPeriodCurrent
...
[PXProjection(typeof (Select5<FinPeriod, LeftJoin<FinPeriod2, On<FinPeriod2.finPeriodID, Less<FinPeriod.finPeriodID>>>, Where<FinPeriod.masterFinPeriodID, Equal<CurrentValue<GLHistoryFilter.finPeriodID>>>, Aggregate<Max<FinPeriod2.finPeriodID, GroupBy<FinPeriod.organizationID, GroupBy<FinPeriod.finPeriodID, GroupBy<FinPeriod.masterFinPeriodID>>>>>>))]
[PXCacheName("Last FinPeriod Current")]
public class OrganizationFinPeriodCurrent : PXBqlTable, IBqlTable, IBqlTableSystemDataStorage
{
  ...
  public abstract class organizationID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    OrganizationFinPeriodCurrent.organizationID>
  {
  }
  ...
  public abstract class finPeriodID : 
    ...
    #nullable disable
    OrganizationFinPeriodCurrent.finPeriodID>
  {
  }
  ...
  public abstract class masterFinPeriodID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    OrganizationFinPeriodCurrent.masterFinPeriodID>
  {
  }
  ...
  public abstract class prevFinPeriodID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    OrganizationFinPeriodCurrent.prevFinPeriodID>
  {
  }
}
