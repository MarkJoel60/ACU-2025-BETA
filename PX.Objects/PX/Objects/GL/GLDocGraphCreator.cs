...
// Type: PX.Objects.GL.GLDocGraphCreator
...
public class GLDocGraphCreator : IDocGraphCreator
{
  ...
  public virtual PXGraph Create(string aTranType, string aRefNbr, int? referenceID)
  {
    ...
    ((PXSelectBase<Batch>) instance.BatchModule).Current = PXResultset<Batch>.op_Implicit(((PXSelectBase<Batch>) instance.BatchModule).Search<Batch.batchNbr>((object) aRefNbr, Array.Empty<object>()));
