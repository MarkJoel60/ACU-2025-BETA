...
// Type: PX.Objects.GL.Consolidation.ConsolidationDataParametersAPITmp
...
internal class ConsolidationDataParametersAPITmp
{
  ...
  {
    this.LedgerCD = new ApiProperty<string>(ledgerCD);
    this.BranchCD = new ApiProperty<string>(branchCD);
  }
}
