...
// Type: PX.Objects.GL.GLHistoryByPeriodMasterCurrent
...
[PXProjection(typeof (Select5<GLHistory, InnerJoin<MasterFinPeriod, On<MasterFinPeriod.finPeriodID, GreaterEqual<GLHistory.finPeriodID>>, InnerJoin<MasterPrevFinPeriodCurrent, On<MasterFinPeriod.finPeriodID, Equal<MasterPrevFinPeriodCurrent.prevFinPeriodID>>>>, Aggregate<Max<GLHistory.finPeriodID, GroupBy<GLHistory.branchID, GroupBy<GLHistory.ledgerID, GroupBy<GLHistory.accountID, GroupBy<GLHistory.subID, GroupBy<MasterFinPeriod.finPeriodID>>>>>>>>))]
[GLHistoryPrimaryGraph]
[PXCacheName("GL History by Period")]
[Serializable]
public class GLHistoryByPeriodMasterCurrent : PXBqlTable, IBqlTable, IBqlTableSystemDataStorage
{
  /// <summary>
  ...
  public abstract class ledgerID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    GLHistoryByPeriodMasterCurrent.ledgerID>
  {
  }
  ...
  public abstract class accountID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    GLHistoryByPeriodMasterCurrent.accountID>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  GLHistoryByPeriodMasterCurrent.subID>
  {
  }
  ...
  public abstract class lastActivityPeriod : 
    ...
    #nullable disable
    GLHistoryByPeriodMasterCurrent.lastActivityPeriod>
  {
  }
  ...
  public abstract class finPeriodID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    GLHistoryByPeriodMasterCurrent.finPeriodID>
  {
  }
