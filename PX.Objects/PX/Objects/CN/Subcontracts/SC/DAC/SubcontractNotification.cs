...
// Type: PX.Objects.CN.Subcontracts.SC.DAC.SubcontractNotification
...
[PXProjection(typeof (Select<NotificationSetup, Where<NotificationSetup.module, Equal<PXModule.sc>>>), Persistent = true)]
...
public class SubcontractNotification : NotificationSetup
{
  ...
  [PXSelector(typeof (Search<SiteMap.screenID, Where<SiteMap.screenID, Like<PXModule.sc_>, And<Where<SiteMap.url, Like<PX.Objects.Common.urlReports>, Or<SiteMap.url, Like<urlReportsInNewUi>>>>>, OrderBy<Asc<SiteMap.screenID>>>), new Type[] {typeof (SiteMap.screenID), typeof (SiteMap.title)}, Headers = new string[] {"Report ID", "Report Name"}, DescriptionField = typeof (SiteMap.title))]
  public override string ReportID { get; set; }

  public new abstract class setupID : IBqlField, IBqlOperand
  {
  }
}
