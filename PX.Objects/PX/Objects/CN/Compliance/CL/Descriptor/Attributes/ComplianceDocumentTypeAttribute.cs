...
// Type: PX.Objects.CN.Compliance.CL.Descriptor.Attributes.ComplianceDocumentTypeAttribute
...
public class ComplianceDocumentTypeAttribute : PXEventSubscriberAttribute, IPXFieldUpdatedSubscriber
{
  public void FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs args)
  {
    if (!(args.Row is ComplianceDocument row))
      return;
    cache.SetValue<ComplianceDocument.documentTypeValue>((object) row, (object) null);
  }
}
