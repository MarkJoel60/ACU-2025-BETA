...
// Type: PX.Objects.CN.Compliance.CL.Descriptor.Attributes.ComplianceDocumentVendorAttribute
...
public class ComplianceDocumentVendorAttribute : 
  ...
  IPXFieldUpdatedSubscriber
{
  public void FieldUpdated(PXCache sender, PXFieldUpdatedEventArgs e)
  {
    if (!(e.Row is ComplianceDocument row))
      return;
    string vendorName = this.GetVendorName(row.VendorID, sender.Graph);
    sender.SetValue<ComplianceDocument.vendorName>((object) row, (object) vendorName);
  }
