...
// Type: PX.Objects.CT.CacheExtensions.ARRetainageFilterExt
...
/// </summary>
public sealed class ARRetainageFilterExt : PXCacheExtension<
#nullable disable
ARRetainageFilter>
{
  /// <summary>
  ...
  [ActiveContractBase(FieldClass = "PROJECT")]
  ...
  IBqlInt, int>.Field<
  #nullable disable
  ARRetainageFilterExt.projectID>
  {
  }
}
