...
public static class Messages
{
  ...
  public const string CannotPrepareReportDefineRoundingAccounts = "The tax report cannot be prepared because the accounts to be used for recording rounding amounts are not specified on the Currencies (CM202000) form. To proceed, specify the Rounding Gain/Loss Account (and subaccounts, if applicable).";
  ...
  public const string TaxTypeNotFound = "{0} tax type is not found.";
  ...
  public const string MissingInventoryAndLineUomForPerUnitTaxErrorMsgFormat = "The {0} per-unit tax cannot be calculated for the document with the {1} tax zone if inventory item and UOM are not specified for the line with the {2} tax category.";
  public const string MissingUomConversionForPerUnitTaxErrorMsgFormat = "The {0} per-unit tax cannot be calculated for the document with the {1} tax zone and the line with the {2} tax category. Conversion rule to the {3} tax UOM is missing.";
  public const string CombinationOfExclusivePerUnitTaxAndInclusveTaxIsForbiddenErrorMsg = "This combination of inclusive taxes and exclusive per-unit taxes is forbidden. Please review and modify your tax settings on the Taxes (TX205000) form.";
