...
// Type: PX.Objects.TX.TaxDetailByGLReportCurrency
...
[PXProjection(typeof (Select2<TaxTran, InnerJoin<TaxBucket, On<TaxBucket.vendorID, Equal<TaxTran.vendorID>, And<TaxBucket.bucketID, Equal<TaxTran.taxBucketID>>>, LeftJoin<TaxPeriodEffective, On<TaxPeriodEffective.vendorID, Equal<TaxTran.vendorID>, And<Where<TaxTran.taxPeriodID, IsNull, And<TaxTran.origRefNbr, Equal<Empty>, And<TaxTran.released, Equal<True>, And<TaxTran.voided, Equal<False>, And<TaxTran.taxType, NotEqual<PX.Objects.TX.TaxType.pendingSales>, And<TaxTran.taxType, NotEqual<PX.Objects.TX.TaxType.pendingPurchase>, And<TaxTran.tranDate, Less<TaxPeriodEffective.endDate>, And<TaxPeriodEffective.status, Equal<TaxPeriodStatus.open>, Or<TaxTran.taxPeriodID, Equal<TaxPeriodEffective.taxPeriodID>>>>>>>>>>>>, InnerJoin<PX.Objects.AP.Vendor, On<PX.Objects.AP.Vendor.bAccountID, Equal<TaxTran.vendorID>>, LeftJoin<PX.Objects.CM.Extensions.CurrencyInfo, On<PX.Objects.CM.Extensions.CurrencyInfo.curyInfoID, Equal<TaxTran.curyInfoID>>, LeftJoin<CurrencyRateByDate, On<CurrencyRateByDate.fromCuryID, Equal<PX.Objects.CM.Extensions.CurrencyInfo.curyID>, And<CurrencyRateByDate.toCuryID, Equal<PX.Objects.AP.Vendor.curyID>, And<CurrencyRateByDate.curyRateType, Equal<PX.Objects.AP.Vendor.curyRateTypeID>, And<CurrencyRateByDate.curyEffDate, LessEqual<TaxTran.tranDate>, And<Where<CurrencyRateByDate.nextEffDate, Greater<TaxTran.tranDate>, Or<CurrencyRateByDate.nextEffDate, IsNull>>>>>>>>>>>>>))]
[Obsolete("TaxDetailByGLReportCurrency is obsolete and will be removed in Acumatica 8.0.")]
[PXHidden]
public class TaxDetailByGLReportCurrency : PXBqlTable, IBqlTable, IBqlTableSystemDataStorage
{
  protected 
  #nullable disable
  string _Module;
  ...
  {
    [PXDependsOnFields(new Type[] {typeof (TaxDetailByGLReportCurrency.module), typeof (TaxDetailByGLReportCurrency.tranType), typeof (TaxDetailByGLReportCurrency.taxType), typeof (TaxDetailByGLReportCurrency.taxableAmt)})] get
    {
  ...
  {
    [PXDependsOnFields(new Type[] {typeof (TaxDetailByGLReportCurrency.module), typeof (TaxDetailByGLReportCurrency.tranType), typeof (TaxDetailByGLReportCurrency.taxType), typeof (TaxDetailByGLReportCurrency.taxAmt)})] get
    {
      Decimal mult = ReportTaxProcess.GetMult(this._Module, this._TranType, this._TaxType, new short?((short) 1));
  ...
  public abstract class module : 
    ...
    #nullable disable
    TaxDetailByGLReportCurrency.module>
  {
  }
  ...
  public abstract class tranType : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.tranType>
  {
  }
  ...
  public abstract class refNbr : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.refNbr>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  TaxDetailByGLReportCurrency.recordID>
  {
  }
  ...
  public abstract class released : 
    ...
    IBqlBool, bool>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.released>
  {
  }
  ...
  IBqlBool, bool>.Field<
  #nullable disable
  TaxDetailByGLReportCurrency.voided>
  {
  }
  ...
  public abstract class taxPeriodID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.taxPeriodID>
  {
  }
  ...
  IBqlString, string>.Field<
  #nullable disable
  TaxDetailByGLReportCurrency.taxID>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  TaxDetailByGLReportCurrency.vendorID>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  TaxDetailByGLReportCurrency.branchID>
  {
  }
  ...
  public abstract class taxZoneID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.taxZoneID>
  {
  }
  ...
  public abstract class accountID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.accountID>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  TaxDetailByGLReportCurrency.subID>
  {
  }
  ...
  public abstract class tranDate : 
    ...
    #nullable disable
    TaxDetailByGLReportCurrency.tranDate>
  {
  }
  ...
  public abstract class taxType : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.taxType>
  {
  }
  ...
  public abstract class taxRate : 
    ...
    #nullable disable
    TaxDetailByGLReportCurrency.taxRate>
  {
  }
  ...
  public abstract class taxableAmt : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.taxableAmt>
  {
  }

  public abstract class taxAmt : 
    BqlType<
    #nullable enable
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.taxAmt>
  {
  }
  ...
  public abstract class taxableAmtIO : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.taxableAmtIO>
  {
  }

  public abstract class taxAmtIO : 
    BqlType<
    #nullable enable
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.taxAmtIO>
  {
  }
  ...
  public abstract class vendorCuryID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.vendorCuryID>
  {
  }
  ...
  public abstract class vendorCuryRateType : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.vendorCuryRateType>
  {
  }
  ...
  public abstract class curyRate : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.curyRate>
  {
  }
  ...
  public abstract class curyMultDiv : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    TaxDetailByGLReportCurrency.curyMultDiv>
  {
  }
}
