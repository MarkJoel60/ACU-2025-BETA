...
// Type: PX.Objects.TX.RestrictWithholdingTaxCalcModeAttribute
...
public class RestrictWithholdingTaxCalcModeAttribute : RestrictTaxCalcModeAttribute
{
  ...
  protected override Type _ConditionSelect
  {
    get
    {
      return typeof (Select2<TaxZoneDet, InnerJoin<Tax, On<TaxZoneDet.taxZoneID, Equal<Required<TaxZoneDet.taxZoneID>>, And<Tax.taxID, Equal<TaxZoneDet.taxID>>>>, Where<Tax.taxType, Equal<CSTaxType.withholding>>>);
    }
  }
