...
// Type: PX.Objects.PM.TaxZoneExtension.PMShippingAddress2Attribute
...
public class PMShippingAddress2Attribute(System.Type SelectType, System.Type customerID) : 
  PMShippingAddressAttribute(SelectType, customerID)
{
          ...
          if (!nullable2.GetValueOrDefault())
          {
            ...
            if (source != null)
            {
              ...
              if (!nullable2.GetValueOrDefault())
              {
                ...
                addressFound = AddressAttribute.DefaultAddress<TAddress, TAddressID>(sender, this.FieldName, DocumentRow, AddressRow, (object) new PXResult<Address, PMShippingAddress>(address, new PMShippingAddress()));
              }
            }
