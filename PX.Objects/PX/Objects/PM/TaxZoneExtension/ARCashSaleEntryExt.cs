...
// Type: PX.Objects.PM.TaxZoneExtension.ARCashSaleEntryExt
...
public class ARCashSaleEntryExt : ProjectRevenueTaxZoneExtension<ARCashSaleEntry>
{
  ...
  [PXOverride]
  public virtual string GetDefaultTaxZone(ARCashSale row, Func<ARCashSale, string> baseMethod)
  {
  ...
  {
    SharedRecordAttribute.DefaultRecord<PX.Objects.AR.ARInvoice.shipAddressID>(sender, (object) row);
  }
}
