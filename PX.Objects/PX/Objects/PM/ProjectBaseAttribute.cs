...
// Type: PX.Objects.PM.ProjectBaseAttribute
...
public class ProjectBaseAttribute : PXEntityAttribute, IPXFieldVerifyingSubscriber
{
  ...
  public ProjectBaseAttribute(Type customerField)
  {
    ...
    {
      selectorAttribute = new PXDimensionSelectorAttribute("PROJECT", typeof (Search2<PMProject.contractID, LeftJoin<PX.Objects.AR.Customer, On<PX.Objects.AR.Customer.bAccountID, Equal<PMProject.customerID>>>, Where<PMProject.baseType, Equal<CTPRType.project>, And2<Match<Current<AccessInfo.userName>>, Or<PMProject.nonProject, Equal<True>>>>>), typeof (PMProject.contractCD), new Type[6]
      {
    ...
    else
    {
      ...
      typeList.AddRange((IEnumerable<Type>) new Type[8]
      {
        typeof (Search2<,,>),
      ...
      typeList.AddRange((IEnumerable<Type>) new Type[29]
      {
        typeof (Where<,,>),
        typeof (PMProject.baseType),
        typeof (Equal<>),
        typeof (CTPRType.project),
        typeof (And2<,>),
        typeof (Where2<,>),
        typeof (Where<,,>),
        typeof (PMProject.customerID),
      ...
      selectorAttribute = new PXDimensionSelectorAttribute("PROJECT", BqlCommand.Compose(typeList.ToArray()), typeof (PMProject.contractCD), new Type[6]
      {
        typeof (PMProject.contractCD),
        typeof (PMProject.description),
        typeof (PMProject.status),
  ...
  {
    if (this.customerField == (Type) null)
      return;
    ...
    if (nullable.GetValueOrDefault() == customerId.GetValueOrDefault() & nullable.HasValue == customerId.HasValue)
      return;
    sender.RaiseExceptionHandling(this.FieldName, e.Row, e.NewValue, (Exception) new PXSetPropertyException("Customer on the Document doesn't match the Customer on the Project or Contract.", (PXErrorLevel) 2));
  }
}
