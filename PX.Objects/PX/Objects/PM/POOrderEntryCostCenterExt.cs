...
// Type: PX.Objects.PM.POOrderEntryCostCenterExt
...
public class POOrderEntryCostCenterExt : 
  ProjectCostCenterBase<POOrderEntry>,
  ICostCenterSupport<PX.Objects.PO.POLine>
{
  ...
  public virtual IEnumerable<Type> GetFieldsDependOn()
  {
    ...
    yield return typeof (PX.Objects.PO.POLine.projectID);
    yield return typeof (PX.Objects.PO.POLine.taskID);
  }

  public bool IsSpecificCostCenter(PX.Objects.PO.POLine line)
  {
    return !line.IsSpecialOrder.GetValueOrDefault() && this.IsSpecificCostCenter(line.SiteID, line.ProjectID, line.TaskID);
  }

  public virtual int GetCostCenterID(PX.Objects.PO.POLine tran)
  {
    return this.FindOrCreateCostCenter(tran.SiteID, tran.ProjectID, tran.TaskID).CostCenterID.Value;
  }

  public virtual INCostCenter GetCostCenter(PX.Objects.PO.POLine tran)
  {
