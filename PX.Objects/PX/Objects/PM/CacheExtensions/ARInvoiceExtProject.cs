...
// Type: PX.Objects.PM.CacheExtensions.ARInvoiceExtProject
...
/// </summary>
public sealed class ARInvoiceExtProject : PXCacheExtension<
#nullable disable
ARInvoice>
{
  /// <summary>
  ...
  [ActiveProjectBase(typeof (ARInvoice.customerID))]
  ...
  [PXRestrictor(typeof (Where<PMSetup.visibleInAR, Equal<True>, Or<PMProject.nonProject, Equal<True>, Or<PMProject.contractID, Equal<Current<ARInvoice.projectID>>>>>), "The '{0}' project is invisible in the module.", new System.Type[] {typeof (PMProject.contractCD)})]
