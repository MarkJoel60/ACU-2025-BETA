...
// Type: PX.Objects.PM.CacheExtensions.ARRetainageFilterExtProjectContract
...
/// </summary>
public sealed class ARRetainageFilterExtProjectContract : PXCacheExtension<
#nullable disable
ARRetainageFilter>
{
  /// <summary>
  ...
  [ActiveProjectOrContractBase(typeof (ARRetainageFilter.customerID), FieldClass = "PROJECT")]
  ...
  public abstract class projectID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    ARRetainageFilterExtProjectContract.projectID>
  {
  }
}
