...
// Type: PX.Objects.CR.Extensions.CRCreateActions.BC.CreateContactFromOpportunityGraphExt
...
public class CreateContactFromOpportunityGraphExt : PXGraphExtension<OpportunityMaint>
{
  ...
  {
    OpportunityMaint.CreateContactFromOpportunityGraphExt extension = ((PXGraph) this.Base).GetExtension<OpportunityMaint.CreateContactFromOpportunityGraphExt>();
