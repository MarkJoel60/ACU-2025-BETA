...
// Type: PX.Objects.CR.Extensions.CROpportunityContactAddress.Document
...
public class Document : PXMappedCacheExtension
{
  ...
  public abstract class billContactID : IBqlField, IBqlOperand
  {
  }

  public abstract class billAddressID : IBqlField, IBqlOperand
  {
  }
  ...
  public abstract class allowOverrideShippingContactAddress : 
    ...
    #nullable disable
    Document.allowOverrideShippingContactAddress>
  {
  }
  ...
  public abstract class allowOverrideBillingContactAddress : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    Document.allowOverrideBillingContactAddress>
  {
  }
}
