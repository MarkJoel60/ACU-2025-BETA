...
// Type: PX.Objects.CR.Extensions.CRCreateSalesOrder.CRCreateSalesOrder_SOOrderEntry
...
public class CRCreateSalesOrder_SOOrderEntry : PXGraphExtension<SOOrderEntry>
{
  ...
  public virtual void _(PX.Data.Events.RowPersisting<SOOrder> e)
  {
    SOOrder row = e.Row;
    ...
    foreach (object obj in cach.Cached)
    {
      ...
      if (cach.GetStatus(obj) == 5)
        ((SelectedEntityEvent<SOOrder, CRQuote>) PXEntityEventBase<SOOrder>.Container<SOOrder.Events>.Select<CRQuote>((Expression<Func<SOOrder.Events, PXEntityEvent<SOOrder.Events, CRQuote>>>) (o => o.OrderCreatedFromQuote))).FireOn((PXGraph) this.Base, row, obj as CRQuote);
    }
  }
}
