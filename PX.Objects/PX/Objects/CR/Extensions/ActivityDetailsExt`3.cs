...
// Type: PX.Objects.CR.Extensions.ActivityDetailsExt`3
...
public abstract class ActivityDetailsExt<TGraph, TPrimaryEntity, TPrimaryEntity_NoteID> : 
  ActivityDetailsExt<TGraph, TPrimaryEntity>
  ...
  where TPrimaryEntity_NoteID : IBqlField, IImplement<IBqlCastableTo<IBqlGuid>>
{
  ...
  {
    return typeof (Where<CRPMTimeActivity.refNoteID, Equal<Current<TPrimaryEntity_NoteID>>>);
  }
}
