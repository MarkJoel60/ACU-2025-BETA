...
public static class Messages
{
  ...
  public const string CustomerRequired = "An account of the Customer type is required for this case.";
  public const string VendorRequired = "An account of the Vendor type is required for this case.";
  public const string CustomerAndVendorRequired = "An account of the Customer & Vendor type is required for this case. ";
  ...
  public const string UsernameNotAvailable = "The username '{0}' is not available. Contact your system administrator.";
  public const string ContactWithoutEmail = "Contact '{0}' does not have an email address.";
  public const string LinkedContactInactive = "The linked contact is inactive";
  ...
  public const string DefAddressNotExists = "Default Address does not exist for '{0}'";
  ...
  public const string ReplaceModernAddressTab = "Override settings on the Addresses tab with settings from the new entity?";
  public const string ReplaceContactAndModernAddressTab = "Override settings on the Contact and Addresses tabs with settings from the new entity?";
  ...
  public const string SystemCannotExecuteWebRequestExtensive = "The system cannot execute a web request.\nStatus code: {0}\nResponse: {1}";
  ...
  public const string QuoteSubmittedReadonly = "Some of the opportunity settings cannot be modified because the primary quote status is other than Draft.";
  ...
  public const string EmptySalesOrderType = "Order Type cannot be empty.";
  ...
  public const string CannotCreateQuoteOnMobileBecauseUDF = "The project quote cannot be created in the mobile app because it requires at least one user-defined field to be specified. To create the project quote from this opportunity, use the web version.";
  [Obsolete]
  ...
  public const string UnknownAddressSourceUsed = "Address source unidentified.";
  ...
  [Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
  public const string DisplayType = "Type";
  ...
  public const string BusinessAccountId = "Business Account ID";
  ...
  public const string CaseCommitments = "Case Commitments";
  ...
  [Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
  public const string BAccount_AssignmentMapType = "Customer";
  [Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
  ...
  public const string BusinessAccountAddressLine1 = "Business Account Address Line 1";
  public const string BusinessAccountAddressLine2 = "Business Account Address Line 2";
  public const string BusinessAccountAddressLine3 = "Business Account Address Line 3";
  public const string BusinessAccountCity = "Business Account City";
  public const string BusinessAccountState = "Business Account State";
  public const string BusinessAccountPostalCode = "Business Account Postal Code";
  public const string BusinessAccountCountry = "Business Account Country";
  public const string BusinessAccountDepartment = "Business Account Department";
  public const string BusinessAccountSubDepartment = "Business Account Subdepartment";
  public const string BusinessAccountStreetName = "Business Account Street Name";
  public const string BusinessAccountBuildingNumber = "Business Account Building Number";
  public const string BusinessAccountBuildingName = "Business Account Building Name";
  public const string BusinessAccountFloor = "Business Account Floor";
  public const string BusinessAccountUnitNumber = "Business Account Unit Number";
  public const string BusinessAccountPostBox = "Business Account Post Box";
  public const string BusinessAccountRoom = "Business Account Room";
  public const string BusinessAccountTownLocationName = "Business Account Town Location Name";
  public const string BusinessAccountDistrictName = "Business Account District Name";
  ...
  public const string NoOpenIDConnectWhenOutlookTurnedOnFeature = "The OpenID Connect feature must be enabled for Outlook Integration to work with Microsoft 365 accounts.";
  ...
  public const string ReplacingEmailBody = "Replacing Email Body";
  public const string AfterEmailBody = "After Email Body";
  public const string BeforeEmailBody = "Before Email Body";
  ...
  public static string[] GetLocal(string[] msgs)
  {
    if (msgs == null)
      return (string[]) null;
    string[] local = new string[msgs.Length];
    for (int index = 0; index < msgs.Length; ++index)
      local[index] = PXLocalizer.Localize(msgs[index], typeof (Messages).ToString());
    return local;
  }

  public static string FormNoAccessRightsMessage(System.Type graphType)
  {
    PXSiteMapNode siteMapNodeUnsecure = PXSiteMapProviderExtensions.FindSiteMapNodeUnsecure(PXSiteMap.Provider, graphType);
    return siteMapNodeUnsecure != null && siteMapNodeUnsecure.ScreenID != null ? string.Format(Messages.GetLocal("You do not have enough rights to access the screen {0} ({1})"), (object) siteMapNodeUnsecure.Title, (object) siteMapNodeUnsecure.ScreenID) : string.Format(Messages.GetLocal("You do not have enough rights to access {0}"), (object) graphType.ToString());
  }
}
