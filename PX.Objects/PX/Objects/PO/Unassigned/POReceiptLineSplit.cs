...
// Type: PX.Objects.PO.Unassigned.POReceiptLineSplit
...
#nullable enable
namespace PX.Objects.PO.Unassigned;

/// <summary>
/// Is exact copy of POReceiptLineSplit except PXProjection Where clause.
/// </summary>
[POReceiptLineSplitProjection(typeof (Select<POReceiptLineSplit, Where<POReceiptLineSplit.isReverse, Equal<False>>>), typeof (POReceiptLineSplit.isUnassigned), true)]
[PXHidden]
  ...
  IItemPlanSource
{
  ...
  [PXDefault(typeof (Search<PX.Objects.PO.POReceiptLine.pONbr, Where<PX.Objects.PO.POReceiptLine.receiptType, Equal<Current<POReceiptLineSplit.receiptType>>, And<PX.Objects.PO.POReceiptLine.receiptNbr, Equal<Current<POReceiptLineSplit.receiptNbr>>, And<PX.Objects.PO.POReceiptLine.lineNbr, Equal<Current<POReceiptLineSplit.lineNbr>>>>>>))]
  [PXDBString(15, IsUnicode = true)]
  public string PONbr { get; set; }

  [PXDefault(typeof (Search<PX.Objects.PO.POReceiptLine.lineType, Where<PX.Objects.PO.POReceiptLine.receiptType, Equal<Current<POReceiptLineSplit.receiptType>>, And<PX.Objects.PO.POReceiptLine.receiptNbr, Equal<Current<POReceiptLineSplit.receiptNbr>>, And<PX.Objects.PO.POReceiptLine.lineNbr, Equal<Current<POReceiptLineSplit.lineNbr>>>>>>))]
  ...
  [PXDBShort]
  [PXDefault(typeof (PX.Objects.PO.POReceiptLine.invtMult))]
  ...
  [POLotSerialNbr(typeof (POReceiptLineSplit.inventoryID), typeof (POReceiptLineSplit.subItemID), typeof (POReceiptLineSplit.locationID), typeof (PX.Objects.PO.POReceiptLine.lotSerialNbr), typeof (PX.Objects.PO.POReceiptLine.costCenterID))]
  ...
  [PXDBBool]
  [PXDefault(typeof (PX.Objects.PO.POReceiptLine.isUnassigned))]
