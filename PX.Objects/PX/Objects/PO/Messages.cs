...
public static class Messages
{
  ...
  public const string POReceiptLineQuantityMustBeGreaterThanZeroOnRelease = "You cannot release the receipt because the Receipt Qty. in a line must be greater than 0. Specify a nonzero quantity or delete the lines with a quantity of 0.";
  ...
  public const string DSCannotConvertToNormalBecauseShipmentExist = "The drop-ship purchase order cannot be converted to the Normal type because a shipment has been prepared for the related {0} sales order.";
  ...
  public const string QtyCannotChangedInterCompanySOCreated = "The quantity cannot be changed because the {0} intercompany sales order has been created for the line.";
  ...
  public const string ViewAllDemand = "View Demand";
  public const string AddAndClose = "Add & Close";
  ...
  public const string POReceiptItemLotSerialAttributesHeader = "Purchase Receipt Item Lot/Serial Attributes Header";
  ...
  public const string UnderCorrection = "Under Correction";
  ...
  public const string CannotCorrectWithUnreleasedINReceipt = "Before correcting the purchase receipt, release the {0} inventory receipt.";
  public const string CannotCorrectWithInappropriateLineTypes = "The {0} receipt cannot be corrected because it has been created for a replenishment request, project, or subcontract. Correction of such purchase receipts is not supported.";
  public const string CannotCorrectReceiptUndergoingPutAway = "The {0} receipt cannot be corrected because it is being put away on the Receive and Put Away (PO302020) form.";
  public const string CannotCorrectBilledReceipt = "The {0} receipt cannot be corrected because at least one bill has been created for this receipt.";
  public const string CannotCorrectReceiptWithBilledPOOrder = "The {0} receipt cannot be corrected because at least one bill has been created for the linked purchase order {1}.";
  public const string CannotCorrectReceiptWithInvoice = "The {0} receipt cannot be corrected because the {1} invoice has been created for the related sales order ({2}).";
  public const string CannotCorrectReceiptReferencedInLandedCost = "The {0} receipt cannot be corrected because it is linked to the {1} landed cost document.";
  public const string CannotCorrectReceiptWithUnreleasedReturn = "The {0} receipt cannot be corrected because it has at least one unreleased purchase return. To be able to correct the receipt, remove or release the following unreleased purchase returns: ({1}).";
  public const string CorrectionReceiptQtyCannotBeLessOrigReturn = "The quantity in the receipt line cannot be less than {0} because the line is fully or partially returned in the original purchase receipt ({1}).";
  public const string CannotCreateAPBillForReceiptUnderCorrection = "The bill cannot be created because at least one linked purchase receipt is under correction.";
  public const string CannotCreateInvoiceForShipmentUnderCorrection = "The invoice cannot be created because the {0} drop shipment is under correction.";
  public const string CannotChangePostPeriodInCorrectionReceipt = "The posting period of the correction receipt differs from the {0} posting period of the original receipt ({1}). If you need to change the financial period, cancel the original receipt and create a new one.";
  public const string CannotHaveDifferentConversionRuleForUOM = "The conversion rule from the {0} purchase unit to the {1} base unit has been modified for the {2} item. The base quantity of the item in the correction receipt will not match the base quantity in the original purchase receipt ({3}). To correct the original purchase receipt, the conversion rule from the {0} purchase unit to the {1} base unit should be the same as in the original purchase receipt.";
  public const string ReceiptHasBeenCorrected = "The current document has been corrected.";
  public const string CannotCorrectDropShipReceiptWithNonDSLines = "The {0} receipt cannot be corrected because it contains lines of the Goods for IN or Non-Stock type, or both.";
  public const string VendorDoesNotAllowQtyOverThreshold = "The purchase receipt cannot be created because at least one linked purchase receipt is under correction. The {0} vendor does not accept the receiving of items over the threshold. The quantity of the items received from the vendor may be above the threshold specified on the Purchase Settings tab of the Vendors (AP303000) form. To be able to create the purchase receipt, finish the correction of the {1} receipt first.";
  public const string RemovingLineFromOrigReceiptIsNotAllowed = "The line from the original receipt ({0}) cannot be deleted. If the item was not received in this receipt, change the item quantity to 0.";
  public const string TotalQtyCannotBeZeroInCorrectionReceipt = "The receipt total quantity is 0. If a total quantity of 0 has been received, use the Cancel Receipt command for the original receipt ({0}).";
  public const string OriginalIssueIsNotReleased = "The {0} receipt cannot be released because the original issue ({1}) is not released. Release the issue before releasing the receipt.";
  public const string LinkedPOReceiptUnderCorrectionOrCanceled = "The linked purchase receipt ({0}) is under correction or canceled.";
  public const string CannotSaveCorrectionWithBill = "The receipt cannot be saved or released because at least one bill has been created for the original receipt ({0}).";
  public const string CannotSaveCorrectionWithBilledPOOrder = "The receipt cannot be saved or released because at least one bill has been created for the {0} purchase order.";
  public const string CannotSaveCorrectionWithUnreleasedReturn = "The receipt cannot be saved or released because there is at least one unreleased purchase return ({0}) prepared for the original purchase receipt ({1}). To correct the original receipt, delete or release the unreleased purchase return.";
  public const string CannotSaveCorrectionWithLandedCost = "The receipt cannot be saved or released because the original receipt ({0}) is linked to the {1} landed cost document.";
  public const string CannotSaveCorrectionWithUndergoingPutAway = "The receipt cannot be saved or released because the original receipt ({0}) is being put away on the Receive and Put Away (PO302020) form.";
  public const string CorrectionReasonCodeNotSpecified = "The receipt cannot be released because the Purchase Receipt Correction reason code is not specified on the Posting Classes (IN206000) form for the {0} item.";
  public const string ShipmentMustBeCorrected = "The receipt cannot be corrected or canceled because the {0} item is already included in the {1} shipment. To correct or cancel the receipt, correct the item quantity in the shipment first.";
  public const string ItemIsAlreadyShipped = "The {0} receipt cannot be corrected because the {1} item is already shipped.";
  public const string ItemCannotIssueWithOrigCost = "The {0} item cannot be issued from the {1} warehouse with the {2} unit cost in the original purchase receipt.";
  public const string CannotCorrectOrCancelReceiptWithReleasedPutAwayTransfer = "The {0} receipt cannot be corrected or canceled because it has a related inventory transfer ({1}). Correction of such purchase receipts is not supported. You can review the transfer on the Put Away tab.";
  public const string CorrectionResultingOversold = "The receipt cannot be corrected or canceled because the on-hand quantity of the {0} item is negative or will become negative in the {1} warehouse. Correction or cancellation of purchase receipts with negative on-hand quantities is not supported.";
  public const string CorrectionResultingOversoldFifo = "The receipt cannot be corrected or canceled because the on-hand quantity of the {0} item received in the {1} receipt is negative or will become negative. Correction or cancellation of purchase receipts with negative on-hand quantities is not supported.";
  public const string CorrectionResultingOversoldSpecific = "The purchase receipt cannot be corrected or canceled because the {0} item with the {1} lot or serial number has already been issued from the {2} warehouse.";
  public const string CorrectionResultingNegQty = "The quantity of the {0} item in the {1} warehouse will become negative.";
  public const string CannotCorrectOrCancelManufacturingAndFSLines = "The {0} receipt cannot be corrected or canceled because it has been created for a service order or production order. Correction of such purchase receipts is not supported.";
  public const string CannotCorrectOrCancelNonStockKit = "The {0} item is a non-stock kit. Correction of receipt lines with non-stock kits or cancellation of receipts with non-stock kits is not supported.";
  public const string CancelReceipt = "Cancel Receipt";
  public const string CannotCancelWithInappropriateLineTypes = "The {0} receipt cannot be canceled because it has been created for a replenishment request, project, or subcontract. Cancellation of such purchase receipts is not supported.";
  public const string CannotCancelBilledReceipt = "The {0} receipt cannot be canceled because at least one bill has been created for this receipt.";
  public const string CannotCancelReceiptWithBilledPOOrder = "The {0} receipt cannot be canceled because at least one bill has been created for the linked purchase order ({1}).";
  public const string CannotCancelReceiptWithInvoice = "The {0} receipt cannot be canceled because the {1} invoice has been created for the related {2} sales order.";
  public const string CannotCancelReceiptReferencedInLandedCost = "The {0} receipt cannot be canceled because it is linked to the {1} landed cost document.";
  public const string CannotCancelReceiptWillFullOrPartialReturn = "The {0} receipt cannot be canceled because the items from this receipt have been fully or partially returned.";
  public const string CannotCancelReceiptWithUnreleasedIssue = "The {0} receipt cannot be canceled because the original issue ({1}) is not released. To be able to cancel the receipt, release the issue first.";
  public const string CannotCancelReceiptWithUnreleasedReturn = "The {0} receipt cannot be canceled because it has at least one unreleased purchase return. To be able to cancel the receipt, remove or release the following unreleased purchase returns: ({1}).";
  public const string CannotCancelReceiptWithNonDSLines = "The {0} receipt cannot be canceled because it contains lines of the Goods for IN or Non-Stock type, or both.";
  [Obsolete("Message is no longer in use and is only left to avoid breaking changes")]
  public const string ReceiptCancellationPopupForDropShip = "The purchase receipt will be canceled and any related inventory transactions will be reversed. Do you want to continue?";
  public const string ReceiptCancellationPopupForNormals = "The purchase receipt will be canceled. Do you want to proceed with canceling the receipt?";
  public const string CannotCancelReceiptUndergoingPutAway = "The {0} receipt cannot be canceled because it is being put away on the Receive and Put Away (PO302020) form.";
}
