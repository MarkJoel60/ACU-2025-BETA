...
// Type: PX.Objects.PO.POShipAddress
...
/// </remarks>
[PXCacheName("PO Shipping Address")]
[Serializable]
public class POShipAddress : POAddress
{
  ...
  [PX.Objects.CR.State(typeof (POShipAddress.countryID))]
  ...
  [PXZipValidation(typeof (PX.Objects.CS.Country.zipCodeRegexp), typeof (PX.Objects.CS.Country.zipCodeMask), typeof (POShipAddress.countryID))]
  [PXPersonalDataField]
  ...
  public new class PK : PrimaryKeyOf<POShipAddress>.By<POShipAddress.addressID>
  {
    public static POShipAddress Find(PXGraph graph, int? addressID, PKFindOptions options = 0)
    {
      return (POShipAddress) PrimaryKeyOf<POShipAddress>.By<POShipAddress.addressID>.FindBy(graph, (object) addressID, options);
    }
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  POShipAddress.addressID>
  {
  }

  /// <inheritdoc cref="P:PX.Objects.PO.POShipAddress.BAccountID" />
  public new abstract class bAccountID : BqlType<
  #nullable enable
  IBqlInt, int>.Field<
  #nullable disable
  POShipAddress.bAccountID>
  {
  }
  ...
  public new abstract class bAccountAddressID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    POShipAddress.bAccountAddressID>
  {
  }
  ...
  public new abstract class isDefaultAddress : 
    ...
    IBqlBool, bool>.Field<
    #nullable disable
    POShipAddress.isDefaultAddress>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  POShipAddress.revisionID>
  {
  }

  /// <inheritdoc cref="P:PX.Objects.PO.POShipAddress.CountryID" />
  public new abstract class countryID : BqlType<
  #nullable enable
  IBqlString, string>.Field<
  #nullable disable
  POShipAddress.countryID>
  {
  }

  /// <inheritdoc cref="P:PX.Objects.PO.POShipAddress.State" />
  ...
  /// <inheritdoc cref="P:PX.Objects.PO.POShipAddress.PostalCode" />
  public new abstract class postalCode : BqlType<
  #nullable enable
  IBqlString, string>.Field<
  #nullable disable
  POShipAddress.postalCode>
  {
  }
