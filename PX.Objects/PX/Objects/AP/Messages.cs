...
public static class Messages
{
  ...
  public const string AP1099_PaymentDate_NotIn_OpenYear = "The payment date must be within an open 1099 year.";
  ...
  public const string PrepaymentCheckCannotBeVoided = "The {0} payment cannot be voided. The {1} prepayment that is paid with this payment has applications. To void the payment, first reverse the released applications, and then delete the unreleased applications of the prepayment.";
  ...
  public const string UnreleasedVoidedPaymentAppliedToPrepayment = "An unreleased voided payment ({0}) is applied to the prepayment. To create new applications for the prepayment, remove the voided payment.";
  ...
  [Obsolete("This field has been deprecated and will be removed in Acumatica ERP 2025R1.")]
  ...
  public const string PrebookingAccountIsRequiredForPrebooking = "To release the document, specify the reclassification account.";
  ...
  public const string DocumentNotApproved = "The document cannot be created on this form because an approval map is active on the Accounts Payable Preferences (AP101000) form.";
  ...
  [Obsolete("Will be removed in Acumatica 2020R2")]
  ...
  public const string ReversingRetainageDocumentExists = "The {0} document with the {1} ref. number cannot be reversed because it has already been reversed with the {2} document with the {3} ref. number.";
  ...
  public const string UnreleasedDebitAdjApplicationExistsForPrepaymentInvoice = "The prepayment invoice has already been applied to the {0} debit adjustment, but the debit adjustment has not been released. Do you want to open the debit adjustment?";
  public const string CannotReverseDebitAdjApplicationToPrepaymentInvoice = "An application of a reversing debit adjustment to a prepayment invoice cannot be reversed.";
  ...
  public const string PaymentsByLinesCannotBeSelectedWithholdingTaxes = "The Pay by Line check box cannot be selected because the document has withholding taxes.";
  public const string TaxesAreNotSupportedInPrepaymentInvoices = "{0} taxes are not supported for prepayment invoices.";
  public const string DirectEntryTaxesAreNotSupportedInPrepaymentInvoices = "Direct-entry taxes are not supported for prepayment invoices.";
  ...
  public const string ReversingDocumentExists = "A reversing {0} document with the {1} ref. number already exists. Do you want to continue?";
  ...
  public const string APExternalRetainedTaxesNotSupported = "Retained taxes calculated by an external tax provider are not supported.";
  ...
  public const string APRefundIsIncludedIntoUnreleasedCADepositAndCannotBeVoided = "This refund is included in the {0} bank deposit. It cannot be voided until the deposit is released or the refund is excluded from it.";
  ...
  public const string CannotReleasePrepaymentInvoiceWithEmptyPendingTaxPayableAccount = "The document cannot be released because the Tax on AP Prepayment Account is not specified for the {0} tax. To proceed, specify this account on the Taxes (TX205000) form.";
  public const string CannotReleasePrepaymentInvoiceWithEmptyPendingTaxPayableSubaccount = "The document cannot be released because the Tax on AP Prepayment Subaccount is not specified for the {0} tax. To proceed, specify this account on the Taxes (TX205000) form.";
  public const string DocumentAlreadyVoided = "The document has already been voided.";
  ...
  public const string VendorBalance = "Current Balance";
  public const string VendorRetainedBalance = "Retained Balance";
  public const string VendorDepositsBalance = "Prepayment Balance";
  ...
  public const string BalanceByVendor = "AP Balance by Vendor";
  ...
  public const string APQuickCheck = "Cash Purchase";
  ...
  public const string PrintCreditAdj = "Credit Adj.";
  public const string PrintDebitAdj = "Debit Adj.";
  public const string PrintCheck = "Payment";
  ...
  public const string PrintVoidCheck = "Voided Payment";
  public const string PrintQuickCheck = "Cash Purchase";
  public const string PrintVoidQuickCheck = "Voided Cash Purchase";
  ...
  public const string OpenAndClosedDocuments = "Open and Closed Documents";
  ...
  public const string GrossModeNotApplyWhenUseTax = "The Gross tax calculation mode cannot be used in a document for which use taxes are calculated by an external tax provider.";
}
