...
// Type: PX.Objects.AP.APPriceWorksheetMaintVisibilityRestriction
...
public class APPriceWorksheetMaintVisibilityRestriction : PXGraphExtension<APPriceWorksheetMaint>
{
  ...
  {
    base.Initialize();
    this.Base.Details.WhereAnd<Where<PX.Objects.CR.BAccount.vOrgBAccountID, RestrictByUserBranches<Current<AccessInfo.userName>>>>();
  }
}
