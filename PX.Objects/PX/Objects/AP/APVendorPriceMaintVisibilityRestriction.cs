...
// Type: PX.Objects.AP.APVendorPriceMaintVisibilityRestriction
...
public class APVendorPriceMaintVisibilityRestriction : PXGraphExtension<APVendorPriceMaint>
{
  ...
  {
    base.Initialize();
    this.Base.Records.WhereAnd<Where<Vendor.vOrgBAccountID, RestrictByUserBranches<Current<AccessInfo.userName>>>>();
  }
}
