...
// Type: PX.Objects.AP.EndOfPayerRecordC
...
public class EndOfPayerRecordC : I1099Record
{
  ...
  void I1099Record.WriteToFile(StreamWriter writer, YearFormat yearFormat)
  {
    ...
    if (yearFormat == YearFormat.F2020)
      StringBuilderExtensions.Append(StringBuilderExtensions.Append(StringBuilderExtensions.Append(StringBuilderExtensions.Append(str, this.RecordType, 1, 1).Append(this.NumberOfPayees, 2, 8, PaddingEnum.Left, '0'), string.Empty, 10, 6).Append(this.ControlTotal1, 16 /*0x10*/, 18, PaddingEnum.Left, '0').Append(this.ControlTotal2, 34, 18, PaddingEnum.Left, '0').Append(this.ControlTotal3, 52, 18, PaddingEnum.Left, '0').Append(this.ControlTotal4, 70, 18, PaddingEnum.Left, '0').Append(this.ControlTotal5, 88, 18, PaddingEnum.Left, '0').Append(this.ControlTotal6, 106, 18, PaddingEnum.Left, '0').Append(this.ControlTotal7, 124, 18, PaddingEnum.Left, '0').Append(this.ControlTotal8, 142, 18, PaddingEnum.Left, '0').Append(this.ControlTotal9, 160 /*0xA0*/, 18, PaddingEnum.Left, '0').Append(this.ControlTotalA, 178, 18, PaddingEnum.Left, '0').Append(this.ControlTotalB, 196, 18, PaddingEnum.Left, '0').Append(this.ControlTotalC, 214, 18, PaddingEnum.Left, '0').Append(this.ControlTotalD, 232, 18, PaddingEnum.Left, '0').Append(this.ControlTotalE, 250, 18, PaddingEnum.Left, '0').Append(this.ControlTotalF, 268, 18, PaddingEnum.Left, '0').Append(this.ControlTotalG, 286, 18, PaddingEnum.Left, '0').Append(string.Empty, 304, 196, PaddingEnum.Left, '0').Append(this.RecordSequenceNumber, 500, 8, PaddingEnum.Left, '0'), string.Empty, 508, 241), string.Empty, 749, 2);
    else
      StringBuilderExtensions.Append(StringBuilderExtensions.Append(StringBuilderExtensions.Append(StringBuilderExtensions.Append(str, this.RecordType, 1, 1).Append(this.NumberOfPayees, 2, 8, PaddingEnum.Left, '0'), string.Empty, 10, 6).Append(this.ControlTotal1, 16 /*0x10*/, 18, PaddingEnum.Left, '0').Append(this.ControlTotal2, 34, 18, PaddingEnum.Left, '0').Append(this.ControlTotal3, 52, 18, PaddingEnum.Left, '0').Append(this.ControlTotal4, 70, 18, PaddingEnum.Left, '0').Append(this.ControlTotal5, 88, 18, PaddingEnum.Left, '0').Append(this.ControlTotal6, 106, 18, PaddingEnum.Left, '0').Append(this.ControlTotal7, 124, 18, PaddingEnum.Left, '0').Append(this.ControlTotal8, 142, 18, PaddingEnum.Left, '0').Append(this.ControlTotal9, 160 /*0xA0*/, 18, PaddingEnum.Left, '0').Append(this.ControlTotalA, 178, 18, PaddingEnum.Left, '0').Append(this.ControlTotalB, 196, 18, PaddingEnum.Left, '0').Append(this.ControlTotalC, 214, 18, PaddingEnum.Left, '0').Append(this.ControlTotalD, 232, 18, PaddingEnum.Left, '0').Append(this.ControlTotalE, 250, 18, PaddingEnum.Left, '0').Append(this.ControlTotalF, 268, 18, PaddingEnum.Left, '0').Append(this.ControlTotalG, 286, 18, PaddingEnum.Left, '0').Append(this.ControlTotalH, 304, 18, PaddingEnum.Left, '0').Append(this.ControlTotalJ, 322, 18, PaddingEnum.Left, '0').Append(string.Empty, 340, 160 /*0xA0*/, PaddingEnum.Left).Append(this.RecordSequenceNumber, 500, 8, PaddingEnum.Left, '0'), string.Empty, 508, 241), string.Empty, 749, 2);
