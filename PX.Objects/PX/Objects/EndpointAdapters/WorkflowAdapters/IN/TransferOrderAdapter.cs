...
// Type: PX.Objects.EndpointAdapters.WorkflowAdapters.IN.TransferOrderAdapter
...
internal class TransferOrderAdapter : InventoryRegisterAdapterBase
{
  ...
  protected virtual void TransferOrder_Insert(
    PXGraph graph,
    EntityImpl entity,
  ...
  protected virtual void TransferOrder_Update(
    PXGraph graph,
    EntityImpl entity,
    EntityImpl targetEntity)
  {
