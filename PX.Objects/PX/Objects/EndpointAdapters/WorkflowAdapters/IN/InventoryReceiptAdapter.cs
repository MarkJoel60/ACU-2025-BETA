...
// Type: PX.Objects.EndpointAdapters.WorkflowAdapters.IN.InventoryReceiptAdapter
...
internal class InventoryReceiptAdapter : InventoryRegisterAdapterBase
{
  ...
  protected virtual void InventoryReceipt_Insert(
    PXGraph graph,
    EntityImpl entity,
  ...
  protected virtual void InventoryReceipt_Update(
    PXGraph graph,
    EntityImpl entity,
    EntityImpl targetEntity)
  {
