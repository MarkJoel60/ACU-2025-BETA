...
// Type: PX.Objects.RQ.SubAccountMaskAttribute
...
public sealed class SubAccountMaskAttribute : PXEntityAttribute
{
  ...
  {
    PXDimensionMaskAttribute dimensionMaskAttribute = new PXDimensionMaskAttribute("SUBACCOUNT", "RQSETUP", "D", new RQAcctSubDefault.ClassListAttribute().AllowedValues, new RQAcctSubDefault.ClassListAttribute().AllowedLabels);
    dimensionMaskAttribute.ValidComboRequired = true;
  ...
  public static string MakeSub<Field>(PXGraph graph, string mask, object[] sources, Type[] fields) where Field : IBqlField
  {
    ...
    catch (PXMaskArgumentException ex)
    {
      ...
      {
        (object) new RQAcctSubDefault.ClassListAttribute().AllowedLabels[ex.SourceIdx],
