...
public static class Messages
{
  ...
  public const string VendorIsNull = "Select a vendor for requisition.";
  public const string VendorLocationIsNull = "Select a vendor location for requisition.";
  ...
  public const string RequisitionVendorCuryRateIDValidation = "The currency rate of the vendor is {0}. Do you want to change the currency rate in the requisition document to the currency rate of the vendor?";
  ...
  public const string ChooseVendor = "Select Vendor";
