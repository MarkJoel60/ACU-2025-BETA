...
// Type: PX.Objects.CA.PXDBStringWithMaskAttribute
...
public class PXDBStringWithMaskAttribute : PXDBStringAttribute, IPXFieldSelectingSubscriber
{
  ...
  public PXDBStringWithMaskAttribute(int length, Type aMaskSearch)
    : base(length)
  {
  ...
  /// <param name="aMaskSearch">Must be a IBqlSearch type returning a valid mask expression</param>
  public PXDBStringWithMaskAttribute(Type aMaskSearch) => this.AssignMaskSearch(aMaskSearch);
  ...
  public virtual void FieldSelecting(PXCache sender, PXFieldSelectingEventArgs e)
  {
    if (e.Row != null)
    {
      ...
      if (!string.IsNullOrEmpty(mask))
        e.ReturnState = (object) PXStringState.CreateInstance(e.ReturnState, new int?(this._Length), new bool?(), ((PXEventSubscriberAttribute) this)._FieldName, new bool?(((PXDBFieldAttribute) this)._IsKey), new int?(), mask, (string[]) null, (string[]) null, new bool?(), (string) null, (string[]) null);
      else
