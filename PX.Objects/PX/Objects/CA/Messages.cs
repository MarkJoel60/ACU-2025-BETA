...
public static class Messages
{
  ...
  public const string DocumentStatusInvalid = "Document Status is invalid for processing.";
  ...
  public const string AnyRequiredPaymentInstructionCanNotBeEmpty = "The payment instruction is required and cannot be empty.";
  ...
  public const string RemittanceSettingValueIsNotValid = "The provided value does not pass the validation rule defined for this box on the Remittance Setting tab of the Payment Methods(CA204000) form: {0}.";
  ...
  public const string ProcessingCenterIsAlreadyOverriddenForBranch = "The {0} processing center has been selected as default for the {1} branch. Only one processing center can be defined as default for a single branch and payment method.";
  public const string ProcessingCenterIsNotActiveForPaymentMethod = "The {0} processing center is not an active processing center configured for the current payment method.";
  public const string BranchOverrideWillBeRemovedOnSave = "The corresponding setting for the {0} processing center in the Overrides by Branch section will be removed once the changes are saved.";
  ...
  public const string CABatchDefaultExportFilenameTemplate = "{0}-{1}-{2:yyyyMMdd}{3:00000}.txt";
  ...
  public const string SomeRemittanceSettingsForCashAccountAreNotValid = "Some remittance settings for this payment method have invalid values. Update the settings on the Remittance Settings tab.";
  ...
  public const string VoidedDepositCannotBeReleasedDueToInvalidStatusOfIncludedPayments = "The voided deposit cannot be released due to an invalid status of at least one included payment.";
  public const string VoidedDepositCannotBeReleasedDueToInvalidStatusOfPayment = "The voided deposit cannot be released because of the invalid status of the included payment. Delete the voided payment before releasing the deposit.";
  public const string DepositCannotBeReleasedDueToIncludedPaymentHasUnreleasedVoidingEntry = "The deposit cannot be released because at least one included payment has an unreleased voiding entry. Delete the unreleased voided payments before releasing the deposit.";
  ...
  public const string UnreleasedVoidingEntryExistForPaymentToDeleteVoiding = "The payment {0} has an unreleased voiding entry. Delete the unreleased voiding entry before releasing the deposit or exclude the payment from the deposit.";
  public const string UnreleasedVoidingEntryExistForRefundToDeleteVoiding = "The refund {0} has an unreleased voiding entry. Delete the unreleased voiding entry before releasing the deposit or exclude the refund from the deposit.";
  public const string UnreleasedVoidingEntryExistForPaymentToDeleteVoided = "The payment {0} has an unreleased voiding entry. Delete the unreleased voided entry before releasing the deposit or exclude the payment from the deposit.";
  public const string UnreleasedVoidingEntryExistForRefundToDeleteVoided = "The refund {0} has an unreleased voiding entry. Delete the unreleased voided entry before releasing the deposit or exclude the refund from the deposit.";
  ...
  public const string DocumentNotApproved = "The document has the Pending Approval status and cannot be released. The document must be approved by a responsible person before it can be released.";
  ...
  public const string NoPaymentsSetBatchStatusToDeposited = "There are no payments that can be included in a deposit. Do you want to change the batch status to Deposited to complete the processing?";
  ...
  public const string SetPaymentDateToBankTransactionDateProhibited = "The Set Payment Date to Bank Transaction Date check box cannot be selected for payment methods with the Integrated Processing check box selected.";
  public const string SomeDetailsWereRemovedFromCurrentBatchPayment = "Some details were removed from the current batch payment. Save or cancel changes before performing any modifications.";
  public const string CashAccountBalanceCannotBeRecalculatedDueToTransferIsRecalculatingAtTheMoment = "The balance of the {0} cash account cannot be recalculated because the balance of the {1} cash account is currently being recalculated for the {2} transfer. Click Recalculate Account Balance again.";
  public const string CashAccountBalanceCannotBeRecalculatedDueToDepositIsRecalculatingAtTheMoment = "The balance of the {0} cash account cannot be recalculated because the balance of the {1} cash account is currently being recalculated for the {2} deposit. Click Recalculate Account Balance again.";
  public const string DirectDepositFileFormatIsNotSupported = "The Direct Deposit file format is not supported.";
  public const string ProcessingCenterCannotBeFound = "The {0} processing center cannot be found in the system.";
  public const string CannotRecordRejectionWithExistingVoidedPayment = "The rejection of the transaction cannot be recorded because the {0} document with the {1} ref. number is already voided or refunded in the system. Click Hide to hide the transaction.";
  public const string CantRecordRejectionOrVoid = "The rejection or voiding of the transaction cannot be recorded because the original payment does not exist in the system. Click Hide to hide the transaction.";
  public const string VerifyWarningsOnDetails = "There are warnings for this transaction. Verify the transaction settings.";
  public const string InactiveProcessor = "External Payment Processor '{0}' is inactive";
  public const string TransactionIsReclassifiedAlready = "The {0} transaction has already been processed.";
  ...
  public const string ExternalPaymentProcessor = "External Payment Processor";
  public const string CreditCard = "Credit Card";
  public const string CashOrCheck = "Cash/Check";
  public const string DirectDeposit = "Direct Deposit";
  public const string POSTerminal = "POS Terminal";
  public const string ExternalPaymentProcessorRequired = "The External Payment Processor box cannot be empty.";
  ...
  public const string RemittanceSetting = "Remittance Settings";
  ...
  public const string CCProcessintCenterPmntMethodBranch = "Overrides By Branch";
  ...
  public const string PayeePayer = "Payee/Payer";
  public const string TranCode = "Tran. Code";
  public const string AccountName = "Bank Account Name";
  public const string TransactionID = "Ext. Tran. ID";
  public const string TranDate = "Tran. Date";
  public const string Amount = "Transaction Amount";
  public const string CreditAmount = "Receipt Amount";
  public const string DebitAmount = "Disbursement Amount";
  public const string DebitCreditParameter = "Debit/Credit Property in Separate Column";
  ...
  public const string ARAPPrepaymentInvoice = "Prepmt. Invoice";
  ...
  public const string AccountWithoutMaskAlreadyLinked = "The {0} account is already linked to the {1} bank feed.";
  ...
  public const string BankFeedTestConnectionError = "Test connection error: {0}";
  public const string NoMappedFeedAccountsToCashAcc = "At least one bank feed account must be mapped to the cash account on the Cash Accounts tab.";
  public const string DefineUriScheme = "The {0} box should start with '{1}'.";
  public const string ProviderNotFound = "The data provider could not be found in the system.";
  public const string CannotFindFileSpecificFormat = "No files with the {0} format were found in the {1} folder.";
  public const string CannotGetAccessToSharedFolder = "Unable to connect to URL {0}. Verify the values in the Connection to Source File section and try again.";
  public const string CannotGetDateValue = "Cannot get date value from string {0} (file {1} transaction ID {2}).";
  public const string CannotGetDecimalValue = "Cannot get decimal value from string {0} (file {1} transaction ID {2}).";
  public const string FieldCannotBeEmpty = "The {0} column cannot be empty (file {1}).";
  public const string FieldCannotBeEmptyErrorWithId = "The {0} field cannot be empty (file {1} transaction {2}).";
  public const string DebitAndCreditDoNotHaveValues = "The {0} transaction does not have values in the {1} and {2} columns (file {3}).";
  public const string DebitAndCreditHaveValues = "The system does not allow to have both values in the {0} and {1} columns for the {2} transaction (file {3}).";
  public const string AmountShouldBeNotNegative = "The amount must not be negative for {1} transaction (file {2}).";
  public const string ChangeFinInstitutionWarn = "If you change the Financial Institution, the history of bank account transactions will be lost and the default Import Transactions From date will be incorrect. Continue?";
  public const string MappingWasNotSetWarn = "Mapping was not set on the Source File tab.";
  ...
  public const string AmountInSameColumn = "Debit/Credit in Same Column";
  public const string AmountInDifferentColumns = "Debit and Credit in Different Columns";
  public const string CsvFileFormat = "CSV (Comma-Separated Values)";
  public const string BaiFileFormat = "BAI2 (Bank Administration Institute)";
  public const string AmountDependsOnParameter = "Debit/Credit Property in Separate Column";
  ...
  public const string OptionName = "Fields";
  public const string CategoryName = "Bank Feed Transaction";
  public const string ConfirmChangingBankFeedType = "Changing the Bank Feed Type will reset the setup. Continue?";
  ...
  public const string IncorrectDaysOfLoadingTrans = "Plaid cannot provide more than 730 days (2 years) of historical bank transaction data. For best performance and reliability, it is recommended to request no more than 90 days of transaction history.";
  ...
  public const string ErrorWrongFileFormat = "The {0} data provider cannot read the format of the {1} file. Provide a file with the {2} file format.";
  public const string CannotGetValueFromString = "The system cannot extract the value of the {0} field from the following string: {1} (file: {2}; line number: {3}; position: {4}).";
  public const string UnknownCode = "Line {0} in the {1} file contains an unknown code ({2}).";
  public const string UnknownFundsType = "Line {0} in the {1} file contains an unknown funds type ({2}).";
  public const string UnexpectedCode = "Line {0} in the {1} file contains the following unexpected code sequence: {2}.";
  public const string BankReferenceNumberCannotBeEmpty = "The Bank Reference Number field in line {0} of the {1} file must not be left empty.";
  ...
  public const string OFXDocumentHasInvalidOpenTag = "The document has an invalid format - missing open tag: <{0}> at position {1}.";
  ...
  public const string AutoMatchOnly = "Auto-Match Only";
  ...
  public const string NoPaymentsSetBatchStatusToDepositedTitle = "Update Batch Status";
  public const string NoPaymentsSetBatchStatusToDepositedButtonOK = "Update Status";
  public const string NoPaymentsSetBatchStatusToDepositedButtonCancel = "Cancel";
}
