...
// Type: PX.Objects.CA.CABankTaxTranMatch
...
[PXBreakInheritance]
[PXCacheName("CABankTaxTranMatch")]
[Serializable]
public class CABankTaxTranMatch : TaxDetail, IBqlTable, IBqlTableSystemDataStorage
{
  protected 
  #nullable disable
  string _JurisName;
  ...
  [CABankTranType.List]
  [PXUIField]
  [PXParent(typeof (CABankTaxTranMatch.FK.BankTransaction))]
  ...
  [PXDBInt]
  [PXDefault(typeof (Search<PX.Objects.TX.Tax.taxVendorID, Where<PX.Objects.TX.Tax.taxID, Equal<Current<CABankTaxTranMatch.taxID>>>>))]
  ...
  [PX.Objects.GL.FinPeriodID(null, typeof (CABankTaxTranMatch.branchID), null, null, null, null, true, false, null, null, typeof (CABankTran.tranPeriodID), true, true)]
  [PXDefault]
  ...
  /// </summary>
  [PXDBDate]
  [PXDBDefault(typeof (Search2<OrganizationFinPeriod.finDate, InnerJoin<PX.Objects.GL.Branch, On<OrganizationFinPeriod.organizationID, Equal<PX.Objects.GL.Branch.organizationID>>>, Where<PX.Objects.GL.Branch.branchID, Equal<Current2<CABankTaxTranMatch.branchID>>, And<OrganizationFinPeriod.finPeriodID, Equal<Current2<CABankTaxTranMatch.finPeriodID>>>>>))]
  ...
  [PXDBCurrency(typeof (CABankTaxTranMatch.curyInfoID), typeof (CABankTaxTranMatch.taxDiscountAmt))]
  ...
  /// </summary>
  [PXDBCurrency(typeof (CABankTaxTranMatch.curyInfoID), typeof (CABankTaxTranMatch.origTaxableAmt))]
  [PXDefault(TypeCode.Decimal, "0.0")]
  ...
  [PXDBCurrency(typeof (CABankTaxTranMatch.curyInfoID), typeof (CABankTaxTranMatch.taxableAmt))]
  [PXDefault(TypeCode.Decimal, "0.0")]
  [PXUIField]
  ...
  [PXDBCurrency(typeof (CABankTaxTranMatch.curyInfoID), typeof (CABankTaxTranMatch.exemptedAmt))]
  [PXDefault(TypeCode.Decimal, "0.0")]
  [PXUIField]
  ...
  [PXDBCurrency(typeof (CABankTaxTranMatch.curyInfoID), typeof (CABankTaxTranMatch.taxAmt))]
  [PXDefault(TypeCode.Decimal, "0.0")]
  [PXUIField]
  ...
  [PXDBCurrency(typeof (CABankTaxTranMatch.curyInfoID), typeof (CABankTaxTranMatch.taxAmtSumm))]
  [PXDefault(TypeCode.Decimal, "0.0")]
  ...
  [PXDBCurrency(typeof (CABankTaxTranMatch.curyInfoID), typeof (CABankTaxTranMatch.expenseAmt))]
  [PXDefault(TypeCode.Decimal, "0.0")]
  [PXUIField]
  ...
  [PXDBInt]
  [PXDefault(typeof (Search<TaxRev.taxBucketID, Where<TaxRev.taxID, Equal<Current<CABankTaxTranMatch.taxID>>, And<Current<CABankTaxTranMatch.tranDate>, Between<TaxRev.startDate, TaxRev.endDate>, And2<Where<TaxRev.taxType, Equal<Current<CABankTaxTranMatch.taxType>>, Or<TaxRev.taxType, Equal<PX.Objects.TX.TaxType.sales>, And<Current<CABankTaxTranMatch.taxType>, Equal<PX.Objects.TX.TaxType.pendingSales>, Or<TaxRev.taxType, Equal<PX.Objects.TX.TaxType.purchase>, And<Current<CABankTaxTranMatch.taxType>, Equal<PX.Objects.TX.TaxType.pendingPurchase>>>>>>, And<TaxRev.outdated, Equal<False>>>>>>))]
  ...
  public class PK : 
    PrimaryKeyOf<CABankTaxTran>.By<CABankTaxTranMatch.module, CABankTaxTranMatch.tranDate, CABankTaxTranMatch.recordID>
  {
    ...
    {
      return (CABankTaxTran) PrimaryKeyOf<CABankTaxTran>.By<CABankTaxTranMatch.module, CABankTaxTranMatch.tranDate, CABankTaxTranMatch.recordID>.FindBy(graph, (object) module, (object) tranDate, (object) recordID, options);
    }
  }
  ...
  public static class FK
  {
    public class BankTransaction : 
      PrimaryKeyOf<CABankTran>.By<CABankTran.tranID>.ForeignKeyOf<CABankTax>.By<CABankTaxTranMatch.bankTranID>
    {
    }
  }
  ...
  public abstract class bankTranType : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    CABankTaxTranMatch.bankTranType>
  {
  }
  ...
  public abstract class taxPeriodID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    CABankTaxTranMatch.taxPeriodID>
  {
  }
  ...
  public abstract class finPeriodID : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    CABankTaxTranMatch.finPeriodID>
  {
  }
  ...
  public abstract class curyTaxDiscountAmt : 
    ...
    #nullable disable
    CABankTaxTranMatch.curyTaxDiscountAmt>
  {
  }
  ...
  public abstract class taxDiscountAmt : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    CABankTaxTranMatch.taxDiscountAmt>
  {
  }
  ...
  public abstract class curyOrigTaxableAmt : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    CABankTaxTranMatch.curyOrigTaxableAmt>
  {
  }
  ...
  public abstract class origTaxableAmt : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    CABankTaxTranMatch.origTaxableAmt>
  {
  }
  ...
  public abstract class curyTaxableAmt : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    CABankTaxTranMatch.curyTaxableAmt>
  {
  }
  ...
  public abstract class curyTaxAmtSumm : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    CABankTaxTranMatch.curyTaxAmtSumm>
  {
  }

  public abstract class taxAmtSumm : 
    BqlType<
    #nullable enable
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    CABankTaxTranMatch.taxAmtSumm>
  {
  }
  ...
  public abstract class nonDeductibleTaxRate : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    CABankTaxTranMatch.nonDeductibleTaxRate>
  {
  }
  ...
  public abstract class curyExpenseAmt : 
    ...
    IBqlDecimal, Decimal>.Field<
    #nullable disable
    CABankTaxTranMatch.curyExpenseAmt>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  CABankTaxTranMatch.taxBucketID>
  {
  }
  ...
  public abstract class taxInvoiceNbr : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    CABankTaxTranMatch.taxInvoiceNbr>
  {
  }
  ...
  public abstract class taxInvoiceDate : 
    ...
    IBqlDateTime, DateTime>.Field<
    #nullable disable
    CABankTaxTranMatch.taxInvoiceDate>
  {
  }
  ...
  public abstract class origTranType : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    CABankTaxTranMatch.origTranType>
  {
  }
  ...
  public abstract class adjdDocType : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    CABankTaxTranMatch.adjdDocType>
  {
  }
  ...
  public abstract class description : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    CABankTaxTranMatch.description>
  {
  }
