...
// Type: ReconciliationTools.APGLDiscrepancyByDocumentEnqResult
...
[Serializable]
public class APGLDiscrepancyByDocumentEnqResult : 
  ...
  IDiscrepancyEnqResult
{
  ...
  public abstract class xXTurnover : 
    ...
    #nullable disable
    APGLDiscrepancyByDocumentEnqResult.xXTurnover>
  {
  }
  ...
  public abstract class discrepancy : 
    ...
    #nullable disable
    APGLDiscrepancyByDocumentEnqResult.discrepancy>
  {
  }
}
