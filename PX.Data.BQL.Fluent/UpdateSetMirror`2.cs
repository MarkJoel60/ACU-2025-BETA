...
// Type: PX.Data.BQL.Fluent.UpdateSetMirror`2
...
/// <exclude />
public abstract class UpdateSetMirror<TTable, TAssigns> : UpdateSet<TTable, TAssigns>
  where TTable : class, IBqlTable, new()
  where TAssigns : ITypeArrayOf<IFbqlSet>
{
  /// <summary>Adds another field assignment.</summary>
  public new class Set<TAssign> : UpdateSet<TTable, TypeArrayOf<IFbqlSet>.Append<TAssigns, TAssign>> where TAssign : IFbqlSet
  {
  }
}
