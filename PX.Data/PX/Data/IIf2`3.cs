...
/// <exclude />
public class IIf2<Operator, Operand, OperandElse> : IBqlOperand, IBqlCreator, IBqlVerifier
  where Operator : IBqlUnary, new()
  where Operand : IBqlOperand
  where OperandElse : IBqlOperand
{
  private readonly IBqlCreator _formula = (IBqlCreator) new Switch<Case2<Where<Operator>, Operand>, OperandElse>();
