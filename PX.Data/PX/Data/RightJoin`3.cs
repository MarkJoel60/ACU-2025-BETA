...
/// <example><para>Below is an example of a data view with RightJoin and the corresponding SQL query.</para>
...
/// </example>
public sealed class RightJoin<Table, On, NextJoin> : JoinBase<Table, On, NextJoin>
