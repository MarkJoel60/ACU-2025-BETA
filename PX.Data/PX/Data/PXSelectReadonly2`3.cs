...
// Type: PX.Data.PXSelectReadonly2`3
...
public class PXSelectReadonly2<Table, Join, Where> : 
  PXSelectBase<Table, PXSelectReadonly2<Table, Join, Where>.Config>
  ...
  where Where : IBqlWhere, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectReadonly2<Table, Join, Where>.Config>.IViewConfig,
    IViewConfigBase
  {
