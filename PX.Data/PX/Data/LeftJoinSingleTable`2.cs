...
// Type: PX.Data.LeftJoinSingleTable`2
...
/// <summary>Joins tables by using the <tt>LEFT JOIN</tt> clause. Joins first table only.</summary>
...
public sealed class LeftJoinSingleTable<Table, On> : JoinBase<Table, On, BqlNone>, IBqlJoinHints
