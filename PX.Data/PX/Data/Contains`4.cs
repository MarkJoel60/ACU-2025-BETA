...
/// <example><para>For example, the following statement illustrates the use of the Contains function.</para>
...
/// </example>
public class Contains<Field, Operand, FieldKey, TopCount> : 
