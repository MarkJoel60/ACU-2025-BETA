...
// Type: PX.Data.InnerJoinSingleTable`2
...
/// <summary>Joins tables by using the <tt>INNER JOIN</tt> clause. Joins first table only.</summary>
...
public sealed class InnerJoinSingleTable<Table, On> : JoinBase<Table, On, BqlNone>, IBqlJoinHints
