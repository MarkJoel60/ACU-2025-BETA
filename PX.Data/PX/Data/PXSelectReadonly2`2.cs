...
// Type: PX.Data.PXSelectReadonly2`2
...
public class PXSelectReadonly2<Table, Join> : 
  PXSelectBase<Table, PXSelectReadonly2<Table, Join>.Config>
  ...
  where Join : IBqlJoin, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectReadonly2<Table, Join>.Config>.IViewConfig,
    IViewConfigBase
  {
    public BqlCommand GetCommand() => (BqlCommand) new Select2<Table, Join>();
