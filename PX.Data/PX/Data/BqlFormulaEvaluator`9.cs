...
// Type: PX.Data.BqlFormulaEvaluator`9
...
public abstract class BqlFormulaEvaluator<Operand1, Operand2, Operand3, Operand4, Operand5, Operand6, Operand7, Operand8, Operand9> : 
  BqlFormulaEvaluator<Operand1, Operand2, Operand3, Operand4, Operand5, Operand6, Operand7, Operand8>
  ...
  where Operand9 : IBqlOperand
{
  protected IBqlCreator _operand9;
  ...
  {
    return base.AppendExpression(ref exp, graph, info, selection) & this.GetOperandExpression<Operand9>(ref exp, ref this._operand9, graph, info, selection);
  }
    ...
    ref object value)
  {
    value = this.Evaluate(cache, BqlFormula.ItemContainer.Unwrap(item), new Dictionary<System.Type, object>()
    {
      ...
      [typeof (Operand9)] = this.Calculate<Operand9>(cache, item)
    });
  }
}
