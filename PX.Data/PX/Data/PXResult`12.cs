...
/// <exclude />
[Serializable]
public class PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : 
  PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
  ...
  where T11 : class, IBqlTable, new()
{
  ...
  public static implicit operator T0(
    PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> r)
  {
  ...
  public override object this[System.Type t] => t == typeof (T11) ? this.Items[11] : base[t];

  public override object this[string s] => s == typeof (T11).Name ? this.Items[11] : base[s];

  public override System.Type GetItemType(int i) => i == 11 ? typeof (T11) : base.GetItemType(i);

  public override System.Type GetItemType(string s)
  {
    return s == typeof (T11).Name ? typeof (T11) : base.GetItemType(s);
  }

  public static PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> Current
  {
    get
    {
      ...
      if (slot != null)
      {
        ...
        if (slot.TryGetValue(typeof (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>), out current))
          return (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>) current;
      }
      return (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>) null;
    }
  }
  ...
  public void Deconstruct(
    ...
    out T11 item11)
  {
    (item0, item1, item2, item3, item4, item5, item6, item7, item8, item9, item10) = this;
    item11 = (T11) this;
  }
}
