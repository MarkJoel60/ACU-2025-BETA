...
/// <exclude />
[Obsolete("Use Sub<,>")]
public sealed class Minus<Operand1, Operand2> : IBqlOperand, IBqlCreator, IBqlVerifier
  where Operand1 : IBqlOperand
  where Operand2 : IBqlOperand
{
  private readonly IBqlCreator _formula = (IBqlCreator) new Sub<Operand1, Operand2>();
