...
public class PXSelectJoin<Table, Join, Where, OrderBy> : 
  PXSelectBase<Table, PXSelectJoin<Table, Join, Where, OrderBy>.Config>
  ...
  where OrderBy : IBqlOrderBy, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectJoin<Table, Join, Where, OrderBy>.Config>.IViewConfig,
    IViewConfigBase
  {
