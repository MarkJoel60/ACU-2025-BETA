...
/// <exclude />
[Serializable]
public class PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> : 
  PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
  ...
  where T12 : class, IBqlTable, new()
{
  ...
  public static implicit operator T0(
    PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> r)
  {
  ...
  public override object this[System.Type t] => t == typeof (T12) ? this.Items[12] : base[t];

  public override object this[string s] => s == typeof (T12).Name ? this.Items[12] : base[s];

  public override System.Type GetItemType(int i) => i == 12 ? typeof (T12) : base.GetItemType(i);

  public override System.Type GetItemType(string s)
  {
    return s == typeof (T12).Name ? typeof (T12) : base.GetItemType(s);
  }

  public static PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> Current
  {
    get
    {
      ...
      if (slot != null)
      {
        ...
        if (slot.TryGetValue(typeof (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>), out current))
          return (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>) current;
      }
      return (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>) null;
    }
  }
  ...
  public void Deconstruct(
    ...
    out T12 item12)
  {
    (item0, item1, item2, item3, item4, item5, item6, item7, item8, item9, item10, item11) = this;
    item12 = (T12) this;
  }
}
