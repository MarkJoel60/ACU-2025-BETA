...
// Type: PX.Data.PXRowPersistingException
...
public class PXRowPersistingException : PXOverridableException
{
  ...
  public PXRowPersistingException(SerializationInfo info, StreamingContext context)
    : base(info, context)
  {
    ReflectionSerializer.RestoreObjectProps<PXRowPersistingException>(this, info);
  }

  public override void GetObjectData(SerializationInfo info, StreamingContext context)
  {
    ReflectionSerializer.GetObjectData<PXRowPersistingException>(this, info);
