...
[Obsolete("Use Add<,>")]
public sealed class Plus<Operand1, Operand2> : IBqlOperand, IBqlCreator, IBqlVerifier
  where Operand1 : IBqlOperand
  where Operand2 : IBqlOperand
{
  private readonly IBqlCreator formula = (IBqlCreator) new Add<Operand1, Operand2>();
