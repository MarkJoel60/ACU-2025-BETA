...
// Type: PX.Data.Update.ExchangeService.GetMessageTrackingReportResponseMessageType
...
public class GetMessageTrackingReportResponseMessageType : ResponseMessageType
{
  ...
  {
    get => this.messageTrackingReportField;
    set => this.messageTrackingReportField = value;
  }
