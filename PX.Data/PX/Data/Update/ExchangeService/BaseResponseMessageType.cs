...
// Type: PX.Data.Update.ExchangeService.BaseResponseMessageType
...
[XmlInclude(typeof (GetFederatedDirectoryGroupResponseMessageType))]
...
public class BaseResponseMessageType
{
  ...
  {
    get => this.responseMessagesField;
    set => this.responseMessagesField = value;
  }
}
