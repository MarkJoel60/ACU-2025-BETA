...
// Type: PX.Data.Update.ExchangeService.GetUserRetentionPolicyTagsResponseMessageType
...
public class GetUserRetentionPolicyTagsResponseMessageType : ResponseMessageType
{
  ...
  {
    get => this.retentionPolicyTagsField;
    set => this.retentionPolicyTagsField = value;
  }
}
