...
// Type: PX.Data.Update.ExchangeService.CalendarItemType
...
public class CalendarItemType : ItemType
{
  ...
  {
    get => this.calendarItemType1Field;
    set => this.calendarItemType1Field = value;
  }
  ...
  {
    get => this.calendarItemType1FieldSpecified;
    set => this.calendarItemType1FieldSpecified = value;
  }
  ...
  {
    get => this.joinOnlineMeetingUrlField;
    set => this.joinOnlineMeetingUrlField = value;
  }

  /// <remarks />
  public OnlineMeetingSettingsType OnlineMeetingSettings
  {
    get => this.onlineMeetingSettingsField;
    set => this.onlineMeetingSettingsField = value;
  }
