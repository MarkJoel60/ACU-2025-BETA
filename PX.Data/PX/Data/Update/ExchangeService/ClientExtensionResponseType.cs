...
// Type: PX.Data.Update.ExchangeService.ClientExtensionResponseType
...
public class ClientExtensionResponseType : ResponseMessageType
{
  ...
  {
    get => this.clientExtensionsField;
    set => this.clientExtensionsField = value;
  }

  /// <remarks />
  public string RawMasterTableXml
  {
    get => this.rawMasterTableXmlField;
    set => this.rawMasterTableXmlField = value;
  }
}
