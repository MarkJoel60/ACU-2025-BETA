...
// Type: PX.Data.Update.ExchangeService.CompleteFindInGALSpeechRecognitionResponseMessageType
...
public class CompleteFindInGALSpeechRecognitionResponseMessageType : ResponseMessageType
{
  ...
  {
    get => this.recognitionResultField;
    set => this.recognitionResultField = value;
  }
}
