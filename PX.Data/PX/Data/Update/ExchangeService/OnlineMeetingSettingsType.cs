...
// Type: PX.Data.Update.ExchangeService.OnlineMeetingSettingsType
...
public class OnlineMeetingSettingsType
{
  ...
  {
    get => this.lobbyBypassField;
    set => this.lobbyBypassField = value;
  }
  ...
  {
    get => this.presentersField;
    set => this.presentersField = value;
  }
}
