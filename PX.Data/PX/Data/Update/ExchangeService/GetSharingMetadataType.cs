...
// Type: PX.Data.Update.ExchangeService.GetSharingMetadataType
...
public class GetSharingMetadataType : BaseRequestType
{
  ...
  {
    get => this.idOfFolderToShareField;
    set => this.idOfFolderToShareField = value;
  }

  /// <remarks />
  public string SenderSmtpAddress
  {
    get => this.senderSmtpAddressField;
    set => this.senderSmtpAddressField = value;
  }
