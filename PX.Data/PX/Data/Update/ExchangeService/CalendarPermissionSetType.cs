...
// Type: PX.Data.Update.ExchangeService.CalendarPermissionSetType
...
public class CalendarPermissionSetType
{
  ...
  {
    get => this.calendarPermissionsField;
    set => this.calendarPermissionsField = value;
  }
  ...
  {
    get => this.unknownEntriesField;
    set => this.unknownEntriesField = value;
  }
}
