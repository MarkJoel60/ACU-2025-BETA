...
// Type: PX.Data.Update.ExchangeService.GetUserAvailabilityResponseType
...
public class GetUserAvailabilityResponseType
{
  ...
  {
    get => this.freeBusyResponseArrayField;
    set => this.freeBusyResponseArrayField = value;
  }

  /// <remarks />
  public SuggestionsResponseType SuggestionsResponse
  {
    get => this.suggestionsResponseField;
    set => this.suggestionsResponseField = value;
  }
}
