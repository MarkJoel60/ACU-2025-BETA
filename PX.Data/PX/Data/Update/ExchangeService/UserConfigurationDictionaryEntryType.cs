...
// Type: PX.Data.Update.ExchangeService.UserConfigurationDictionaryEntryType
...
public class UserConfigurationDictionaryEntryType
{
  ...
  {
    get => this.dictionaryKeyField;
    set => this.dictionaryKeyField = value;
  }
  ...
  {
    get => this.dictionaryValueField;
    set => this.dictionaryValueField = value;
  }
}
