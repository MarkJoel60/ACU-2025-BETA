...
// Type: PX.Data.Update.ExchangeService.GetPhoneCallInformationResponseMessageType
...
public class GetPhoneCallInformationResponseMessageType : ResponseMessageType
{
  ...
  {
    get => this.phoneCallInformationField;
    set => this.phoneCallInformationField = value;
  }
}
