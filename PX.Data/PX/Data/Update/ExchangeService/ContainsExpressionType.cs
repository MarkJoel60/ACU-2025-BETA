...
// Type: PX.Data.Update.ExchangeService.ContainsExpressionType
...
public class ContainsExpressionType : SearchExpressionType
{
  ...
  {
    get => this.containmentModeField;
    set => this.containmentModeField = value;
  }
  ...
  {
    get => this.containmentModeFieldSpecified;
    set => this.containmentModeFieldSpecified = value;
  }
  ...
  {
    get => this.containmentComparisonField;
    set => this.containmentComparisonField = value;
  }
  ...
  {
    get => this.containmentComparisonFieldSpecified;
    set => this.containmentComparisonFieldSpecified = value;
  }
}
