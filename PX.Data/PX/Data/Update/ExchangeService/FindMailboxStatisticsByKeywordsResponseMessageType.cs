...
// Type: PX.Data.Update.ExchangeService.FindMailboxStatisticsByKeywordsResponseMessageType
...
public class FindMailboxStatisticsByKeywordsResponseMessageType : ResponseMessageType
{
  ...
  {
    get => this.mailboxStatisticsSearchResultField;
    set => this.mailboxStatisticsSearchResultField = value;
  }
}
