...
// Type: PX.Data.Update.ExchangeService.GetDiscoverySearchConfigurationResponseMessageType
...
public class GetDiscoverySearchConfigurationResponseMessageType : ResponseMessageType
{
  ...
  {
    get => this.discoverySearchConfigurationsField;
    set => this.discoverySearchConfigurationsField = value;
  }
}
