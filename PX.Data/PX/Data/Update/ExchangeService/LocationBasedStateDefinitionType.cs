...
// Type: PX.Data.Update.ExchangeService.LocationBasedStateDefinitionType
...
public class LocationBasedStateDefinitionType : BaseCalendarItemStateDefinitionType
{
  ...
  {
    get => this.organizerLocationField;
    set => this.organizerLocationField = value;
  }

  /// <remarks />
  public string AttendeeLocation
  {
    get => this.attendeeLocationField;
    set => this.attendeeLocationField = value;
  }
}
