...
// Type: PX.Data.Update.ExchangeService.GetAttachmentType
...
public class GetAttachmentType : BaseRequestType
{
  ...
  {
    get => this.attachmentShapeField;
    set => this.attachmentShapeField = value;
  }
  ...
  {
    get => this.attachmentIdsField;
    set => this.attachmentIdsField = value;
  }
}
