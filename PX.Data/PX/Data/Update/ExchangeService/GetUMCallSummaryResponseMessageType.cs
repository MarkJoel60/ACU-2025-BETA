...
// Type: PX.Data.Update.ExchangeService.GetUMCallSummaryResponseMessageType
...
public class GetUMCallSummaryResponseMessageType : ResponseMessageType
{
  ...
  {
    get => this.uMReportRawCountersCollectionField;
    set => this.uMReportRawCountersCollectionField = value;
  }
}
