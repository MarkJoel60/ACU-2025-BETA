...
// Type: PX.Data.Update.ExchangeService.VotingInformationType
...
public class VotingInformationType
{
  ...
  {
    get => this.userOptionsField;
    set => this.userOptionsField = value;
  }

  /// <remarks />
  public string VotingResponse
  {
    get => this.votingResponseField;
    set => this.votingResponseField = value;
  }
}
