...
// Type: PX.Data.Update.ExchangeService.RelativeMonthlyRecurrencePatternType
...
public class RelativeMonthlyRecurrencePatternType : IntervalRecurrencePatternBaseType
{
  ...
  {
    get => this.dayOfWeekIndexField;
    set => this.dayOfWeekIndexField = value;
  }
}
