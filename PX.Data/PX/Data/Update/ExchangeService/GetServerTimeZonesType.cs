...
// Type: PX.Data.Update.ExchangeService.GetServerTimeZonesType
...
public class GetServerTimeZonesType : BaseRequestType
{
  ...
  {
    get => this.returnFullTimeZoneDataField;
    set => this.returnFullTimeZoneDataField = value;
  }
  ...
  {
    get => this.returnFullTimeZoneDataFieldSpecified;
    set => this.returnFullTimeZoneDataFieldSpecified = value;
  }
}
