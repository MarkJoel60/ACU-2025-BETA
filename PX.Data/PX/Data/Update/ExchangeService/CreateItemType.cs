...
// Type: PX.Data.Update.ExchangeService.CreateItemType
...
public class CreateItemType : BaseRequestType
{
  ...
  {
    get => this.sendMeetingInvitationsField;
    set => this.sendMeetingInvitationsField = value;
  }
  ...
  {
    get => this.sendMeetingInvitationsFieldSpecified;
    set => this.sendMeetingInvitationsFieldSpecified = value;
  }
}
