...
// Type: PX.Data.Update.ExchangeService.TaskSuggestionType
...
public class TaskSuggestionType : EntityType
{
  ...
  {
    get => this.taskStringField;
    set => this.taskStringField = value;
  }
  ...
  {
    get => this.assigneesField;
    set => this.assigneesField = value;
  }
}
