...
// Type: PX.Data.Update.ExchangeService.MailboxStatisticsSearchResultType
...
public class MailboxStatisticsSearchResultType
{
  ...
  {
    get => this.userMailboxField;
    set => this.userMailboxField = value;
  }

  /// <remarks />
  public KeywordStatisticsSearchResultType KeywordStatisticsSearchResult
  {
    get => this.keywordStatisticsSearchResultField;
    set => this.keywordStatisticsSearchResultField = value;
  }
}
