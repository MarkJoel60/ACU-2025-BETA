...
// Type: PX.Data.Update.ExchangeService.UpdateDelegateType
...
public class UpdateDelegateType : BaseDelegateType
{
  ...
  {
    get => this.delegateUsersField;
    set => this.delegateUsersField = value;
  }

  /// <remarks />
  public DeliverMeetingRequestsType DeliverMeetingRequests
  {
    get => this.deliverMeetingRequestsField;
    set => this.deliverMeetingRequestsField = value;
  }
  ...
  {
    get => this.deliverMeetingRequestsFieldSpecified;
    set => this.deliverMeetingRequestsFieldSpecified = value;
  }
}
