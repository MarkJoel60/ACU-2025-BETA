...
// Type: PX.Data.Update.ExchangeService.GetInboxRulesResponseType
...
public class GetInboxRulesResponseType : ResponseMessageType
{
  ...
  {
    get => this.outlookRuleBlobExistsField;
    set => this.outlookRuleBlobExistsField = value;
  }
  ...
  {
    get => this.outlookRuleBlobExistsFieldSpecified;
    set => this.outlookRuleBlobExistsFieldSpecified = value;
  }
  ...
  {
    get => this.inboxRulesField;
    set => this.inboxRulesField = value;
  }
}
