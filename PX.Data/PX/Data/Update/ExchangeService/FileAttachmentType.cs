...
// Type: PX.Data.Update.ExchangeService.FileAttachmentType
...
public class FileAttachmentType : AttachmentType
{
  ...
  {
    get => this.isContactPhotoField;
    set => this.isContactPhotoField = value;
  }
  ...
  {
    get => this.isContactPhotoFieldSpecified;
    set => this.isContactPhotoFieldSpecified = value;
  }
