...
// Type: PX.Data.BqlFormulaEvaluator`6
...
public abstract class BqlFormulaEvaluator<Operand1, Operand2, Operand3, Operand4, Operand5, Operand6> : 
  BqlFormulaEvaluator<Operand1, Operand2, Operand3, Operand4, Operand5>
...
{
  protected IBqlCreator _operand6;
  ...
  {
    return base.AppendExpression(ref exp, graph, info, selection) & this.GetOperandExpression<Operand6>(ref exp, ref this._operand6, graph, info, selection);
  }
