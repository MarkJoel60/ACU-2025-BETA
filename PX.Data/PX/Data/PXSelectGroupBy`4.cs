...
// Type: PX.Data.PXSelectGroupBy`4
...
public class PXSelectGroupBy<Table, Where, Aggregate, OrderBy> : 
  PXSelectBase<Table, PXSelectGroupBy<Table, Where, Aggregate, OrderBy>.Config>
  ...
  where OrderBy : IBqlOrderBy, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectGroupBy<Table, Where, Aggregate, OrderBy>.Config>.IViewConfig,
    IViewConfigBase
  {
    public BqlCommand GetCommand() => (BqlCommand) new Select4<Table, Where, Aggregate, OrderBy>();
