...
// Type: PX.Data.PXSelectGroupByOrderBy`3
...
public class PXSelectGroupByOrderBy<Table, Aggregate, OrderBy> : 
  PXSelectBase<Table, PXSelectGroupByOrderBy<Table, Aggregate, OrderBy>.Config>
  ...
  where OrderBy : IBqlOrderBy, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectGroupByOrderBy<Table, Aggregate, OrderBy>.Config>.IViewConfig,
    IViewConfigBase
  {
    public BqlCommand GetCommand() => (BqlCommand) new Select6<Table, Aggregate, OrderBy>();
