...
public class PXSelectJoin<Table, Join> : PXSelectBase<Table, PXSelectJoin<Table, Join>.Config>
  ...
  where Join : IBqlJoin, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectJoin<Table, Join>.Config>.IViewConfig,
    IViewConfigBase
  {
