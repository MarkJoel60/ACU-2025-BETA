...
// Type: PX.Data.PXDBShortAttribute
...
public class PXDBShortAttribute : 
  PXDBFieldAttribute,
  ...
  IPXFieldVerifyingSubscriber
{
  ...
  {
    if (e.Row != null)
      sender.SetValue(e.Row, this._FieldOrdinal, (object) e.Record.GetInt16(e.Position));
    ++e.Position;
  }
  ...
  {
    if (!(e.NewValue is short newValue))
      return;
