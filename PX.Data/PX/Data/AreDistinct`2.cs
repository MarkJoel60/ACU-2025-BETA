...
/// </summary>
public sealed class AreDistinct<TOperand1, TOperand2> : CustomPredicate
  where TOperand1 : IBqlOperand
  where TOperand2 : IBqlOperand
{
  public AreDistinct()
    : base((IBqlUnary) new Not<Where<TOperand1, Equal<TOperand2>, Or<TOperand1, IsNull, And<TOperand2, IsNull>>>>())
  {
  }
}
