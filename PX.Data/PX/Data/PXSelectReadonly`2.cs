...
// Type: PX.Data.PXSelectReadonly`2
...
public class PXSelectReadonly<Table, Where> : 
  PXSelectBase<Table, PXSelectReadonly<Table, Where>.Config>
  ...
  where Where : IBqlWhere, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectReadonly<Table, Where>.Config>.IViewConfig,
    IViewConfigBase
  {
