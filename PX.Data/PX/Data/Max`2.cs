...
/// <example><para>The following BQL statement groups Table records by the Table1.field1 field and calculates maximum values of the Table1.field2 field and minimum values of the Table1.field3 field in each group. The corresponding SQL query is given below.</para>
...
/// </example>
public sealed class Max<Field, NextAggregate> : AggregatedFnBase<Field, NextAggregate>
  where Field : IBqlField
  where NextAggregate : IBqlFunction, new()
{
  /// <exclude />
  public override string GetFunction() => "MAX";
}
