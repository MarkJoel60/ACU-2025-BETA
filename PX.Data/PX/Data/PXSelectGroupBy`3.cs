...
// Type: PX.Data.PXSelectGroupBy`3
...
public class PXSelectGroupBy<Table, Where, Aggregate> : 
  PXSelectBase<Table, PXSelectGroupBy<Table, Where, Aggregate>.Config>
  ...
  where Aggregate : IBqlAggregate, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectGroupBy<Table, Where, Aggregate>.Config>.IViewConfig,
    IViewConfigBase
  {
    public BqlCommand GetCommand() => (BqlCommand) new Select4<Table, Where, Aggregate>();
