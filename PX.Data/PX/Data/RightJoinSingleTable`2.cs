...
// Type: PX.Data.RightJoinSingleTable`2
...
/// <summary>Joins tables by using the <tt>RIGHT JOIN</tt> clause. Joins first table only.</summary>
...
public sealed class RightJoinSingleTable<Table, On> : JoinBase<Table, On, BqlNone>, IBqlJoinHints
