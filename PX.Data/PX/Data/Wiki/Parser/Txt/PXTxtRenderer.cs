...
// Type: PX.Data.Wiki.Parser.Txt.PXTxtRenderer
...
public class PXTxtRenderer : PXRenderer<PXTxtRenderer>
{
  ...
  protected override void OnRegisterCustomRenderers()
  {
    ...
    PXRenderer<PXTxtRenderer>.RegisterRenderer(typeof (PXHorLineElement), (PXTxtRenderer) new PXHorLineRenderer());
    PXRenderer<PXTxtRenderer>.RegisterRenderer(typeof (PXBoxElement), (PXTxtRenderer) new PXBoxRenderer());
    PXRenderer<PXTxtRenderer>.RegisterRenderer(typeof (PXCodeBoxElement), (PXTxtRenderer) new PXCodeBoxRenderer());
    PXRenderer<PXTxtRenderer>.RegisterRenderer(typeof (PXHiddenElement), (PXTxtRenderer) new PXTxtHiddenRenderer());
    ...
    PXRenderer<PXTxtRenderer>.RegisterRenderer(typeof (SourceElement), (PXTxtRenderer) new PXSourceRenderer());
