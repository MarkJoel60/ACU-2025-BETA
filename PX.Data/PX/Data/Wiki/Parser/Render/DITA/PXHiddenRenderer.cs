...
// Type: PX.Data.Wiki.Parser.Render.DITA.PXHiddenRenderer
...
internal class PXHiddenRenderer : PXditaRenderer
{
  private PXHiddenElement _e;

  protected override void Render(PXElement elem, PXditaRenderContext resultTxt)
  {
    this._e = (PXHiddenElement) elem;
    foreach (PXElement el in this._e.Caption)
