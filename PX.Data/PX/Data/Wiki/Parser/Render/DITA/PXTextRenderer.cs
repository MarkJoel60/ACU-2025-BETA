...
// Type: PX.Data.Wiki.Parser.Render.DITA.PXTextRenderer
...
internal class PXTextRenderer : PXditaRenderer
{
  private PXTextElement _e;

  protected override void Render(PXElement elem, PXditaRenderContext resultTxt)
  {
    this._e = (PXTextElement) elem;
    if (this._e.Value == "&nbsp;" || this._e.Value == "&nbsp")
      return;
