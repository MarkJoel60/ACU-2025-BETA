...
// Type: PX.Data.Wiki.Parser.DiffEngine
...
public class DiffEngine
{
    ...
    int sourceEnd)
  {
    ...
    {
      int maxLength = System.Math.Min(val1, sourceEnd - sourceIndex + 1);
      if (maxLength > length)
      {
  ...
  public double ProcessDiff(IDiffList source, IDiffList destination)
  {
    ...
    return (System.DateTime.Now - now).TotalSeconds;
  }
    ...
    int nextSource)
  {
    ...
    if (num1 > 0)
    {
      if (num2 > 0)
      {
        int length = System.Math.Min(num1, num2);
