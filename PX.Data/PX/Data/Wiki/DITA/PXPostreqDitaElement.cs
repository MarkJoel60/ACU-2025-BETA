...
// Type: PX.Data.Wiki.DITA.PXPostreqDitaElement
...
public class PXPostreqDitaElement : PXDitaContainer
{
  ...
  public override StringBuilder Read(StringBuilder globalContent1, ExportContext _context)
  {
    ...
    globalContent1_1.Append("{br}");
    globalContent1_1.Append("'''Post-requisites:'''");
    globalContent1_1.Append("{br}");
