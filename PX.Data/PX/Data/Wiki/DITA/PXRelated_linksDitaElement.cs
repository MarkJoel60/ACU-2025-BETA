...
// Type: PX.Data.Wiki.DITA.PXRelated_linksDitaElement
...
public class PXRelated_linksDitaElement : PXDitaContainer
{
  ...
  public override StringBuilder Read(StringBuilder globalContent1, ExportContext _context)
  {
    ...
    _context.IsRelatedLink = true;
    globalContent1_1.Append("\n");
    globalContent1_1.Append("==Related Articles:==");
    StringBuilder stringBuilder = this.ReadChilds(globalContent1_1, _context);
    _context.IsRelatedLink = false;
