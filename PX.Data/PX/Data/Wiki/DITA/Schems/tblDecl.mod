...
<!-- The Formal SYSTEM Identifier (FPI) for this DITA adaptation of
     the Exchange Table Model shall be:

     "-//OASIS//ELEMENTS DITA Exchange Table Model//EN"

     This set of declarations may be referred to using a SYSTEM external
     entity declaration and reference as shown in the following three
     lines:

     <!ENTITY % tableXML
       SYSTEM "-//OASIS//ELEMENTS DITA Exchange Table Model//EN">
       %tableXML;
-->
