...
/// <exclude />
public class PXLast<TNode, TName> : PXLast<TNode>
  ...
  where TName : class, IBqlField
{
  ...
  {
    return PXNavigationHelper.Press<TName>(adapter, (PXAction) new PXLast<TNode>(this._Graph, "Last"));
  }
}
