...
/// <example><para>The following BQL statement groups Table records by the Table1.field2 field and calculates minimum values of the Table1.field1 field in each group. The corresponding SQL query is given below.</para>
...
/// </example>
public sealed class Min<Field, NextAggregate> : AggregatedFnBase<Field, NextAggregate>
