...
// Type: PX.Data.PXModelExtension`1
...
public class PXModelExtension<TNode> : PXCache where TNode : PXMappedCacheExtension, IBqlTable, new()
{
  ...
  {
    return this.Cache._Clone(PXModelExtension<TNode>.getBaseClass(item));
  }
  ...
  {
    return this.Cache.HasAttributes(PXModelExtension<TNode>.getBaseClass(data));
  }
  ...
  {
    return this.Cache.GetAttributesReadonly(this.tryRemapField(name));
  }
  ...
  {
    return this.Cache.GetAttributesReadonly(this.tryRemapField(name), extractEmmbeddedAttr);
  }
  ...
  public override IEnumerable<PXEventSubscriberAttribute> GetAttributesReadonly(
    ...
    string name)
  {
    return this.Cache.GetAttributesReadonly(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(name));
  }
  ...
  {
    return this.Cache.GetAttributes(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(name));
  }

  /// <exclude />
  public override IEnumerable<T> GetAttributesOfType<T>(object data, string name)
  {
    return this.Cache.GetAttributesOfType<T>(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(name));
  }

  /// <exclude />
  public override List<System.Type> GetExtensionTables() => this.Cache.GetExtensionTables();
  ...
  {
    return this.Cache.GetAttributes(this.tryRemapField(name));
  }
  ...
  {
    this.Cache.SetValue(PXModelExtension<TNode>.getBaseClass(data), ordinal, value);
  }
  ...
  {
    this.Cache.SetValue(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName), value);
  }

  internal override object GetCopy(object data)
  {
    return this.Cache.GetCopy(PXModelExtension<TNode>.getBaseClass(data));
  }
  ...
  {
    this.Cache.SetDefaultExt(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName), value);
  }
  ...
  {
    this.Cache.SetValueExt(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName), value);
  }
  ...
  {
    return this.Cache.GetValue(PXModelExtension<TNode>.getBaseClass(data), ordinal);
  }
  ...
  /// (another way is to get the extension data record through the <see cref="M:PX.Data.PXCache`1.GetExtension``1(`0)">GetExtension&lt;&gt;()</see>
  /// method).</para>
  /// <para>The <see cref="M:PX.Data.PXCache`1.GetValueExt(System.Object,System.String)">GetValueExt()</see>
  ...
  {
    return this.Cache.GetValue(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName));
  }

  /// <exclude />
  public override object GetValueInt(object data, string fieldName)
  {
    return this.Cache.GetValueInt(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName));
  }

  /// <exclude />
  internal override object GetStateInt(object data, string fieldName)
  {
    return this.Cache.GetStateInt(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName));
  }
  ...
  {
    return this.Cache.GetValueExt(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName));
  }
  ...
  {
    return this.Cache.GetValueOriginal(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName));
  }

  /// <exclude />
  public override object GetOriginal(object data)
  {
    return this.Cache.GetOriginal(PXModelExtension<TNode>.getBaseClass(data));
  }
  ...
  {
    return this.Cache.GetValuePending(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName));
  }
  ...
  {
    this.Cache.SetValuePending(PXModelExtension<TNode>.getBaseClass(data), this.tryRemapField(fieldName), value);
  }

  internal override bool HasPendingValues(object data) => this.Cache.HasPendingValues(data);
  ...
  {
    this.Cache.RestoreCopy(PXModelExtension<TNode>.getBaseClass(item), PXModelExtension<TNode>.getBaseClass(copy));
  }
  ...
  public override object CreateCopy(object item)
  {
    if (item == null)
      return (object) null;
    object copy = this.Cache.CreateCopy(PXModelExtension<TNode>.getBaseClass(item));
    this._copiesStrongRef = this._copiesStrongRef ?? new List<object>();
    this._copiesStrongRef.Add(copy);
    return (object) this.Cache.GetExtension<TNode>(copy);
  }
  ...
  {
    return this.Cache.ToDictionary(PXModelExtension<TNode>.getBaseClass(data));
  }
  ...
  {
    return this.Cache.ToXml(PXModelExtension<TNode>.getBaseClass(data));
  }
  ...
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.FromXml(xml));
  }
  ...
  {
    return this.Cache.ValueToString(this.tryRemapField(fieldName), val);
  }
  ...
  {
    return this.Cache.ValueFromString(this.tryRemapField(fieldName), val);
  }
  ...
  public override PXFieldCollection Fields => this.Cache.Fields;
  ...
  public override List<System.Type> BqlFields => this.Cache.BqlFields;

  /// <summary>Gets the collection of BQL types that correspond to the key
  /// fields which the DAC defines.</summary>
  public override List<System.Type> BqlKeys => this.Cache.BqlKeys;

  /// <exclude />
  public override List<System.Type> BqlImmutables => this.Cache.BqlImmutables;

  /// <exclude />
  public override BqlCommand BqlSelect
  {
    get => this.Cache.BqlSelect;
    set => this.Cache.BqlSelect = value;
  }
  ...
  public override System.Type BqlTable => this.Cache.BqlTable;

  public override System.Type GenericParameter => typeof (TNode);

  internal override System.Type GetFieldType(string fieldName)
  {
    return this.Cache.GetFieldType(this.tryRemapField(fieldName));
  }

  internal override System.Type GetBaseBqlField(string field)
  {
    return this.Cache.GetBaseBqlField(this.tryRemapField(field));
  }

  /// <exclude />
  public override System.Type[] GetExtensionTypes() => this.Cache.GetExtensionTypes();
  ...
  {
    return this.Cache.ObjectsEqual(PXModelExtension<TNode>.getBaseClass(a), PXModelExtension<TNode>.getBaseClass(b));
  }
  ...
  {
    return this.Cache.GetObjectHashCode(PXModelExtension<TNode>.getBaseClass(data));
  }
  ...
  {
    return this.Cache.ObjectToString(PXModelExtension<TNode>.getBaseClass(data));
  }
  ...
  {
    object baseClass = PXModelExtension<TNode>.getBaseClass(item);
    return (Extension) (!typeof (Extension).IsAssignableFrom(typeof (TNode)) ? (PXCacheExtension) this.Cache.GetExtension<Extension>(baseClass) : (PXCacheExtension) this.Cache.GetExtension<TNode>(baseClass));
  }

  /// <exclude />
  public override object GetMain<Extension>(Extension item)
  {
    return PXModelExtension<TNode>.getBaseClass((object) item);
  }

  internal override PXCacheExtension[] GetCacheExtensions(IBqlTable item)
  {
    return this.Cache.GetCacheExtensions(PXModelExtension<TNode>.getBaseClass((object) item) as IBqlTable);
  }
  ...
  {
    get => this.Cache.Interceptor;
    set => this.Cache.Interceptor = value;
  }

  protected internal override void SetSessionUnmodified(object item, object unmodified)
  {
    this.Cache.SetSessionUnmodified(PXModelExtension<TNode>.getBaseClass(item), PXModelExtension<TNode>.getBaseClass(unmodified));
  }
  ...
  {
    this.Cache.EnsureUnmodified(PXModelExtension<TNode>.getBaseClass(item), existingStatus, newStatus);
  }
  ...
  {
    this.Cache.CreateNewVersion(PXModelExtension<TNode>.getBaseClass(item));
  }

  protected internal override void DiscardCurrentVersion(object item)
  {
    this.Cache.DiscardCurrentVersion(PXModelExtension<TNode>.getBaseClass(item));
  }

  protected internal override void SaveCurrentVersion(object item)
  {
    this.Cache.SaveCurrentVersion(PXModelExtension<TNode>.getBaseClass(item));
  }

  protected internal override bool IfModifiedVersion(object item)
  {
    return this.Cache.IfModifiedVersion(PXModelExtension<TNode>.getBaseClass(item));
  }

  protected internal override void SetVersionModified(object item)
  {
    this.Cache.SetVersionModified(PXModelExtension<TNode>.getBaseClass(item));
  }

  internal override void SaveInsertState() => this.Cache.SaveInsertState();

  internal override void CreateNewVersion() => this.Cache.CreateNewVersion();

  internal override void DiscardCurrentVersion() => this.Cache.DiscardCurrentVersion();

  internal override void SaveCurrentVersion() => this.Cache.SaveCurrentVersion();

  /// <exclude />
  public override System.Type GetBqlField(string field) => this.Cache.GetBqlField(field);

  /// <summary>Returns the number of fields and virtual fields which
  /// comprise the <tt>Fields</tt> collection.</summary>
  public override int GetFieldCount() => this.Cache.GetFieldCount();

  /// <summary>Returns the index of the specified field in the internally
  /// kept fields map. The pare</summary>
  public override int GetFieldOrdinal<Field>() => this.Cache.GetFieldOrdinal<Field>();

  /// <summary>Returns the index of the specified field in the internally
  /// kept fields map.</summary>
  /// <param name="field">The name of the field whose index is
  /// returned.</param>
  public override int GetFieldOrdinal(string field) => this.Cache.GetFieldOrdinal(field);
  ...
  /// cache.</summary>
  public override void Normalize() => this.Cache.Normalize();
  ...
  public override object Current
  {
    get
    {
      return (object) (this.Cache.Current != null ? this.Cache.GetExtension<TNode>(this.Cache.Current) : default (TNode));
    }
    set => this.Cache.Current = ((TNode) value)._Base.Target;
  }

  /// <exclude />
  public override object InternalCurrent
  {
    get => (object) this.Cache.GetExtension<TNode>(this.Cache.InternalCurrent);
  }

  private PXCache Cache => this._cache.Value;

  private string tryRemapField(string fieldName)
  {
    string str;
    return fieldName != null && this.FieldRemapping.TryGetValue(fieldName, out str) ? str : fieldName;
  }

  private static object getBaseClass(object data)
  {
    object baseClass = data;
    if (data is PXMappedCacheExtension && ((PXMappedCacheExtension) data)._Base != null)
      baseClass = ((PXMappedCacheExtension) data)._Base.Target;
    return baseClass;
  }
  ...
  {
    this._Graph = graph;
    this._cache = new Lazy<PXCache>((Func<PXCache>) (() => graph.Caches[map.Table]));
    this.FieldRemapping = new Dictionary<string, string>((IEqualityComparer<string>) StringComparer.OrdinalIgnoreCase);
    foreach (System.Reflection.FieldInfo field in map.GetType().GetFields(BindingFlags.Instance | BindingFlags.Public))
    {
      if (field.FieldType == typeof (System.Type))
        this.FieldRemapping[field.Name] = ((System.Type) field.GetValue((object) map)).Name;
    }
  }
  ...
  public override object Select(
    ...
    out bool wasUpdated)
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Select(record, ref position, isReadOnly, out wasUpdated));
  }

  internal override object CreateItem(PXDataRecord record, ref int position, bool isReadOnly)
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.CreateItem(record, ref position, isReadOnly));
  }
  ...
  internal override object Select(
    ...
    out bool wasUpdated)
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Select(record, row, isReadOnly, out wasUpdated));
  }

  /// <summary>Returns the status of the provided data record. The <see cref="T:PX.Data.PXEntryStatus">PXEntryStatus</see> enumeration
  ...
  {
    return this.Cache.GetStatus(PXModelExtension<TNode>.getBaseClass(item));
  }
  ...
  {
    this.Cache.SetStatus(PXModelExtension<TNode>.getBaseClass(item), status);
  }
  ...
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Locate(PXModelExtension<TNode>.getBaseClass(item)));
  }

  /// <exclude />
  public object UpdateExtensionMapping(object extension)
  {
    return this.UpdateExtensionMapping(extension, MappingSyncDirection.ExtensionToBase);
  }

  /// <exclude />
  public object UpdateExtensionMapping(object extension, MappingSyncDirection direction)
  {
    object baseObject = (object) null;
    if (extension is PXMappedCacheExtension && ((PXMappedCacheExtension) extension)._Base != null)
    {
      baseObject = ((PXMappedCacheExtension) extension)._Base.Target;
      this.UpdateExtensionMapping(extension, baseObject, direction);
    }
    return baseObject;
  }
  ...
  {
    this.UpdateExtensionMapping(extension, baseObject, MappingSyncDirection.ExtensionToBase);
  }

  private void UpdateExtensionMapping(
    object extension,
    object baseObject,
    MappingSyncDirection direction)
  {
    if (extension == null || baseObject == null)
      return;
    foreach (KeyValuePair<string, string> keyValuePair in this.FieldRemapping)
    {
      string key = keyValuePair.Key;
      string fieldName = keyValuePair.Value;
      this.SetValue(baseObject, fieldName, direction == MappingSyncDirection.ExtensionToBase ? typeof (TNode).GetProperty(key)?.GetValue(extension, (object[]) null) : this.Cache.GetValue(baseObject, fieldName));
    }
  }

  protected internal override bool IsPresent(object item)
  {
    return this.Cache.IsPresent(PXModelExtension<TNode>.getBaseClass(item));
  }

  protected internal override bool IsGraphSpecificField(string fieldName)
  {
    return this.Cache.IsGraphSpecificField(this.tryRemapField(fieldName));
  }
  ...
  public override int Locate(IDictionary keys) => this.Cache.Locate(keys);

  /// <exclude />
  public override int LocateByNoteID(Guid noteId) => this.Cache.LocateByNoteID(noteId);

  internal override int LocateByNoteID(Guid noteId, string noteIdField)
  {
    return this.Cache.LocateByNoteID(noteId, noteIdField);
  }
  ...
  {
    this.Cache.Remove(PXModelExtension<TNode>.getBaseClass(item));
  }
  ...
  /// are updated.</param>
  public override int Update(IDictionary keys, IDictionary values) => 0;
  ...
  {
    object baseClass = PXModelExtension<TNode>.getBaseClass(data);
    if (baseClass != data)
      this.UpdateExtensionMapping(data, baseClass);
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Update(baseClass));
  }

  protected internal override object Update(object data, bool bypassinterceptor)
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Update(PXModelExtension<TNode>.getBaseClass(data), bypassinterceptor));
  }

  protected internal override void UpdateLastModified(object item, bool inserted)
  {
    this.Cache.UpdateLastModified(PXModelExtension<TNode>.getBaseClass(item), inserted);
  }
  ...
  /// record fields. The dictionary keys are field names.</param>
  public override int Insert(IDictionary values) => this.Cache.Insert(values);

  internal override object FillItem(IDictionary values)
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.FillItem(values));
  }
  ...
  {
    object baseObject = PXModelExtension<TNode>.getBaseClass(data);
    if (baseObject == data)
      baseObject = this.Cache.CreateInstance();
    this.UpdateExtensionMapping(data, baseObject);
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Insert(baseObject));
  }

  protected internal override object Insert(object data, bool bypassinterceptor)
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Insert(PXModelExtension<TNode>.getBaseClass(data), bypassinterceptor));
  }

  internal override object ToChildEntity<Parent>(Parent item)
  {
    return this.Cache.ToChildEntity<Parent>(item);
  }
  ...
  /// 
  /// </example>
  public override object Extend<Parent>(Parent item) => this.Cache.Extend<Parent>(item);
  ...
  public override object Insert() => (object) this.Cache.GetExtension<TNode>(this.Cache.Insert());
  ...
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.CreateInstance());
  }

  /// <summary>Clears the internal cache of database query
  /// results.</summary>
  public override void ClearQueryCacheObsolete() => this.Cache.ClearQueryCacheObsolete();

  public override void ClearQueryCache() => this.Cache.ClearQueryCache();
  ...
  public override int Delete(IDictionary keys, IDictionary values) => 0;
  ...
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Delete(PXModelExtension<TNode>.getBaseClass(data)));
  }

  protected internal override object Delete(object data, bool bypassinterceptor)
  {
    return (object) this.Cache.GetExtension<TNode>(this.Cache.Delete(PXModelExtension<TNode>.getBaseClass(data), bypassinterceptor));
  }

  protected internal override void PlaceNotChanged(object data)
  {
    this.Cache.PlaceNotChanged(PXModelExtension<TNode>.getBaseClass(data));
  }

  protected internal override object PlaceNotChanged(object data, out bool wasUpdated)
  {
    return this.Cache.PlaceNotChanged(PXModelExtension<TNode>.getBaseClass(data), out wasUpdated);
  }
  ...
  /// status.</summary>
  public override IEnumerable Dirty => this.Cache.Dirty;
  ...
  public override IEnumerable Updated
  {
    get
    {
      return (IEnumerable) this.Cache.Updated.Cast<object>().Select<object, TNode>((Func<object, TNode>) (o => this.GetExtension<TNode>(o)));
    }
  }
  ...
  public override IEnumerable Inserted
  {
    get
    {
      return (IEnumerable) this.Cache.Inserted.Cast<object>().Select<object, TNode>((Func<object, TNode>) (o => this.GetExtension<TNode>(o)));
    }
  }
  ...
  public override IEnumerable Cached
  {
    get
    {
      return (IEnumerable) this.Cache.Cached.Cast<object>().Select<object, TNode>((Func<object, TNode>) (o => this.GetExtension<TNode>(o)));
    }
  }
  ...
  public override IEnumerable Deleted
  {
    get
    {
      return (IEnumerable) this.Cache.Deleted.Cast<object>().Select<object, TNode>((Func<object, TNode>) (o => this.GetExtension<TNode>(o)));
    }
  }
  ...
  {
    return this.Cache.GetOriginalObjectContext(PXModelExtension<TNode>.getBaseClass(data), readItemIfNotExists);
  }

  /// <summary>Gets the value that indicates if the cache contains modified
  /// data records to be saved to database.</summary>
  public override bool IsInsertedUpdatedDeleted => this.Cache.IsInsertedUpdatedDeleted;
  ...
  /// </example>
  public override int Persist(PXDBOperation operation) => 0;
  ...
  protected internal override bool PersistUpdated(object row, bool bypassInterceptor) => false;
  ...
  protected internal override bool PersistInserted(object row, bool bypassInterceptor) => false;
  ...
  /// database.</param>
  protected internal override bool PersistDeleted(object row, bool bypassInterceptor) => false;

  /// <exclude />
  public override void ResetPersisted(object row)
  {
    this.Cache.ResetPersisted(PXModelExtension<TNode>.getBaseClass(row));
  }
  ...
  /// <exclude />
  public override void ClearItemAttributes() => this.Cache.ClearItemAttributes();

  /// <exclude />
  public override void TrimItemAttributes(object item) => this.Cache.TrimItemAttributes(item);

  internal override bool HasChangedKeys() => this.Cache.HasChangedKeys();

  internal override void ClearSession() => this.Cache.ClearSession();
  ...
  /// object.</summary>
  public override string ToString() => this.Cache.ToString();

  /// <exclude />
  public override bool RaiseCommandPreparing(
    string name,
    object row,
    object value,
    ...
    out PXCommandPreparingEventArgs.FieldDescription description)
  {
    if (table == typeof (TNode))
      table = this.Cache.GetItemType();
    return this.Cache.RaiseCommandPreparing(this.tryRemapField(name), PXModelExtension<TNode>.getBaseClass(row), value, operation, table, out description);
  }

  /// <exclude />
  public override bool RaiseExceptionHandling(
    string name,
    object row,
    object newValue,
    Exception exception)
  {
    return this.Cache.RaiseExceptionHandling(this.tryRemapField(name), PXModelExtension<TNode>.getBaseClass(row), newValue, exception);
  }

  /// <exclude />
  public override bool RaiseFieldDefaulting(string name, object row, out object newValue)
  {
    return this.Cache.RaiseFieldDefaulting(this.tryRemapField(name), PXModelExtension<TNode>.getBaseClass(row), out newValue);
  }

  /// <exclude />
  public override bool RaiseFieldSelecting(
    string name,
    object row,
    ref object returnValue,
    bool forceState)
  {
    return this.Cache.RaiseFieldSelecting(this.tryRemapField(name), PXModelExtension<TNode>.getBaseClass(row), ref returnValue, forceState);
  }

  /// <exclude />
  public override void RaiseFieldUpdated(string name, object row, object oldValue)
  {
    this.Cache.RaiseFieldUpdated(this.tryRemapField(name), PXModelExtension<TNode>.getBaseClass(row), oldValue);
  }

  /// <exclude />
  public override void RaiseFieldUpdated<Field>(object row, object oldValue)
  {
    this.Cache.RaiseFieldUpdated(this.tryRemapField(typeof (Field).Name), PXModelExtension<TNode>.getBaseClass(row), oldValue);
  }

  /// <exclude />
  public override bool RaiseFieldVerifying(string name, object row, ref object newValue)
  {
    return this.Cache.RaiseFieldVerifying(this.tryRemapField(name), PXModelExtension<TNode>.getBaseClass(row), ref newValue);
  }

  /// <exclude />
  public override void RaiseRowDeleted(object item)
  {
    this.Cache.RaiseRowDeleted(PXModelExtension<TNode>.getBaseClass(item));
  }

  /// <exclude />
  public override bool RaiseRowDeleting(object item)
  {
    return this.Cache.RaiseRowDeleting(PXModelExtension<TNode>.getBaseClass(item));
  }

  /// <exclude />
  public override void RaiseRowInserted(object item)
  {
    this.Cache.RaiseRowInserted(PXModelExtension<TNode>.getBaseClass(item));
  }

  /// <exclude />
  public override bool RaiseRowPersisting(object item, PXDBOperation operation)
  {
    return this.Cache.RaiseRowPersisting(PXModelExtension<TNode>.getBaseClass(item), operation);
  }

  /// <exclude />
  public override void RaiseRowSelected(object item)
  {
    this.Cache.RaiseRowSelected(PXModelExtension<TNode>.getBaseClass(item));
  }
  ...
  public override bool RaiseRowSelecting(
    ...
    bool isReadOnly)
  {
    return this.Cache.RaiseRowSelecting(PXModelExtension<TNode>.getBaseClass(item), record, ref position, isReadOnly);
  }

  /// <exclude />
  public override void RaiseRowUpdated(object newItem, object oldItem)
  {
    this.Cache.RaiseRowUpdated(PXModelExtension<TNode>.getBaseClass(newItem), PXModelExtension<TNode>.getBaseClass(oldItem));
  }

  /// <exclude />
  public override bool RaiseRowUpdating(object item, object newItem)
  {
    return this.Cache.RaiseRowUpdating(PXModelExtension<TNode>.getBaseClass(item), PXModelExtension<TNode>.getBaseClass(newItem));
  }
}
