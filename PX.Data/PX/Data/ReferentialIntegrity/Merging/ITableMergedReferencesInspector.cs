...
// Type: PX.Data.ReferentialIntegrity.Merging.ITableMergedReferencesInspector
...
public interface ITableMergedReferencesInspector
{
  ...
  /// </summary>
  Dictionary<System.Type, MergedReferencesInspectionResult> GetMergedReferencesOfAllTables();
  ...
  MergedReferencesInspectionResult GetMergedReferencesOf(System.Type bqlTable);

  /// <summary>
  /// Gets information about referential relationship between the given <see cref="T:PX.Data.IBqlTable" />
  /// and other <see cref="T:PX.Data.IBqlTable" />s that are included in referential integrity check.
  /// </summary>
  MergedReferencesInspectionResult GetMergedReferencesOf<TTable>() where TTable : IBqlTable;

  IEnumerable<Reference> GetIncomingReferencesApplicableTo(System.Type bqlTable);

  IEnumerable<Reference> GetOutgoingReferencesApplicableTo(System.Type bqlTable);
}
