...
// Type: PX.Data.ReferentialIntegrity.Attributes.CompositeKey`8
...
public class CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5, TFieldsRelation6, TFieldsRelation7, TFieldsRelation8> : 
  TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5, TFieldsRelation6, TFieldsRelation7, TFieldsRelation8>,
  ...
  where TFieldsRelation8 : IFieldsRelation
{
  ...
  public class WithTablesOf<TParentTable, TChildTable> : 
    KeysRelation<CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5, TFieldsRelation6, TFieldsRelation7, TFieldsRelation8>.WithTablesOf<TParentTable, TChildTable>, TParentTable, TChildTable>,
    TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5, TFieldsRelation6, TFieldsRelation7, TFieldsRelation8>,
    ITypeArrayOf<IFieldsRelation>,
    TypeArray.IsNotEmpty
