...
// Type: PX.Data.ReferentialIntegrity.Attributes.CompositeKey`5
...
public class CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5> : 
  TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5>,
  ...
  where TFieldsRelation5 : IFieldsRelation
{
  ...
  public class WithTablesOf<TParentTable, TChildTable> : 
    KeysRelation<CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5>.WithTablesOf<TParentTable, TChildTable>, TParentTable, TChildTable>,
    TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5>,
    ITypeArrayOf<IFieldsRelation>,
    TypeArray.IsNotEmpty
