...
// Type: PX.Data.ReferentialIntegrity.Attributes.CompositeKey`9
...
public class CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5, TFieldsRelation6, TFieldsRelation7, TFieldsRelation8, TFieldsRelation9> : 
  TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5, TFieldsRelation6, TFieldsRelation7, TFieldsRelation8, TFieldsRelation9>,
  ...
  where TFieldsRelation9 : IFieldsRelation
{
  ...
  public class WithTablesOf<TParentTable, TChildTable> : 
    KeysRelation<CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5, TFieldsRelation6, TFieldsRelation7, TFieldsRelation8, TFieldsRelation9>.WithTablesOf<TParentTable, TChildTable>, TParentTable, TChildTable>,
    TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4, TFieldsRelation5, TFieldsRelation6, TFieldsRelation7, TFieldsRelation8, TFieldsRelation9>,
    ITypeArrayOf<IFieldsRelation>,
    TypeArray.IsNotEmpty
