...
// Type: PX.Data.ReferentialIntegrity.Attributes.CompositeKey`4
...
public class CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4> : 
  TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4>,
  ...
  where TFieldsRelation4 : IFieldsRelation
{
  ...
  public class WithTablesOf<TParentTable, TChildTable> : 
    KeysRelation<CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4>.WithTablesOf<TParentTable, TChildTable>, TParentTable, TChildTable>,
    TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3, TFieldsRelation4>,
    ITypeArrayOf<IFieldsRelation>,
    TypeArray.IsNotEmpty
