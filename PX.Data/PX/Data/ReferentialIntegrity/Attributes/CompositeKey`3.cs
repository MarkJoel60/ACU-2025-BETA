...
// Type: PX.Data.ReferentialIntegrity.Attributes.CompositeKey`3
...
public class CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3> : 
  TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3>,
  ...
  where TFieldsRelation3 : IFieldsRelation
{
  ...
  public class WithTablesOf<TParentTable, TChildTable> : 
    KeysRelation<CompositeKey<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3>.WithTablesOf<TParentTable, TChildTable>, TParentTable, TChildTable>,
    TypeArrayOf<IFieldsRelation>.IFilledWith<TFieldsRelation1, TFieldsRelation2, TFieldsRelation3>,
    ITypeArrayOf<IFieldsRelation>,
    TypeArray.IsNotEmpty
