...
/// <exclude />
[Serializable]
public class PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> : 
  PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
  ...
  where T14 : class, IBqlTable, new()
{
  ...
  public static implicit operator T0(
    PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> r)
  {
  ...
  public override object this[System.Type t] => t == typeof (T14) ? this.Items[14] : base[t];

  public override object this[string s] => s == typeof (T14).Name ? this.Items[14] : base[s];

  public override System.Type GetItemType(int i) => i == 14 ? typeof (T14) : base.GetItemType(i);

  public override System.Type GetItemType(string s)
  {
    return s == typeof (T14).Name ? typeof (T14) : base.GetItemType(s);
  }

  public static PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> Current
  {
    get
    {
      ...
      if (slot != null)
      {
        ...
        if (slot.TryGetValue(typeof (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>), out current))
          return (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>) current;
      }
      return (PXResult<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>) null;
    }
  }
  ...
  public void Deconstruct(
    ...
    out T14 item14)
  {
    (item0, item1, item2, item3, item4, item5, item6, item7, item8, item9, item10, item11, item12, item13) = this;
    item14 = (T14) this;
  }
}
