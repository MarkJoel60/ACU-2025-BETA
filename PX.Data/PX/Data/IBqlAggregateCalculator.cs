...
// Type: PX.Data.IBqlAggregateCalculator
...
public interface IBqlAggregateCalculator
{
  ...
  object Calculate(PXCache cache, object row, int fieldordinal, object[] records, int digit);

  object Calculate(PXCache cache, object row, object oldrow, int fieldordinal, int digit);
}
