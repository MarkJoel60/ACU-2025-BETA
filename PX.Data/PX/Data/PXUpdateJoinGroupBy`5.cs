...
// Type: PX.Data.PXUpdateJoinGroupBy`5
...
public static class PXUpdateJoinGroupBy<Set, Table, Join, Where, Aggregate>
  where Set : IBqlSet
  ...
  where Aggregate : IBqlAggregate, new()
{
  ...
  {
    IBqlUpdate command = (IBqlUpdate) new PX.Data.Update<Set, Select5<Table, Join, Where, Aggregate>>();
