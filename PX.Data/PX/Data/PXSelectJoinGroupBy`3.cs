...
// Type: PX.Data.PXSelectJoinGroupBy`3
...
public class PXSelectJoinGroupBy<Table, Join, Aggregate> : 
  PXSelectBase<Table, PXSelectJoinGroupBy<Table, Join, Aggregate>.Config>
  ...
  where Aggregate : IBqlAggregate, new()
{
  ...
  public class Config : 
    PXSelectBase<Table, PXSelectJoinGroupBy<Table, Join, Aggregate>.Config>.IViewConfig,
    IViewConfigBase
  {
    public BqlCommand GetCommand() => (BqlCommand) new Select5<Table, Join, Aggregate>();
