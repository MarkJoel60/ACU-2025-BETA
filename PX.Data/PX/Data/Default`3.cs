...
/// <example><para>The code below shows how an expression for the %PXFormula:PXFormulaAttribute% attribute can be composed at run time by using the %BqlCommand:BqlCommand% class.</para>
...
/// </example>
public class Default<V1, V2, V3> : Default<V1, V2>
  where V1 : IBqlField
  where V2 : IBqlField
  where V3 : IBqlField
{
