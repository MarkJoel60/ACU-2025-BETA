...
// Type: PX.Data.PXSelectGroupByOrderBy`4
...
public class PXSelectGroupByOrderBy<Table, Join, Aggregate, OrderBy> : 
  PXSelectBase<Table, PXSelectGroupByOrderBy<Table, Join, Aggregate, OrderBy>.Config>
...
{
  /// <exclude />
  public PXSelectGroupByOrderBy(PXGraph graph)
    : base(graph)
  {
  }

  /// <exclude />
  public PXSelectGroupByOrderBy(PXGraph graph, Delegate handler)
    : base(graph, handler)
  {
  }

  public class Config : 
    PXSelectBase<Table, PXSelectGroupByOrderBy<Table, Join, Aggregate, OrderBy>.Config>.IViewConfig,
    IViewConfigBase
  {
    public BqlCommand GetCommand() => (BqlCommand) new Select6<Table, Join, Aggregate, OrderBy>();
