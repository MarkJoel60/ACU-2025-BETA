...
[Serializable]
public class SMPrintJobFilter : PXBqlTable, IBqlTable, IBqlTableSystemDataStorage
{
  ...
  [PXInt]
  [PXUIField(DisplayName = "Job ID", Visible = false, Visibility = PXUIVisibility.Invisible)]
  public virtual int? JobID { get; set; }

  [PXDate(UseTimeZone = true)]
  [PXUIField(DisplayName = "Start Date and Time Modified", Visibility = PXUIVisibility.SelectorVisible, Required = false)]
  public virtual System.DateTime? StartModifiedDateTime { get; set; }

  [PXDate(UseTimeZone = true)]
  [PXUIField(DisplayName = "End Date and Time Modified", Visibility = PXUIVisibility.SelectorVisible, Required = false)]
  public virtual System.DateTime? EndModifiedDateTime { get; set; }

  public abstract class startDate : BqlType<IBqlDateTime, System.DateTime>.Field<
  #nullable disable
  SMPrintJobFilter.startDate>
  {
  }
  ...
  public abstract class endDatePlusOne : 
    ...
    IBqlDateTime, System.DateTime>.Field<
    #nullable disable
    SMPrintJobFilter.endDatePlusOne>
  {
  }
  ...
  IBqlBool, bool>.Field<
  #nullable disable
  SMPrintJobFilter.hideProcessed>
  {
  }
  ...
  IBqlInt, int>.Field<
  #nullable disable
  SMPrintJobFilter.jobID>
  {
  }

  public abstract class startModifiedDateTime : 
    BqlType<
    #nullable enable
    IBqlDateTime, System.DateTime>.Field<
    #nullable disable
    SMPrintJobFilter.startModifiedDateTime>
  {
  }

  public abstract class endModifiedDateTime : 
    BqlType<
    #nullable enable
    IBqlDateTime, System.DateTime>.Field<
    #nullable disable
    SMPrintJobFilter.endModifiedDateTime>
  {
  }
}
