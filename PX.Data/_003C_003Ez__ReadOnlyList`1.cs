...
#nullable disable
internal sealed class \u003C\u003Ez__ReadOnlyList<T> : 
  IEnumerable,
  IEnumerable<T>,
  ...
  IList<T>
{
  public \u003C\u003Ez__ReadOnlyList(List<T> items) => this._items = items;
  ...
  int ICollection<T>.Count => this._items.Count;
  ...
  bool ICollection<T>.Contains(T item) => this._items.Contains(item);
  ...
  int IList<T>.IndexOf(T item) => this._items.IndexOf(item);
