...
// Type: PX.Objects.FS.FSSelectorComponentIDAttribute
...
public class FSSelectorComponentIDAttribute : PXSelectorAttribute
{
  public FSSelectorComponentIDAttribute()
    : base(typeof (Search<FSModelTemplateComponent.componentID, Where<FSModelTemplateComponent.modelTemplateID, Equal<Current<PX.Objects.IN.InventoryItem.itemClassID>>, And<FSModelTemplateComponent.active, Equal<True>>>>), new Type[4]
    {
