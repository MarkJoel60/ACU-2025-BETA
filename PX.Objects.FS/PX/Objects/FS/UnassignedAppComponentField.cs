...
// Type: PX.Objects.FS.UnassignedAppComponentField
...
[PXBreakInheritance]
[PXProjection(typeof (Select<FSCalendarComponentField, Where<FSCalendarComponentField.componentType, Equal<ListField_ComponentType.unassignedAppGrid>>>), Persistent = true)]
[Serializable]
public class UnassignedAppComponentField : FSCalendarComponentField
{
  ...
  public new abstract class componentType : 
    ...
    #nullable disable
    UnassignedAppComponentField.componentType>
  {
  ...
  public new abstract class sortOrder : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    UnassignedAppComponentField.sortOrder>
  {
  }
  ...
  public new abstract class objectName : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    UnassignedAppComponentField.objectName>
  {
  }
  ...
  public new abstract class fieldName : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    UnassignedAppComponentField.fieldName>
  {
  }
}
