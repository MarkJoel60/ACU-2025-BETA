...
public static class TX
{
  ...
  public static class TableName
  {
    ...
    public const string SERVICEMANAGEMENT_SETUP = "Service Management Preferences";
    ...
    public const string EmployeeLicenseType = "Employee License Type";
    public const string EmployeeSkill = "Employee Skill";
    public const string EmployeeInventoryItem = "Employee Inventory Item";
    public const string AppointmentGeoZone = "Appointment Geo Zone";
    public const string SchedulerTrackingHistory = "Scheduler Tracking History";
  }
  ...
  public static class Error
  {
    ...
    public const string ROLLBACK_ROUTE_CONTRACT_GENERATION_FAILED = "The last generation process cannot be rolled back because at least one appointment has a status other than Not Started.";
    ...
    public const string PROJECT_ID_CANNOT_BE_MODIFIED = "The Project ID cannot be modified because this line is related to a service order.";
    ...
    public const string DEFAULT_SERVICE_ORDER_TYPE_NOT_DEFINED = "The default service order type has not been defined. Specify the default type in the Default Service Order Type box on the Service Management Preferences (FS100100) form.";
    public const string DEFAULT_SERVICE_ORDER_TYPE_COST_CODE_NOT_DEFINED = "Error: 'Cost Code' cannot be empty. Please specify the default cost code for the related service order type.";
    ...
    public const string CannotCancelLineBecausePOIsAlreadyCreated = "The selected line is associated with a purchase order and cannot be canceled directly. To cancel this line, first cancel or delete the corresponding line in the related purchase order.";
    ...
    public const string ReleasedTimeActivityCannotBeDeleted = "The log line cannot be deleted because at least one time activity associated with {0} log line has been released or approved.";
    public const string LogLineWithReleasedTimeActivityCannotBeDeleted = "The log line cannot be deleted because at least one time activity associated with {0} and the {1} log line has been released or approved.";
    ...
    public const string BillingCustomerCannotBeModifiedDueToPrepayments = "The service order contains at least one prepayment associated with a different customer. The billing customer cannot be modified.";
    public const string BillingCustomerCannotBeModifiedDueToExpenseReceipts = "The service order is related to at least one expense receipt associated with a different customer. The billing customer cannot be modified.";
    public const string BillingCustomerCannotBeModifiedDueToAPBill = "The service order is related to at least one bill. The billing customer cannot be modified.";
    public const string CannotBillWhenUsedItem = "Items that have a lot or serial class with the When Used assignment method cannot be used with a service document where Billing By is set to Service Orders.";
    public const string ScheduleWithRelatedTimeSlotCannotBeDeleted = "The staff schedule rule cannot be deleted because the time slots have been generated for it. To be able to delete the staff schedule rule, remove the time slots by using the Roll Back Schedule Generation command.";
    public const string DetailsLineMultipleLotSerNumbers = "Selecting multiple lot or serial numbers in a single line for the item for which the Specify Lot/Serial Price and Description check box is selected in the item's lot or serial class is not supported in sales orders and invoices. To avoid errors during the billing process, add a separate line for each lot or serial number.";
    public const string LotSerClassSpecifyPriceChangeError = "The state of the check box cannot be changed because items with this lot or serial class exist in open documents. See the trace log for details.";
    public const string LotSerClassSpecifyPriceChangeErrorDetails = "The state of the Specify Lot/Serial Price and Description check box cannot be changed because items with this lot or serial class exist in the following open service orders: {0}.";
  }
  ...
  public static class Warning
  {
    ...
    public const string BillingCustomerChangedWarning = "Changing the billing customer in the service order will affect all related appointments (if any). This change may update the currency, prices, tax zone, service contract, and project information in the related appointments because these settings originate from the billing customer.";
    public const string UpdatingWarehouseOnPOEnabledLineWarning = "Changing the warehouse will not affect the purchase order or the PO receipt.";
    public const string LocationDiffersFromServiceDocument = "The location of the {0} item has been modified and no longer matches the location in the originating service document. These changes will not affect the originating {1} service document.";
    public const string LogLineIsRelatedToTimeActivity = "At least one time activity related to this log line has been generated. If you delete the log line, the related time activity will also be deleted.";
    public const string TimeIntegrationIsInUse = "This functionality is currently in use. If you clear this check box, it may cause unexpected results.";
  }
  ...
  [PXLocalizable]
  public class SourceType_Equipment_ALL : TX.SourceType_Equipment
  {
    public const string ALL = "All";
  }
  ...
  public static class RouteLocationType
  {
    ...
    public const string EMPLOYEE_LOCATION = "EMLC";
  }
  ...
  {
    public static string[] weeksOfMonth = new string[5]
    {
      "First",
      "Second",
      "Third",
    ...
    public static string[] dayOfMonthOrdinals = new string[31 /*0x1F*/]
    {
      "1st",
      "2nd",
      "3rd",
  ...
  public static class CalendarMessages
  {
    ...
    public const string WARNING_INVENTORY_ITEM_MUST_BE_SERVICE_TYPE = "An inventory item must be of the Service type.";
    ...
    public const string SERVICEORDER_REPORTSTO = "Reports To";
    ...
    public const string APPT_STATUS = "Appointment Status";
    ...
    public const string SO_STATUS = "Service Order Status";
    ...
    public const string EMPLOYEE_DEFAULT = "Default Staff";
    public const string EMPLOYEE_NOPROJECT = "Not in Project";
    public const string EMPLOYEE_NOSKILL = "Skill Mismatch";
    public const string EMPLOYEE_NOLICENSE = "License Mismatch";
    public const string EMPLOYEE_NOAREA = "Not in Service Area";
    public const string EMPLOYEE_LICENSE_TYPE_DESCR = "Employee License Type Description";
    public const string EMPLOYEE_LICENSE_TYPE_DESC = "Employee License Type Desc.";
    public const string EMPLOYEE_LICENSE_TYPE_ID = "Employee License Type ID";
    public const string EMPLOYEE_SKILL_DESCR = "Employee Skill Description";
    public const string EMPLOYEE_SKILL_ID = "Employee Skill ID";
    public const string EMPLOYEE_SERVICE_TYPE = "Employee Service Type";
    public const string EMPLOYEE_GEOZONE_ID = "Employee Service Area ID";
    public const string EMPLOYEE_GEOZONE_DESC = "Employee Service Area Desc.";
    public const string STAFF_TYPE = "Staff Type";
    public const string LICENSE_TYPE_DESCR = "License Type Description";
    public const string LICENSE_TYPE_ID = "License Type ID";
    public const string SKILL_DESCR = "Skill Description";
  }
