...
// Type: PX.Objects.FS.Scheduler.MonthlyScheduleSpecificDay
...
public class MonthlyScheduleSpecificDay : MonthlySchedule
{
  ...
  {
    return date.Day == this.DayOfMonth || date.Day == DateTime.DaysInMonth(date.Year, date.Month) && this.DayOfMonth > date.Day;
  }
}
