...
// Type: PX.Objects.FS.FSServiceOrderVisibilityRestriction
...
public class FSServiceOrderVisibilityRestriction : PXCacheExtension<FSServiceOrder>
{
  ...
  [PXMergeAttributes]
  [RestrictCustomerByBranch(typeof (PX.Objects.AR.Customer.cOrgBAccountID), typeof (FSServiceOrder.branchID), ResetCustomer = true)]
