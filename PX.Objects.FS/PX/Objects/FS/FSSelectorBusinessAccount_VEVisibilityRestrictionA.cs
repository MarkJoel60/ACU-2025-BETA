...
// Type: PX.Objects.FS.FSSelectorBusinessAccount_VEVisibilityRestrictionAttribute
...
public class FSSelectorBusinessAccount_VEVisibilityRestrictionAttribute : 
  PXDimensionSelectorAttribute
{
  public FSSelectorBusinessAccount_VEVisibilityRestrictionAttribute()
    : base("VENDOR", BqlCommand.Compose(new System.Type[9]
    {
      ...
      typeof (Where<PX.Objects.AP.Vendor.vOrgBAccountID, RestrictByUserBranches<Current<AccessInfo.userName>>, And<Match<PX.Objects.AP.Vendor, Current<AccessInfo.userName>>>>)
