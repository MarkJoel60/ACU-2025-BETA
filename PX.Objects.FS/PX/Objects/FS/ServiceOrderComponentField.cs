...
// Type: PX.Objects.FS.ServiceOrderComponentField
...
[PXBreakInheritance]
[PXProjection(typeof (Select<FSCalendarComponentField, Where<FSCalendarComponentField.componentType, Equal<ListField_ComponentType.serviceOrderGrid>>>), Persistent = true)]
[Serializable]
public class ServiceOrderComponentField : FSCalendarComponentField
{
  ...
  public new abstract class componentType : 
    ...
    #nullable disable
    ServiceOrderComponentField.componentType>
  {
  ...
  public new abstract class sortOrder : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    ServiceOrderComponentField.sortOrder>
  {
  }
  ...
  public new abstract class objectName : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    ServiceOrderComponentField.objectName>
  {
  }
  ...
  public new abstract class fieldName : 
    ...
    IBqlString, string>.Field<
    #nullable disable
    ServiceOrderComponentField.fieldName>
  {
  }
}
