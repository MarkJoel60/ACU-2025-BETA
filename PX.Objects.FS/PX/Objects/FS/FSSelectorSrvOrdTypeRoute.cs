...
// Type: PX.Objects.FS.FSSelectorSrvOrdTypeRoute
...
public class FSSelectorSrvOrdTypeRoute : PXSelectorAttribute
{
  public FSSelectorSrvOrdTypeRoute()
    : base(typeof (Search<FSSrvOrdType.srvOrdType, Where<FSSrvOrdType.behavior, Equal<ListField.ServiceOrderTypeBehavior.routeAppointment>>>), new Type[3]
    {
