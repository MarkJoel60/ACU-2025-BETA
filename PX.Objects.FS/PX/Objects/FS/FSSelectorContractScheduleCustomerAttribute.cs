...
// Type: PX.Objects.FS.FSSelectorContractScheduleCustomerAttribute
...
{
  public FSSelectorContractScheduleCustomerAttribute(System.Type whereType)
    : base("BIZACCT", BqlCommand.Compose(new System.Type[17]
    {
      typeof (Search5<,,,>),
      typeof (PX.Objects.AR.Customer.bAccountID),
      typeof (InnerJoin<,,>),
      typeof (FSServiceContract),
      typeof (On<FSServiceContract.customerID, Equal<PX.Objects.AR.Customer.bAccountID>>),
      typeof (LeftJoin<,,>),
      ...
      whereType,
      typeof (Aggregate<>),
      typeof (GroupBy<PX.Objects.AR.Customer.bAccountID>)
