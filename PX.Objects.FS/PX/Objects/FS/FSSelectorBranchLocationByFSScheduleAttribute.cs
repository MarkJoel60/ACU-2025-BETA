...
// Type: PX.Objects.FS.FSSelectorBranchLocationByFSScheduleAttribute
...
public class FSSelectorBranchLocationByFSScheduleAttribute : PXSelectorAttribute
{
  public FSSelectorBranchLocationByFSScheduleAttribute()
    : base(typeof (Search<FSBranchLocation.branchLocationID, Where<FSBranchLocation.branchID, Equal<Current<FSSchedule.branchID>>>>))
  {
