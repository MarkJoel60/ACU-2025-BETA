...
// Type: PX.Objects.FS.AppointmentEntryVisibilityRestriction
...
public class AppointmentEntryVisibilityRestriction : PXGraphExtension<AppointmentEntry>
{
  ...
  public void CopyPasteGetScript(
    ...
    AppointmentEntryVisibilityRestriction.CopyPasteGetScriptDelegate baseMethod)
  {
    baseMethod(isImportSimple, script, containers);
    string str1 = "ServiceOrderRelated: 2";
    string str2 = "ServiceOrderRelated: 1";
  ...
  public void _(
    PX.Data.Events.CacheAttached<FSAppointmentEmployee.employeeID> e)
  {
  }
  ...
  public void _(
    PX.Data.Events.CacheAttached<FSAppointmentDet.poVendorID> e)
  {
  }
