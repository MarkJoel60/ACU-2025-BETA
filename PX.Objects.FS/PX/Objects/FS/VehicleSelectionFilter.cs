...
// Type: PX.Objects.FS.VehicleSelectionFilter
...
[Serializable]
public class VehicleSelectionFilter : PXBqlTable, IBqlTable, IBqlTableSystemDataStorage
{
  [PXInt]
  ...
  public abstract class routeDocumentID : 
    ...
    #nullable disable
    VehicleSelectionFilter.routeDocumentID>
  {
  }

  public abstract class showUnassignedVehicles : 
    BqlType<
    #nullable enable
    IBqlBool, bool>.Field<
    #nullable disable
    VehicleSelectionFilter.showUnassignedVehicles>
  {
  }
  ...
  public abstract class vehicleTypeID : 
    ...
    IBqlInt, int>.Field<
    #nullable disable
    VehicleSelectionFilter.vehicleTypeID>
  {
  }
}
