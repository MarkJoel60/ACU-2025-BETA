...
// Type: PX.Objects.PM.MaterialManagement.GraphExtensions.ItemAvailability.FSAppointmentItemAvailabilityProjectExtension
  ...
  ItemAvailabilityProjectExtension<AppointmentEntry, FSAppointmentItemAvailabilityExtension, FSAppointmentDet, FSApptLineSplit>
{
  ...
  protected override string GetStatusProject(FSAppointmentDet line)
  {
    ...
    bool excludeCurrent = line?.Status != "CP";
    PMProject project;
    if (ProjectDefaultAttribute.IsProject((PXGraph) ((PXGraphExtension<AppointmentEntry>) this).Base, line.ProjectID, out project) && project.AccountingMode != "L")
    {
