...
#nullable disable
public class Page_FS300700 : PXPage
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    StreamReader streamReader1 = new StreamReader(((Page) this).Server.MapPath("../../Shared/templates/TooltipAppointment.html"));
    this.toolTipTemplateAppointment = streamReader1.ReadToEnd();
    streamReader1.Close();
    ...
    streamReader2.Close();
    StreamReader streamReader3 = new StreamReader(((Page) this).Server.MapPath("../../Shared/templates/EventTemplate.html"));
    this.appointmentBodyTemplate = streamReader3.ReadToEnd();
    streamReader3.Close();
  }
}
