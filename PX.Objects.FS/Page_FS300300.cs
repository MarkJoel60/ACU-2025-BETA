...
#nullable disable
public class Page_FS300300 : PXPage
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    streamReader1.Close();
    StreamReader streamReader2 = new StreamReader(((Page) this).Server.MapPath("../../Shared/templates/TooltipAppointment.html"));
    this.toolTipTemplateAppointment = streamReader2.ReadToEnd();
    streamReader2.Close();
    StreamReader streamReader3 = new StreamReader(((Page) this).Server.MapPath("../../Shared/templates/TooltipServiceOrder.html"));
    this.toolTipTemplateServiceOrder = streamReader3.ReadToEnd();
    streamReader3.Close();
  }
}
